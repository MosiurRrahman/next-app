        ...
        <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
          ...
          <ul className="menu-list">
            ...
            <li className="position-inherit">
              ...
              <i onClick={() => toggleMenu("new-car")} className={`bi bi-${state.activeMenu === "new-car" ?"dash":"plus"} dropdown-icon d-lg-none d-block`} />
              <div className={`mega-menu ${state.activeMenu === "new-car"?"d-block":""}`}>
                <ul className="menu-row">
                  ...
                  <li className="menu-single-item">
                    ...
                    <ul>
                      <li>
                        <Link to="/single-brand-category">Toyota Camry</Link>
                      </li>
                      <li>
                        <Link to="/single-brand-category">Ford Mustang</Link>
                      </li>
                      <li>
                        <Link to="/single-brand-category">Volkswagen Golf</Link>
                      </li>
                      <li>
                        <Link to="/single-brand-category">
                          Mercedes C-Class
                      ...
                      <li>
                        <Link to="/single-brand-category">Audi A4</Link>
                      </li>
                      <li>
                        <Link to="/single-brand-category">Jeep Wrangler</Link>
                      </li>
                      <li>
                        <Link to="/single-brand-category">Mazda CX-5</Link>
                      </li>
                      <li>
                        <Link to="/single-brand-category">
                          Chevrolet Corvette
            ...
            <li className="position-inherit">
              ...
              <i onClick={() => toggleMenu("use-car")} className={`bi bi-${state.activeMenu === "use-car" ?"dash":"plus"} dropdown-icon d-lg-none d-block`} />
            ...
            />
              <ul className={`sub-menu ${
                ...
                <li>
                  <Link to="/brand-category">Brand Category</Link>
                </li>
                <li>
                  <Link to="/single-brand-category">Single Brand Category</Link>
                </li>
                <li>
                ...
                />
                  ...
                  <ul  className={`sub-menu ${
                    ...
                    <li>
                      <Link to="car-listing-left-sidebar">
                        Car Listing Left Sidebar
                      </Link>
                    </li>
                    <li>
                      <Link to="car-listing-right-sidebar">
                        Car Listing Right Sidebar
                      </Link>
                    </li>
                    <li>
                      <Link to="car-listing-no-sidebar">
                        Car Listing No Sidebar
                      </Link>
                    </li>
                  </ul>
                </li>
                ...
                <li>
                  <Link to="car-deatils">Car Details </Link>
                </li>
                <li>
                  <Link to="car-auction-details">Car Auction Details</Link>
                </li>
                <li>
                  <Link to="compare"> Compare Car</Link>
                </li>
                <li>
                  <a href="#">Shop</a>
                  <i className="d-lg-flex d-none bi bi-chevron-right dropdown-icon" />
                ...
                <li>
                  <Link to="/return-enchange">Return &amp; Exchange</Link>
                </li>
              </ul>
            </li>
            <li>
              <Link to="/contact" className="drop-down">
                CONTACT US
              </Link>
            </li>
          </ul>
