...
const Home6Destinaiton = () => {
 ...
 const settings = useMemo(()=>{
  ...
  <div className="row">
    <div className="col-lg-12">
      <Swiper {...settings} className="swiper home6-destination-card-slider">
        <div className="swiper-wrapper">
          <SwiperSlide className="swiper-slide">
            <div className="destination-card4">
              <Link href="/destination/destination-details" className="card-img">
                <img src="assets/img/home6/destination-card-img1.jpg" alt="" />
              </Link>
          ...
          <SwiperSlide className="swiper-slide">
            <div className="destination-card4">
              <Link href="/destination/destination-details" className="card-img">
                <img src="assets/img/home6/destination-card-img2.jpg" alt="" />
              </Link>
              <div className="card-content-wrap">
                <div className="batch">
                  <ul>
          ...
          <SwiperSlide className="swiper-slide">
            <div className="destination-card4">
              <Link href="/destination/destination-details" className="card-img">
                <img src="assets/img/home6/destination-card-img3.jpg" alt="" />
              </Link>
              <div className="card-content-wrap">
                <div className="batch">
                  <ul>
                ...
                <div className="card-content">
                  <h4><Link href="/destination/destination-details">Egypt</Link></h4>
                </div>
              </div>
            </div> 
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="destination-card4">
              <Link href="/destination/destination-details" className="card-img">
                <img src="assets/img/home6/destination-card-img4.jpg" alt="" />
              </Link>
              <div className="card-content-wrap">
                <div className="batch">
                  <ul>
          ...
          <SwiperSlide className="swiper-slide">
            <div className="destination-card4">
              <Link href="/destination/destination-details" className="card-img">
                <img src="assets/img/home6/destination-card-img5.jpg" alt="" />
              </Link>
              <div className="card-content-wrap">
                <div className="batch">
                  <ul>
          ...
          <SwiperSlide className="swiper-slide">
            <div className="destination-card4">
              <Link href="/destination/destination-details" className="card-img">
                <img src="assets/img/home6/destination-card-img6.jpg" alt="" />
              </Link>
              <div className="card-content-wrap">
                <div className="batch">
                  <ul>
                ...
                <div className="card-content">
                  <h4><Link href="/destination/destination-details">Turkey</Link></h4>
                </div>
              </div>
            </div> 
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="destination-card4">
              <Link href="/destination/destination-details" className="card-img">
                <img src="assets/img/home6/destination-card-img7.jpg" alt="" />
              </Link>
              <div className="card-content-wrap">
                <div className="batch">
                  <ul>
          ...
          <SwiperSlide className="swiper-slide"> 
            <div className="destination-card4">
              <Link href="/destination/destination-details" className="card-img">
                <img src="assets/img/home6/destination-card-img8.jpg" alt="" />
              </Link>
              <div className="card-content-wrap">
                <div className="batch">
                  <ul>
    ...
    <div className="row">
      <div className="col-lg-12">
        <div className="slider-btn-grp two d-md-flex d-none justify-content-between">
          ...
          <Link href="/destination" className="secondary-btn4">View All Destination</Link>
