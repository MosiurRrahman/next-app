...
const Destination1 = () => {
  ...
  <img src="assets/img/home1/section-vector2.png" alt="" className="section-vector2" />
    ...
    <div className="row g-4">
      ...
      <div className="col-lg-3 col-sm-6">
        <div className="destination-card">
          ...
          <div className="content">
            <h4><Link href="/destination/destination-details">Europe</Link></h4>
            <div className="eg-tag">
              <span>
                50 Tour
              </span>
      ...
      <div className="col-lg-4 col-sm-6">
        <div className="destination-banner">
          <div className="destination-banner-content">
            ...
            <Link href="/destination1" className="primary-btn1">View All Destination</Link>
          </div>
        </div>
      </div>
    </div>
