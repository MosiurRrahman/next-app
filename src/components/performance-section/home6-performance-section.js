...
const Home6PerformanceSection = () => {
  ...
  <svg className="scroll-svg2" width={1480} height={433} viewBox="0 0 1480 433" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path id="route-1" d="M720.5 10C783.834 13 940 31.5 918.5 113.5C899.258 186.89 427.834 161.333 178.5 138C131.5 132.333 60.5014 146 34.0003 173C-30.941 239.164 34.0001 363 255.5 291.5C409.69 241.728 480.001 385.5 697 302C936.501 209.842 1381 213 1470 422.5" stroke="#DAE2FF" strokeWidth={20} strokeLinecap="round" />
  </svg>
    ...
    <div className="row g-lg-4 gy-5 align-items-end justify-content-between mb-70">
      <div className="col-lg-6">
        <div className="section-title3 text-animation">
          ...
          <p>Cloud-based solution that simplifies project management, allowing teams to focus on
            delivering high-quality results without the complexities.</p>
        </div>
      </div>
    ...
    <div className="performance-slider-wrap">
      <div className="row">
        <div className="col-lg-12">
          <Swiper {...settings} className="swiper home6-performance-slider">
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div className="performance-card">
                  <div className="performance-img">
                    <img src="assets/img/home6/performance-img1.png" alt="" />
                  </div>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="performance-card">
                  <div className="performance-img">
                    <img src="assets/img/home6/performance-img2.png" alt="" />
                  </div>
                  <div className="performance-content">
              ...
              <SwiperSlide className="swiper-slide">
                <div className="performance-card">
                  <div className="performance-img">
                    <img src="assets/img/home6/performance-img3.png" alt="" />
                  </div>
                  <div className="performance-content">
              ...
              <SwiperSlide className="swiper-slide">
                <div className="performance-card">
                  <div className="performance-img">
                    <img src="assets/img/home6/performance-img4.png" alt="" />
                  </div>
                  <div className="performance-content">
