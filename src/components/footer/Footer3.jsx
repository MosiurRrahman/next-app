        ...
        <div className="col-lg-3 col-md-6 col-sm-6">
          <div className="footer-widget">
            <div className="footer-logo">
              <Link href="/"><img src="assets/img/logo2.svg" alt="" /></Link>
            </div>
            <h3>Want <span>to Take <br /></span> Tour Packages<span>?</span></h3>
            <Link href="/package" className="primary-btn1">Book A Tour</Link>
          </div>
        </div>
        <div className="col-lg-2 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-sm-start">
          <div className="footer-widget">
            ...
            <ul className="widget-list">
              ...
              <li><Link href="/package">Tour Package</Link></li>
              <li><Link href="/guide">Tour Guide</Link></li>
