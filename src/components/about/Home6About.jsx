                        ...
                        <div className="counter-area">
                          <div className="counter-content-wrap">
                            <div className="number">
                              <h5 className="counter"><CountUp delay={2} end={60} /></h5>
                              <span>K+</span>
                            </div>
                            <p>Tours <br />Success</p>
                          </div>
                        </div>
                      </div>
                      <div className="video-wrapper">
                        <img src="assets/img/home6/about-video-img.jpg" alt="" />
                        <a style={{ cursor: "pointer" }}
    onClick={() => setOpen(true)} className="video-area video5">
                          <div className="icon">
