...
function index() {
  ...
  <div className="topbar-header">
    ...
    <header ref={headerRef} className={state.scrollY?"header-area style-2 sticky":"header-area style-2"}>
              ...
              <ul className="menu-row">
                ...
                <li className="menu-single-item">
                  ...
                  <ul>
                    ...
                    <li><Link legacyBehavior href="/single-brand-category"><a>Chevrolet Corvette</a></Link></li>
                    <li className="explore-more-btn">
                      <a href="brand-category">Explore More <i className="bi bi-arrow-right" /></a>
                    </li>
                  </ul>
                </li>
                <li className="menu-single-item">
