              ...
              <div className="project-card">
                ...
                <div className="project-content">
                  <div className="category-title">
                    ...
                    <h4><Link legacyBehavior href="/portfolio-details"><a>Information Technology (IT)</a></Link></h4>
                  </div>
              ...
              <div className="project-card">
                ...
                <div className="project-content">
                  <div className="category-title">
                    ...
                    <h4><Link legacyBehavior href="/portfolio-details"><a>International Business</a></Link></h4>
                  </div>
                   <Link legacyBehavior href="/portfolio-details">
                    <a className="explore-btn">
                    Explore More
              ...
              <div className="project-card">
                ...
                <div className="project-content">
                  <div className="category-title">
                    ...
                    <h4><Link legacyBehavior href="/portfolio-details"><a>Marketing Research</a></Link></h4>
                  </div>
                   <Link legacyBehavior href="/portfolio-details">
                    <a className="explore-btn">
                    Explore More
              ...
              <div className="project-card">
                ...
                <div className="project-content">
                  <div className="category-title">
                    ...
                    <h4><Link legacyBehavior href="/portfolio-details"><a>Human Resources</a></Link></h4>
                  </div>
                   <Link legacyBehavior href="/portfolio-details">
                    <a className="explore-btn">
                    Explore More
              ...
              <div className="project-card">
                ...
                <div className="project-content">
                  <div className="category-title">
                    ...
                    <h4><Link legacyBehavior href="/portfolio-details"><a>Finance Consulting</a></Link></h4>
                  </div>
                   <Link legacyBehavior href="/portfolio-details">
                    <a className="explore-btn">
                    Explore More
