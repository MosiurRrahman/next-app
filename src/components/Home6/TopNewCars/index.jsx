        ...
        <div className="home6-filter-area d-flex align-items-center justify-content-between">
          <ul className="nav nav-tabs" id="myTab3" role="tablist">
            <li className="nav-item" role="presentation">
              <button className="nav-link active" id="popular1-tab" data-bs-toggle="tab" data-bs-target="#popular1" type="button" role="tab" aria-controls="popular1" aria-selected="true">Popular</button>
            </li>
            <li className="nav-item" role="presentation">
              <button className="nav-link" id="latest2-tab" data-bs-toggle="tab" data-bs-target="#latest2" type="button" role="tab" aria-controls="latest2" aria-selected="false">Latest</button>
            </li>
            <li className="nav-item" role="presentation">
              <button className="nav-link" id="upcomming3-tab" data-bs-toggle="tab" data-bs-target="#upcomming3" type="button" role="tab" aria-controls="upcomming3" aria-selected="false">Upcoming</button>
            </li>
          </ul>
    ...
    <div className="row  wow fadeInUp" data-wow-delay="400ms">
      <div className="col-lg-12">
        <div className="tab-content" id="myTab3Content">
          <div className="tab-pane fade show active" id="popular1" role="tabpanel" aria-labelledby="popular1-tab">
            <div className="row">
              <div className="col-lg-12">
          ...
          <div className="tab-pane fade" id="latest2" role="tabpanel" aria-labelledby="latest2-tab">
            <div className="row">
              <div className="col-lg-12">
                <Swiper {...slideSetting} className="swiper home6-top-use-car-slider">
                  <div className="swiper-wrapper">
          ...
          <div className="tab-pane fade" id="upcomming3" role="tabpanel" aria-labelledby="upcomming3-tab">
            <div className="row">
              <div className="col-lg-12">
                <Swiper {...slideSetting} className="swiper home6-top-use-car-slider">
                  <div className="swiper-wrapper">
