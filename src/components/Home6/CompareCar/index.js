            ...
            <div className="tab-pane active" id="toyota" role="tabpanel" aria-labelledby="toyota-tab">
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Toyota 86</a></h6>
                          <h6 className="price">$68, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Toyota Prius</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
              ...
              <div className="compare-btn-and-slider-btn">
                <div className="see-all-btn">
                  <a className="view-btn2" href="compare.html">
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">E Class</a></h6>
                          <h6 className="price">$68, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Glc</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Gla</a></h6>
                          <h6 className="price">$70, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">A Class</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">GLB</a></h6>
                          <h6 className="price">$93, 740.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Tesla Model S</a></h6>
                          <h6 className="price">$68, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Tesla Model 3</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Tesla Model X</a></h6>
                          <h6 className="price">$70, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Tesla Model Y</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Tesla Roadster</a></h6>
                          <h6 className="price">$90, 319.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Tesla Cybertruck</a></h6>
                          <h6 className="price">$93, 740.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Mazda3</a></h6>
                          <h6 className="price">$68, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Mazda6</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Mazda MX-5</a></h6>
                          <h6 className="price">$70, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Mazda CX-3</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Mazda Demio</a></h6>
                          <h6 className="price">$90, 319.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Mazda CX-9</a></h6>
                          <h6 className="price">$93, 740.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Ferrari 488</a></h6>
                          <h6 className="price">$68, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Ferrari 458</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Ferrari F430</a></h6>
                          <h6 className="price">$70, 219.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Ferrari F40</a></h6>
                          <h6 className="price">$78, 729.000</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="single-compare-card style-2">
                    <div className="compare-top">
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Ferrari Enzo</a></h6>
                          <h6 className="price">$90, 319.000</h6>
                        </div>
                      </div>
                      <div className="vs">
                      ...
                      <div className="single-car">
                        ...
                        <div className="content text-center">
                          <h6 className="title"><a href="car-deatils.html">Ferrari 250 GTO</a></h6>
                          <h6 className="price">$93, 740.000</h6>
                        </div>
                      </div>
                    </div>
