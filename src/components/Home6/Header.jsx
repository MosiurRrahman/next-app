...
function Header() {
  ...
  return (
    <>
    <header ref={headerRef} className={state.scrollY > 10 ?"header-area style-6 sticky":"header-area style-6"} >
  ...
  <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
    ...
    <div className="topbar-right d-lg-none d-block">
      ...
      <button type="button" className="primary-btn6" data-bs-toggle="modal" data-bs-target="#signUpModal01">
