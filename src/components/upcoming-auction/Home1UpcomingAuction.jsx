  ...
  <div className="upcoming-auction-wrapper">
    <div className="row mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
      <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
        ...
        <a className="view-button" href="auction-grid.html">
          View All Auction
                ...
                <div className="row g-4">
                  <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="auction-card">
                      <div className="auction-card-img-wrap">
                        <a href="auction-details.html" className="card-img">
                      ...
                      <div className="auction-card-content">
                        <h6><a href="auction-details.html">Velocity Visions Performance Meets Precision.</a>
                        </h6>
                        ...
                        <div className="author-and-btn-area">
                          <a href="auction-details2.html" className="bid-btn">
                            Notify Me
                          </a>
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="auction-card">
                      ...
                      <div className="auction-card-content">
                        <h6><a href="auction-details.html">Performance Empowering Your Drive Prime.</a></h6>
                        <div className="price-and-code-area">
                          <div className="price">
                            <span>Current Bid at:</span>
                            <strong>$9,458</strong>
                  ...
                  <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="auction-card">
                      ...
                      <div className="auction-card-content">
                        <h6><a href="auction-details.html">Nexus Drives Connecting You to the Future.</a>
                        </h6>
                        <div className="price-and-code-area">
                          <div className="price">
                            <span>Current Bid at:</span>
                  ...
                  <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div className="auction-card">
                      ...
                      <div className="auction-card-content">
                        <h6><a href="auction-details.html">Apex Automotive Excellence New Heights. </a></h6>
                        <div className="price-and-code-area">
                          <div className="price">
                            <span>Current Bid at:</span>
                            <strong>$6,367</strong>
                  ...
                  <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div className="auction-card">
                      ...
                      <div className="auction-card-content">
                        <h6><a href="auction-details.html">Horizon Motors an Expanding Your Journey.</a>
                        </h6>
                        <div className="price-and-code-area">
                          <div className="price">
                            <span>Current Bid at:</span>
                  ...
                  <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="auction-card">
                      ...
                      <div className="auction-card-content">
                        <h6><a href="auction-details.html">Genesis Motors Pioneering Tomorrow's Drive.</a></h6>
                        <div className="price-and-code-area">
                          <div className="price">
                            <span>Current Bid at:</span>
                            <strong>$5,578</strong>
