            ...
            <div className="col-lg-8">
              <div className="section-title">
                <div className="text-animation">
                  <h2>
                    Build &amp; enhance brand <br /> within 08 months.
                  </h2>
                </div>
                        ...
                        <div className="col-lg-5">
                          <div className="testimonial-img-wrap">
                            <div className="testimonial-img">
                              <img
                                src="assets/img/home3/testimonial-img-01.png"
                                alt=""
                              />
                            </div>
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <div className="c-name-and-author">
                              <img
                                className="dark"
                                src="assets/img/home3/icon/client-logo.svg"
                                alt=""
                              />
                              <img
                                className="light"
                                src="assets/img/home3/icon/client-logo-white.svg"
                                alt=""
                              />
                              <span>
                                ( Mr. Noufel Haque, CEO &amp; Founder )
                              </span>
                            </div>
                            <p>
                              Establish a customer advisory board with
                              representatives depending on the client's needs,
                              industry.
                            </p>
                      ...
                      <div className="row g-lg-4 gy-5">
                        <div className="col-lg-5">
                          <div className="testimonial-img-wrap">
                            <div className="testimonial-img">
                              <img
                                src="assets/img/home3/testimonial-img-02.png"
                                alt=""
                              />
                            </div>
                            <div className="video-icon">
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <div className="c-name-and-author">
                              <img
                                className="dark"
                                src="assets/img/home3/icon/client-logo2.svg"
                                alt=""
                              />
                              <img
                                className="light"
                                src="assets/img/home3/icon/client-logo2-white.svg"
                                alt=""
                              />
                              <span>
                                ( Mr. Danial Scoot, CEO &amp; Founder )
                              </span>
                            </div>
                            <p>
                              Create a customer advisory council and appoint
                              representatives based on the needs and sector of
                              the client.
                            </p>
                            <ul className="counter-wrap">
                              <li className="single-counter">
                      ...
                      <div className="row g-lg-4 gy-5">
                        <div className="col-lg-5">
                          <div className="testimonial-img-wrap">
                            <div className="testimonial-img">
                              <img
                                src="assets/img/home3/testimonial-img-03.png"
                                alt=""
                              />
                            </div>
                            <div className="video-icon">
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <div className="c-name-and-author">
                              <img
                                className="dark"
                                src="assets/img/home3/icon/client-logo3.svg"
                                alt=""
                              />
                              <img
                                className="light"
                                src="assets/img/home3/icon/client-logo3-white.svg"
                                alt=""
                              />
                              <span>
                                ( Mr. David Beckham, CEO &amp; Founder )
                              </span>
                            </div>
                            <p>
                              Depending on the demands and industry of the
                              client, a customer advisory board should be
                      ...
                      <div className="row g-lg-4 gy-5">
                        <div className="col-lg-5">
                          <div className="testimonial-img-wrap">
                            <div className="testimonial-img">
                              <img
                                src="assets/img/home3/testimonial-img-04.png"
                                alt=""
                              />
                            </div>
                            <div className="video-icon">
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <div className="c-name-and-author">
                              <img
                                className="dark"
                                src="assets/img/home3/icon/client-logo4.svg"
                                alt=""
                              />
                              <img
                                className="light"
                                src="assets/img/home3/icon/client-logo4-white.svg"
                                alt=""
                              />
                              <span>
                                ( Mr. Sakib Al Hasan, CEO &amp; Founder )
                              </span>
                            </div>
                            <p>
                              Form a group of advisors for customers, selecting
                              people based on the needs and sector of the
                              client.
                            </p>
                            <ul className="counter-wrap">
                              <li className="single-counter">
