...
const Home3Accordion = () => {
  ...
  <img src="assets/img/home3/vector/accordion-with-tab-vector1.svg" alt="" className="vector1" />
  <img src="assets/img/home3/vector/accordion-with-tab-vector2.svg" alt="" className="vector2" />
      ...
      <div className="col-lg-6">
        <div className="accordion-with-tab-content">
          ...
          <div className="accordion-with-tab-wrap">
            <ul className="nav nav-pills" id="pills-accordion-tab" role="tablist">
              <li className="nav-item" role="presentation">
                <button className="nav-link active" id="g-travel-tab" data-bs-toggle="pill" data-bs-target="#g-travel" type="button" role="tab" aria-controls="g-travel" aria-selected="true">General Travel</button>
              </li>
              <li className="nav-item" role="presentation">
                <button className="nav-link" id="transportation-tab" data-bs-toggle="pill" data-bs-target="#transportation" type="button" role="tab" aria-controls="transportation" aria-selected="false">Transportation</button>
              </li>
              <li className="nav-item" role="presentation">
            ...
            <div className="tab-content" id="pills-accordion-tabContent">
              <div className="tab-pane fade show active" id="g-travel" role="tabpanel" aria-labelledby="g-travel-tab">
              ...
              <div className="tab-pane fade" id="transportation" role="tabpanel" aria-labelledby="transportation-tab">
                <div className="faq-content">
                  <div className="accordion" id="accordionTransportation">
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="transportationheadingOne">
                        <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#transportationcollapseOne" aria-expanded="true" aria-controls="transportationcollapseOne">
                          01. How do I book a trip with your agency?
                        </button>
                      </h2>
                      <div id="transportationcollapseOne" className="accordion-collapse collapse show" aria-labelledby="transportationheadingOne" data-bs-parent="#accordionTransportation">
                        <div className="accordion-body">
                          Aptent taciti sociosqu ad litora torquent per conubia nostra, per inci only Integer purus onthis felis non aliquam.Mauris nec just vitae ann auctor tol euismod sit amet non ipsul growing this.
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="transportationheadingTwo">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#transportationcollapseTwo" aria-expanded="false" aria-controls="transportationcollapseTwo">
                          02. What payment methods do you accept?
                        </button>
                      </h2>
                      <div id="transportationcollapseTwo" className="accordion-collapse collapse" aria-labelledby="transportationheadingTwo" data-bs-parent="#accordionTransportation">
                        <div className="accordion-body">
                          Aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos only Integer purus onthis
                          placerat felis non aliquam.Mauris nec justo vitae ante auctor tol euismod sit amet non ipsul growing this 
                          Praesent commodo at massa eget suscipit. Utani vitae enim velit.
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="transportationheadingThree">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#transportationcollapseThree" aria-expanded="false" aria-controls="transportationcollapseThree">
                          03. What is your cancellation policy?
                        </button>
                      </h2>
                      <div id="transportationcollapseThree" className="accordion-collapse collapse" aria-labelledby="transportationheadingThree" data-bs-parent="#accordionTransportation">
                        <div className="accordion-body">
                          Aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos only Integer purus onthis
                          placerat felis non aliquam.Mauris nec justo vitae ante auctor tol euismod sit amet non ipsul growing this 
                          Praesent commodo at massa eget suscipit. Utani vitae enim velit.
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="transportationheadingFour">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#transportationcollapseFour" aria-expanded="false" aria-controls="transportationcollapseFour">
                          04. Can I make changes my reservation after booking?
                        </button>
                      </h2>
                      <div id="transportationcollapseFour" className="accordion-collapse collapse" aria-labelledby="transportationheadingFour" data-bs-parent="#accordionTransportation">
                        <div className="accordion-body">
                          Aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos only Integer purus onthis
                          placerat felis non aliquam.Mauris nec justo vitae ante auctor tol euismod sit amet non ipsul growing this 
                          Praesent commodo at massa eget suscipit. Utani vitae enim velit.
