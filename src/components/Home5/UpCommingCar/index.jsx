...
function index() {
  ...
  return (
    <div className="home5-upcomming-car-section pt-90 pb-90 mb-100">
  <div className="container">
    ...
    <div className="row wow fadeInUp" data-wow-delay="300ms">
      <div className="col-lg-12">
        <Swiper {...slideSettings} className="swiper home5-fetured-slider">
          <div className="swiper-wrapper">
            <SwiperSlide className="swiper-slide">
              <div className="product-card5 two">
                  ...
                  <div className="swiper product-img-slider">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <img src="assets/img/home5/feature-car-01.png" alt="image" />
                      </div>
                      <div className="swiper-slide">
                        <img src="assets/img/home5/feature-car-01.png" alt="image" />
                      </div>
              ...
              <div className="product-card5 two">
                <div className="product-img">
                  ...
                  <div className="swiper product-img-slider">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <img src="assets/img/home5/feature-car-02.png" alt="image" />
                      </div>
                      <div className="swiper-slide">
                        <img src="assets/img/home5/feature-car-02.png" alt="image" />
                      </div>
                ...
                <div className="product-content">
                  <h6><a href="#">Nissan Altima S-2022</a></h6>
                  <div className="exp-date">
                    <p>Expected Date  <span>02 April, 2023</span></p>
                  </div>
                  <div className="content-btm">
              ...
              <div className="product-card5 two">
                <div className="product-img">
                  ...
                  <div className="swiper product-img-slider">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <img src="assets/img/home5/feature-car-03.png" alt="image" />
                      </div>
                      <div className="swiper-slide">
                        <img src="assets/img/home5/feature-car-03.png" alt="image" />
                      </div>
              ...
              <div className="product-card5 two">
                <div className="product-img">
                  ...
                  <div className="swiper product-img-slider">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <img src="assets/img/home5/feature-car-04.png" alt="image" />
                      </div>
                      <div className="swiper-slide">
                        <img src="assets/img/home5/feature-car-04.png" alt="image" />
                      </div>
