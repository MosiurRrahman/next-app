...
function index() {
  ...
  return (
    <div className="home5-banner-area">
      ...
      <Swiper {...slideSettings} className="swiper home3-banner-slider">
        <div className="swiper-wrapper">
          <SwiperSlide className="swiper-slide">
            <div className="banner-bg" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url(assets/img/home5/home5-banner-img-01.png)'}}>
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="banner-bg" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url(assets/img/home5/home5-banner-img-02.png)'}}>
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <div className="banner-bg" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.30) 0%, rgba(0, 0, 0, 0.30) 100%), url(assets/img/home5/home5-banner-img-03.png)'}}>
            </div>
          </SwiperSlide>
