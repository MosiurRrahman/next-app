...
function index() {
  ...
  return (
    <div className="home5-recent-car-section mb-100">
      ...
      <div className="row mb-50 wow fadeInUp" data-wow-delay="200ms">
        <div className="col-lg-12 d-flex align-items-end justify-content-between gap-3 flex-wrap">
          ...
          <div className="slider-btn-and-exp-btn">
            <div className="explore-more-btn two three">
      ...
      <div className="row wow fadeInUp" data-wow-delay="200ms">
        <div className="col-lg-12">
          <div className="slick-wrapper">
            <Slider {...settings} id="slick3">
              <div className="slide-item">
                <div className="product-st-card1">
                    ...
                    <div className="swiper product-img-slider">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <img className="img-fluid" src="assets/img/home5/product-st-01.png" alt="image" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/car-deatils"><a>Mercedes-Benz Class-2023</a></Link></h6>
                ...
                <div className="product-st-card1">
                  <div className="product-img">
                    ...
                    <div className="swiper product-img-slider">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <img className="img-fluid" src="assets/img/home5/product-st-02.png" alt="image" />
                        </div>
                        <div className="swiper-slide">
                          <img className="img-fluid" src="assets/img/home5/product-st-02.png" alt="image" />
                        </div>
                ...
                <div className="product-st-card1">
                  <div className="product-img">
                    ...
                    <div className="swiper product-img-slider">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <img className="img-fluid" src="assets/img/home5/product-st-03.png" alt="image" />
                        </div>
                        <div className="swiper-slide">
                          <img className="img-fluid" src="assets/img/home5/product-st-03.png" alt="image" />
                        </div>
                  ...
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/car-deatils"><a>Audi A4s-2023</a></Link></h6>
                    <ul className="features">
                      <li>
                        <img src="assets/img/home4/icon/menual.svg" alt="" />
                        Automatic
                ...
                <div className="product-st-card1">
                  <div className="product-img">
                    ...
                    <div className="swiper product-img-slider">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <img className="img-fluid" src="assets/img/home5/product-st-04.png" alt="image" />
                        </div>
                        <div className="swiper-slide">
                          <img className="img-fluid" src="assets/img/home5/product-st-04.png" alt="image" />
                        </div>
                  ...
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/car-deatils"><a>Mazda MX-5 Miata-2023</a></Link></h6>
                    <ul className="features">
                      <li>
                        <img src="assets/img/home4/icon/menual.svg" alt="" />
                        Automatic
