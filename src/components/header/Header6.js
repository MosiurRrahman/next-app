...
const Header6 = () => {
  ...
  return (
    ...
    <div className="header-wrap">
        ...
        <Link legacyBehavior href="/"><a><img alt="image" className="img-fluid" src="assets/img/black-logo.svg" /></a></Link>
        </div>
        <div className="menu-wrap">
        <div className="main-menu">
            <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div className="mobile-logo-wrap">
                <Link legacyBehavior href="/"><a><img alt="image" src="assets/img/black-logo.svg" /></a></Link>
            </div>
            </div>
        ...
        <div className="nav-right d-flex jsutify-content-end align-items-center">
            ...
            <div className={`search-input ${state.isSearchBarOpen? "active":""}`}>
                ...
                <div className="quick-search">
                    <ul>
                    <li>Quick Search :</li>
                    <li><Link legacyBehavior href="/service"><a>Technology,</a></Link></li>
                    <li><Link legacyBehavior href="/service"><a>Finance consulting,</a></Link></li>
                    <li><Link legacyBehavior href="/service"><a>Human Resources,</a></Link></li>
                    <li><Link legacyBehavior href="/service"><a>Management,</a></Link></li>
                    <li><Link legacyBehavior href="/service"><a>Marketing Research,</a></Link></li>
                    <li><Link legacyBehavior href="/service-details"><a>International Business.</a></Link></li>
                    </ul>
                </div>
                </form>
            </div>
