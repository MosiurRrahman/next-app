        ...
        <header className="header-area style-3">
          <div className="main-menu">
            <div className="logo-area d-lg-none d-flex">
              <Link legacyBehavior href="/"><a><img src="assets/img/white-logo.svg" alt="" /></a></Link>
            </div>
            ...
            <div className="d-xxl-none d-lg-block d-none">
              <form className="mobile-menu-form mb-5">
                <div className="input-with-btn d-flex flex-column">
                  ...
                  <button type="submit" className="primary-btn1 btn-hover">Search <span /></button>
                </div>
              </form>
            </div>
            <div className="d-lg-none d-block">
              ...
              <Link legacyBehavior href="/contact">
                ...
                <span style={{top: '232.625px', left: '96.7812px'}} />
                </a>
              </Link>
            </div>
            <ul className="tags d-lg-flex d-none">
              <li><Link legacyBehavior href="/career"><a>Careers</a></Link></li>
              <li><Link legacyBehavior href="/blog-standard"><a>News &amp; Insight</a></Link></li>
              <li><Link legacyBehavior href="/contact"><a>Join Us</a></Link></li>
            </ul>
          </div>
        </header>
        {/* End header section */}
          ...
          <Swiper {...setting} className="swiper banner4-slider">
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div className="banner-wrapper" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.45) 0%, rgba(0, 0, 0, 0.45) 100%), url(assets/img/home4/banner-img-02.jpg)'}}>
                  <div className="banner-content">
                    <Link legacyBehavior href="/services1"><a>Business</a></Link>
                    <h1><Link legacyBehavior href="/service-details"><a>International Business</a></Link></h1>
                    <p>Business consulting is a professional service provided by individuals or firms to help organizations improve their performance</p>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="banner-wrapper" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.45) 0%, rgba(0, 0, 0, 0.45) 100%), url(assets/img/home4/banner-img-03.jpg)'}}>
                  <div className="banner-content">
                    <Link legacyBehavior href="/services1"><a>Marketing</a></Link>
                    <h1><Link legacyBehavior href="/service-details"><a>Marketing Research</a></Link></h1>
                    <p>Helping clients improve their marketing and sales strategies to increase revenue and market share.</p>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="banner-wrapper" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.45) 0%, rgba(0, 0, 0, 0.45) 100%), url(assets/img/home4/banner-img-04.jpg)'}}>
                  <div className="banner-content">
                    <Link legacyBehavior href="/services1"><a>Consulting</a></Link>
                    <h1><Link legacyBehavior href="/service-details"><a>Finance Consulting</a></Link></h1>
                    <p>Providing financial advice, including cost reduction strategies, financial planning, and risk management.</p>
                  </div>
                </div>
              </SwiperSlide>
            </div>
