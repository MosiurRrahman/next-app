    ...
    <div className="container-lg container-fluid bg-white">
      <div className="row p-12 align-items-center position-relative">
        <div className="col-lg-5 d-flex align-items-center justify-content-md-start justify-content-center">
          <div className="vector-left"><img src="assets/images/bg/topbar-vec-left.png" alt="" /></div>
          <div className="welcome-note">
            <p>Welcome Our Restho Restaurant! <a href="reservation.html">For Private Event</a></p>
          </div>
        </div>
        <div className="col-lg-7 d-flex justify-content-lg-end justify-content-center align-items-center">
          <div className="vector-right"><img src="assets/images/bg/topbar-vec-right.png" alt="" /></div>
  ...
  <header className="header-area style-3">
    <div className="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div className="main-menu">
        ...
        <ul className="menu-list">
          <li className="menu-item-has-children active">
            ...
            <ul className="sub-menu">
              ...
              <li><Link className="active" href="/index3">Home Three</Link></li>
            </ul>
          </li>
        ...
        <div className="reservation-btns d-lg-none d-flex">
          <a href="reservation.html" className="primary-btn6 btn-md">Find Reservation</a>
        </div>
      </div>
