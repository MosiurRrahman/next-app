  ...
  return (
    <>
     <Sidebar isMenuOpen={isMenuOpen} toggleMenu={toggleMenu} />
      <header className="header-area style-1 two">
    <div className="header-logo">
      <Link href="/"><img alt="image" className="img-fluid light" src="assets/img/dm-dark.svg" /></Link>
      <Link href="/"><img alt="image" className="img-fluid dark" src="assets/img/dm-light.svg" /></Link>
    </div>
