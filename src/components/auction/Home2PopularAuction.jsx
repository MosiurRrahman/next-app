        ...
        <div className="container-fluid">
          <div className="home2-popular-auction-wrap">
                ...
                <div className="row mb-25">
                  <div className="col-lg-12">
                    <div className="section-title">
                      <h2>Highest <span>Bidding.</span></h2>
                    </div>
                  </div>
                </div>
                <div className="highest-bidding-card-wrap">
                  <div className="auction-card style-2 mb-25">
                    <div className="auction-card-content">
                      <h6><Link href="/car-auction/auction-details">Roar Auto Illuminating Your Drive.</Link></h6>
                      <div className="price-and-code-area">
                        ...
                        <div className="batch">
                          <span className="live">
                            <svg width={9} height={9} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="auction-card style-2 mb-25">
                    <div className="auction-card-content">
                      <h6><Link href="/car-auction/auction-details">Xus Drives Connecting You To The.</Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$8,325</strong>
                  ...
                  <div className="auction-card style-2">
                    <div className="auction-card-content">
                      <h6><Link href="/car-auction/auction-details">Izon Motors Expanding Your Journey.</Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$9.245</strong>
            ...
            <div className="popular-auction-slider-area">
              <div className="row mb-60">
                <div className="col-lg-12">
                  <div className="section-title-and-btn-area d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div className="section-title">
                      <h2>Popular Auction <span>For You.</span></h2>
                    </div>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <Swiper {...settings} className="swiper home2-popular-auction-slider">
                    <div className="swiper-wrapper">
                      <SwiperSlide className="swiper-slide">
                        <div className="auction-card style-2 mb-25">
                          <div className="auction-card-img-wrap">
                            <Link href="/car-auction/auction-details" className="card-img">
                              <img src="../assets/img/home2/home2-popular-auction-img1.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/car-auction/auction-details">Horizon Motors Expanding Your Journey.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$2,898</strong>
                        ...
                        <div className="auction-card style-2">
                          <div className="auction-card-img-wrap">
                            <Link href="/car-auction/auction-details" className="card-img">
                              <img src="../assets/img/home2/home2-popular-auction-img2.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/car-auction/auction-details">Prime Per for Empowering Your Drive.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$6,648</strong>
                      ...
                      <SwiperSlide className="swiper-slide">
                        <div className="auction-card style-2 mb-25">
                          <div className="auction-card-img-wrap">
                            <Link href="/car-auction/auction-details" className="card-img">
                              <img src="../assets/img/home2/home2-popular-auction-img3.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/car-auction/auction-details">Nexus Driveso Connecting You to the Future.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$8,457</strong>
                        ...
                        <div className="auction-card style-2">
                          <div className="auction-card-img-wrap">
                            <Link href="/car-auction/auction-details" className="card-img">
                              <img src="../assets/img/home2/home2-popular-auction-img4.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/car-auction/auction-details">Aurora Autosi Illuminating Your Driver.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$5,274</strong>
                      ...
                      <diSwiperSlidev className="swiper-slide">
                        <div className="auction-card style-2 mb-25">
                          <div className="auction-card-img-wrap">
                            <Link href="/car-auction/auction-details" className="card-img">
                              <img src="../assets/img/home2/home2-popular-auction-img5.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/car-auction/auction-details">Eclipse on Car Redefining the Road Ahead.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$7,345</strong>
                        ...
                        <div className="auction-card style-2">
                          <div className="auction-card-img-wrap">
                            <Link href="/car-auction/auction-details" className="card-img">
                              <img src="../assets/img/home2/home2-popular-auction-img6.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/car-auction/auction-details">Velocity Visions Precision Performance Meets.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$4,648</strong>
