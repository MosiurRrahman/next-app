        ...
        <div className="container">
          <div className="row mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
              ...
              <Link className="view-button2 two" href="/gadget-and-technology/auction-grid">
                View All Auction
                <div className="arrow">
          ...
          <div className="auction-nav wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <nav>
              <div className="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <button className="nav-link" id="smart-phone-tab" data-bs-toggle="tab" data-bs-target="#smart-phone" type="button" role="tab" aria-controls="smart-phone" aria-selected="false">Smart Phone</button>
                <button className="nav-link" id="camera-tab" data-bs-toggle="tab" data-bs-target="#camera" type="button" role="tab" aria-controls="camera" aria-selected="false">Camera</button>
                <button className="nav-link" id="computer-tab" data-bs-toggle="tab" data-bs-target="#computer" type="button" role="tab" aria-controls="computer" aria-selected="false">Computers</button>
                <button className="nav-link" id="virtual-tab" data-bs-toggle="tab" data-bs-target="#virtual" type="button" role="tab" aria-controls="virtual" aria-selected="false">Virtual Reality</button>
              </div>
            </nav>
          </div>
          <div className="auction-tab-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="tab-content" id="nav-tabContent">
                    ...
                    <div className="row g-4">
                      <div className="col-lg-12">
                        <div className="auction-card style-5 horizontal-d">
                          <div className="auction-card-img-wrap">
                            <Link href="/gadget-and-technology/auction-details" className="card-img">
                              <img src="../assets/img/home5/auction-img7.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/gadget-and-technology/auction-details">Solar Sync Apple Iphone 15 Pro max.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$3,569</strong>
                      ...
                      <div className="col-lg-12">
                        <div className="auction-card style-5 horizontal-d">
                          <div className="auction-card-img-wrap">
                            <Link href="/gadget-and-technology/auction-details" className="card-img">
                              <img src="../assets/img/home5/auction-img8.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="upcoming">
                                <svg width={9} height={9} viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/gadget-and-technology/auction-details">Quantum Quick-Computer Cooling fan.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$5,725</strong>
                      ...
                      <div className="col-lg-12">
                        <div className="auction-card style-5 horizontal-d">
                          <div className="auction-card-img-wrap">
                            <Link href="/gadget-and-technology/auction-details" className="card-img">
                              <img src="../assets/img/home5/auction-img9.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/gadget-and-technology/auction-details">Nebula Noise-Canceling New Headphones.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$6,654</strong>
                      ...
                      <div className="col-lg-12">
                        <div className="auction-card style-5 horizontal-d">
                          <div className="auction-card-img-wrap">
                            <Link href="/gadget-and-technology/auction-details" className="card-img">
                              <img src="../assets/img/home5/auction-img10.jpg" alt="" />
                            </Link>
                            <div className="batch">
                              <span className="live">
                                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="auction-card-content">
                            <h6><Link href="/gadget-and-technology/auction-details">Marketplace Art Auction Extra Masterpiece.</Link></h6>
                            <div className="price-and-code-area">
                              <div className="price">
                                <span>Current Bid at:</span>
                                <strong>$7,217</strong>
              ...
              <div className="tab-pane fade" id="smart-phone" role="tabpanel" aria-labelledby="smart-phone-tab" tabIndex={0}>
                <div className="row g-4 justify-content-center">
                  <div className="col-xl-3 col-md-6 order-xl-1 order-1">
                    <div className="row g-4">
                      <div className="col-lg-12">
              ...
              <div className="tab-pane fade" id="camera" role="tabpanel" aria-labelledby="camera-tab" tabIndex={0}>
                <div className="row g-4 justify-content-center">
                  <div className="col-xl-3 col-md-6 order-xl-1 order-1">
                    <div className="row g-4">
                      <div className="col-lg-12">
              ...
              <div className="tab-pane fade" id="computer" role="tabpanel" aria-labelledby="computer-tab" tabIndex={0}>
                <div className="row g-4 justify-content-center">
                  <div className="col-xl-3 col-md-6 order-xl-1 order-1">
                    <div className="row g-4">
                      <div className="col-lg-12">
              ...
              <div className="tab-pane fade" id="virtual" role="tabpanel" aria-labelledby="virtual-tab" tabIndex={0}>
                <div className="row g-4 justify-content-center">
                  <div className="col-xl-3 col-md-6 order-xl-1 order-1">
                    <div className="row g-4">
                      <div className="col-lg-12">
