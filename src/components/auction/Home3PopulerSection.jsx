          ...
          <div className="row mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
              <div className="section-title2">
                <span><i className="bi bi-arrow-right" />WATCH OUR</span>
                <h2>Popular <span>Auctions.</span></h2>
              </div>
                  ...
                  <div className="swiper-wrapper">
                      ...
                      <div className="auction-card style-3">
                        <div className="auction-card-img-wrap">
                          <Link href="/antiques-auction/auction-details" className="card-img">
                            <img src="../assets/img/home3/auction-img11.jpg" alt="" />
                          </Link>
                          <div className="batch">
                            <span className="live">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/antiques-auction/auction-details">Empire style giltwood coffee maker table.</Link></h6>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-3">
                        <div className="auction-card-img-wrap">
                          <Link href="/antiques-auction/auction-details" className="card-img">
                            <img src="../assets/img/home3/auction-img12.jpg" alt="" />
                          </Link>
                          <div className="batch">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/antiques-auction/auction-details">Mid-century modern armcha gothic revival oak.</Link></h6>
                          <div className="price-and-code-area">
                            <div className="price">
                              <span>Current Bid at:</span>
                              <strong>$8,974</strong>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-3">
                        <div className="auction-card-img-wrap">
                          <Link href="/antiques-auction/auction-details" className="card-img">
                            <img src="../assets/img/home3/auction-img13.jpg" alt="" />
                          </Link>
                          <div className="batch">
                            <span className="live">
                              <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/antiques-auction/auction-details">Neo-classical marble busting rustic farmhouse.</Link></h6>
                          <div className="price-and-code-area">
                            <div className="price">
                              <span>Current Bid at:</span>
                              <strong>$4,648</strong>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-3">
                        <div className="auction-card-img-wrap">
                          <Link href="/antiques-auction/auction-details" className="card-img">
                            <img src="../assets/img/home3/auction-img14.jpg" alt="" />
                          </Link>
                          <div className="batch">
                            <span className="upcoming">
                              <svg width={9} height={9} viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/antiques-auction/auction-details">Artisan crafted silvered clock candelabra.</Link></h6>
                          <div className="price-and-code-area">
                            <div className="price">
                              <span>Current Bid at:</span>
                              <strong>$3,495</strong>
                      ...
                      <div className="auction-card style-3">
                        ...
                        <div className="auction-card-content">
                          ...
                          <div className="price-and-code-area">
                            ...
                            <Link href="/antiques-auction/auction-details" className="bid-btn">Bid Now</Link>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
