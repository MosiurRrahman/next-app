    ...
    <>
      <div className="home4-auction-close-section mb-120">
        <div className="container">
          ...
          <div className="row mb-50 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="col-lg-12">
              <Swiper {...setttings} className="swiper home4-auction-close-slider">
                <div className="swiper-wrapper">
                    ...
                    <div className="auction-card style-4">
                      <div className="auction-card-img-wrap">
                        <Link href="/art-auction/auction-details" className="card-img">
                          <img src="../assets/img/home4/auction-img13.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="live">
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/art-auction/auction-details">Artistry Auctions Discovering New Masterpieces.</Link></h6>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card style-4">
                      <div className="auction-card-img-wrap">
                        <Link href="/art-auction/auction-details" className="card-img">
                          <img src="../assets/img/home4/auction-img14.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="live">
                            <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/art-auction/auction-details">Auctioned Allegr Celebrating Artist Diversity.</Link></h6>
                        <div className="price-and-code-area">
                          <div className="price">
                            <span>Current Bid at:</span>
                            <strong>$4,648</strong>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card style-4">
                      <div className="auction-card-img-wrap">
                        <Link href="/art-auction/auction-details" className="card-img">
                          <img src="../assets/img/home4/auction-img15.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="live">
                            <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/art-auction/auction-details">Gallery Glamour Exclusive Art Auction Event.</Link></h6>
                        <div className="price-and-code-area">
                          <div className="price">
                            <span>Current Bid at:</span>
                            <strong>$8,974</strong>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card style-4">
                      <div className="auction-card-img-wrap">
                        <Link href="/art-auction/auction-details" className="card-img">
                          <img src="../assets/img/home4/auction-img16.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="live">
                            <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/art-auction/auction-details">Canvas Celebration Auction Art Spectacular.</Link></h6>
                        <div className="price-and-code-area">
                          <div className="price">
                            <span>Current Bid at:</span>
                            <strong>$5,237</strong>
          ...
          <div className="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="col-lg-12 d-flex justify-content-center">
              <Link className="primary-btn3 btn-hover" href="/art-auction/auction-grid">
                View All Auction
