          ...
          <div className="row mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
              <div className="section-title2">
                ...
                <h2>Highest Bidding <span>Auction</span></h2>
              </div>
            ...
            <div className="tab-pane fade show active" id="porcelain" role="tabpanel" aria-labelledby="porcelain-tab" tabIndex={0}>
              <div className="row g-4 mb-50">
                <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                  <div className="auction-card style-3">
                    ...
                    <div className="auction-card-content">
                      <h6><Link href="/antiques-auction/auction-details">Victorian silver color wall old clock set.</Link></h6>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                  <div className="auction-card style-3">
                    ...
                    <div className="auction-card-content">
                      <h6><Link href="/antiques-auction/auction-details">Art decorat bronze sculpture antique pot. </Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$4,648</strong>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                  <div className="auction-card style-3">
                    ...
                    <div className="auction-card-content">
                      <h6><Link href="/antiques-auction/auction-details">18th century chines antique porcelain vase.</Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$8,974</strong>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                  <div className="auction-card style-3">
                    ...
                    <div className="auction-card-content">
                      <h6><Link href="/antiques-auction/auction-details">Eclipse cars redefining thus road ahead auction.</Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$5,237</strong>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                  <div className="auction-card style-3">
                    ...
                    <div className="auction-card-content">
                      <h6><Link href="/antiques-auction/auction-details">Colonial revival dining chairs with old book.</Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$4,648</strong>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                  <div className="auction-card style-3">
                    ...
                    <div className="auction-card-content">
                      <h6><Link href="/antiques-auction/auction-details">Regency perioded chandelier jug with pot.</Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$3,984</strong>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                  <div className="auction-card style-3">
                    ...
                    <div className="auction-card-content">
                      <h6><Link href="/antiques-auction/auction-details">Edwardian diamond brooch old song cover.</Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$6,752</strong>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                  <div className="auction-card style-3">
                    <div className="auction-card-img-wrap">
                      <Link href="/antiques-auction/auction-details" className="card-img">
                        <img src="../assets/img/home3/auction-img10.jpg" alt="" />
                      </Link>
                      <div className="batch">
                        <span className="live">
                          <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="auction-card-content">
                      <h6><Link href="/antiques-auction/auction-details">Arts and crafts pottery vase wall big clock.</Link></h6>
                      <div className="price-and-code-area">
                        <div className="price">
                          <span>Current Bid at:</span>
                          <strong>$1,987</strong>
              ...
              <div className="row">
                <div className="col-lg-12 d-flex justify-content-center">
                  <Link className="view-button2" href="/antiques-auction/auction-grid">
                    View All Auction
                    <div className="arrow">
