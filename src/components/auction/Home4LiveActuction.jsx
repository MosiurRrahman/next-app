    ...
    <>
      <div className="home4-new-live-auction-section mb-120">
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-12 d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
              <Link className="primary-btn3 btn-hover" href="/art-auciton/auction-grid">
                View All Auction
