...
const Home6HighlightAuction = () => {
  ...
  <div className="container">
    <div className="row mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
      <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
        <div className="section-title4 two">
          ...
          <h2>Highlight <span>Auction</span></h2>
        </div>
        <div className="selector">

          <SelectComponent placeholder={"All Auction"} options={["Comics","Biography","Philosophy","All Auction"]}/>
    ...
    <div className="row g-4 mb-60">
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div className="auction-banner-card">
          <img src="../assets/img/home6/auction-banner-card-img1.jpg" alt="" />
          <div className="banner-content-wrap">
            <div className="banner-content-top">
              ...
              <h3><a href="auction-details.html">Neoclassical Art</a></h3>
            </div>
            <div className="banner-content-bottom">
              ...
              <a href="auction-details.html" className="bid-btn">
                Bid Now
              </a>
            </div>
          </div>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
        <div className="auction-card style-6">
          ...
          <div className="auction-card-content">
            <h6><a href="auction-details.html">Collector's Edition Limited Print of Frank Perel.</a></h6>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
        <div className="auction-card style-6">
          ...
          <div className="auction-card-content">
            <h6><a href="auction-details.html">Illustrate Masterpiece Deluxe Edition of Love skip.</a></h6>
            <div className="price-and-code-area">
              <div className="price">
                <span>Current Bid at:</span>
                <strong>$2,560</strong>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
        <div className="auction-card style-6">
          ...
          <div className="auction-card-content">
            <h6><a href="auction-details.html">Literary Gem First Edition of Drawing Near.</a></h6>
            <div className="price-and-code-area">
              <div className="price">
                <span>Current Bid at:</span>
                <strong>$7,974</strong>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
        <div className="auction-card style-6">
          ...
          <div className="auction-card-content">
            <h6><a href="auction-details.html">Rare Find Signed Copy of Before Amen.</a></h6>
            <div className="price-and-code-area">
              <div className="price">
                <span>Current Bid at:</span>
                <strong>$2,356</strong>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
        <div className="auction-card style-6">
          ...
          <div className="auction-card-content">
            <h6><a href="auction-details.html">Historical Treasure Antique Thinking Fast &amp; Slow.</a></h6>
            <div className="price-and-code-area">
              <div className="price">
                <span>Current Bid at:</span>
                <strong>$8,974</strong>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
        <div className="auction-card style-6">
          ...
          <div className="auction-card-content">
            <h6><a href="auction-details.html">John revere draw First Edition Masterpiece.</a></h6>
            <div className="price-and-code-area">
              <div className="price">
                <span>Current Bid at:</span>
                <strong>$4,898</strong>
      ...
      <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div className="auction-banner-card">
          <img src="../assets/img/home6/auction-banner-card-img2.jpg" alt="" />
          <div className="banner-content-wrap">
            <div className="banner-content-top">
              <div className="price-area">
                <span>Current Bid at:</span>
              ...
              <h3><a href="auction-details.html">Before Amen</a></h3>
            </div>
            <div className="banner-content-bottom">
              <div className="countdown-timer">
    ...
    <div className="row wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
      <div className="col-lg-12 d-flex justify-content-center">
        <a className="view-button2 three" href="auction-grid.html">
          View All Auction
          <div className="arrow">
