          ...
          <div className="row g-4 mb-60">
              ...
              <div className="auction-banner-card">
                ...
                <div className="banner-content-wrap">
                  <div className="banner-content-top">
                    ...
                    <h3><a Linkref="//book-and-comic/auction-details">Neoclassical Art</a></h3>
                  </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                ...
                <div className="auction-card-content">
                  <h6><a Linkref="//book-and-comic/auction-details">Collector's Edition Limited Print of Frank Perel.</a></h6>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                ...
                <div className="auction-card-content">
                  <h6><a Linkref="//book-and-comic/auction-details">Illustrate Masterpiece Deluxe Edition of Love skip.</a></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,560</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                ...
                <div className="auction-card-content">
                  <h6><a Linkref="//book-and-comic/auction-details">Literary Gem First Edition of Drawing Near.</a></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$7,974</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                ...
                <div className="auction-card-content">
                  <h6><a Linkref="//book-and-comic/auction-details">Rare Find Signed Copy of Before Amen.</a></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,356</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                ...
                <div className="auction-card-content">
                  <h6><a Linkref="//book-and-comic/auction-details">Historical Treasure Antique Thinking Fast &amp; Slow.</a></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$8,974</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                ...
                <div className="auction-card-content">
                  <h6><a Linkref="//book-and-comic/auction-details">John revere draw First Edition Masterpiece.</a></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$4,898</strong>
              ...
              <div className="auction-banner-card">
                ...
                <div className="banner-content-wrap">
                  <div className="banner-content-top">
                    ...
                    <h3><a Linkref="//book-and-comic/auction-details">Before Amen</a></h3>
                  </div>
                  <div className="banner-content-bottom">
                    <div className="countdown-timer">
