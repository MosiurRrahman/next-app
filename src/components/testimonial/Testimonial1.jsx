    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-lg-7 position-relative order-lg-1 order-2">
          <Swiper className="swiper testimonial-img-slider" {...imageSlider}
                  loop={true}
                  spaceBetween={10}
                  modules={[
                    FreeMode,
            ...
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-img">
                  <img src="assets/images/bg/testi-autho-1.png" alt="testi-autho-1" />
                </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-img">
                  <img src="assets/images/bg/testi-autho-2.png" alt="testi-autho-2" />
                </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-img">
                  <img src="assets/images/bg/testi-autho-3.png" alt="testi-autho-3" />
                </div>
              </SwiperSlide>
            </div>
          </Swiper>
          <Swiper className="swiper testimonial-content-slider" {...contentSlider}  onSwiper={setThumbsSwiper}
                  loop={false}
                  spaceBetween={10}
                  slidesPerView={3}
            ...
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-content">
                  <div className="quoat">
                    <img src="assets/images/icon/quate-icon.svg" alt="quate-icon" />
                  </div>
        ...
        <div className="col-lg-5 order-lg-2 order-1">
          <div className="section-title">
            <span><img className="left-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" />Testimonials<img className="right-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" /></span>
