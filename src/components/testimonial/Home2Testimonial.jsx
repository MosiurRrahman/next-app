            ...
            <ul className="rating-area">
              <li className="single-rating">
                <a href="https://www.trustpilot.com/">
                  <div className="icon">
                    <img src="assets/img/home2/icon/trustpilot-logo.svg" alt="" />
                  </div>
              ...
              <li className="single-rating">
                <a href="https://www.tripadvisor.com/">
                  <div className="icon">
                    <img src="assets/img/home2/icon/tripadvisor-logo2.svg" alt="" />
                  </div>
                  <div className="rating">
                    <div className="star">
        ...
        <div className="testimonial-card-slider-area">
          <div className="row">
            <div className="col-lg-12">
              <Swiper {...settings} className="swiper home2-testimonial-card-slider mb-35">
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="tesimonial-card-wrapper style-2">
                      <div className="tesimonial-card">
                        <img src="assets/img/home2/vector/testi-quote.svg" alt="" className="quote" />
