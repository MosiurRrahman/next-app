          ...
          <Swiper {...settings} className="swiper home6-testimonial-slider">
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-wrapper">
                  <div className="author-img">
                    <img src="assets/img/home6/testimonial-author-img1.png" alt="" />
                  </div>
                  <h3>Journey Beautiful Indonesia</h3>
                  <p>“I cannot express enough how satisfied I am with the webgot deve services provided by Egens Lab from the initial.Aenean fermentum. Integer auctor enim eget Fusce nec egestas risus, ac eleifend urna. Vivamus risus velit, scelerisque in dolor sit amet, sodales interdum ligula.”</p>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-wrapper">
                  <div className="author-img">
                    <img src="assets/img/home6/testimonial-author-img2.png" alt="" />
                  </div>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-wrapper">
                  <div className="author-img">
                    <img src="assets/img/home6/testimonial-author-img3.png" alt="" />
                  </div>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-wrapper">
                  <div className="author-img">
                    <img src="assets/img/home6/testimonial-author-img4.png" alt="" />
                  </div>
