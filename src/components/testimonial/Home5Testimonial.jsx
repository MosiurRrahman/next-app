        ...
        <ul className="rating-area">
          <li>
            <a href="https://www.trustpilot.com/">
              <div className="logo">
                <img src="assets/img/home5/vector/trustpilot-logo.svg" alt="" />
              </div>
              <div className="star">
                <img src="assets/img/home5/vector/trustpilot-star.svg" alt="" />
                <span>5.0 / 5.0</span>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.tripadvisor.com/">
              <div className="logo">
                <img src="assets/img/home5/vector/tripadvisor-logo.svg" alt="" />
              </div>
              <div className="star">
                <img src="assets/img/home5/vector/tripadvisor-star.svg" alt="" />
                <span>5.0 / 5.0</span>
              </div>
            </a>
          </li>
      ...
      <div className="row g-0 align-items-center">
        <div className="col-lg-4">
          <div className="testimonal-slider-left-img">
            <img src="assets/img/home5/testimonal-slider-left-img.jpg" alt="" />
          </div>
        </div>
        <div className="col-lg-8">
          <div className="testimonial-slider-area">
            <Swiper {...settings} className="swiper home5-testimonal-slider">
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="testimonial-wrapper">
                    <div className="testi-img">
                      <img src="assets/img/home5/home5-testi-img1.png" alt="" />
                    </div>
                    <div className="testi-content">
                      ...
                      <p>"I work with Alguneb Johnl on many projects, he always on tolda forn tha excel my expectations with his qualitywork andani fastestopasn told up services, very smooth and simpl communication one the way to go upe."</p>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="testimonial-wrapper">
                    <div className="testi-img">
                      <img src="assets/img/home5/home5-testi-img2.png" alt="" />
                    </div>
                    <div className="testi-content">
                      <div className="testi-content-top">
                        <div className="rating-title">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="testimonial-wrapper">
                    <div className="testi-img">
                      <img src="assets/img/home5/home5-testi-img3.png" alt="" />
                    </div>
                    <div className="testi-content">
                      <div className="testi-content-top">
                        <div className="rating-title">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="testimonial-wrapper">
                    <div className="testi-img">
                      <img src="assets/img/home5/home5-testi-img4.png" alt="" />
                    </div>
                    <div className="testi-content">
                      <div className="testi-content-top">
                        <div className="rating-title">
