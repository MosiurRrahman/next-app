  ...
  <div className="testimonial-card-slider-area">
    <div className="row mb-50">
      <div className="col-lg-12">
        <Swiper {...settings} className="swiper home4-testimonial-card-slider">
                ...
                <div className="tesimonial-card-bottom">
                  <div className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home3/testi-author-img1.png" alt="" />
                    </div>
            ...
            <SwiperSlide className="swiper-slide">
              <div className="testimonial-card2 style-2">
                ...
                <div className="tesimonial-card-bottom">
                  <div className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home3/testi-author-img2.png" alt="" />
                    </div>
                    <div className="author-name-desig">
                      <h5>Jon Mark</h5>
            ...
            <SwiperSlide className="swiper-slide">
              <div className="testimonial-card2 style-2">
                ...
                <div className="tesimonial-card-bottom">
                  <div className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home3/testi-author-img3.png" alt="" />
                    </div>
                    <div className="author-name-desig">
                      <h5>Jordan Moriah</h5>
