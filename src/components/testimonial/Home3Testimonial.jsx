      ...
      <div className="row justify-content-center mb-45">
        <div className="col-lg-8">
          <div className="section-title3 text-center">
            <span> <img className="left-vec" src="assets/images/icon/h3-sub-title-vec.svg" alt="" />Testimonials<img className="right-vec" src="assets/images/icon/h3-sub-title-vec.svg" alt="" /></span>
