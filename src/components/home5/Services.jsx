      ...
      <div className="row g-lg-4 gy-5">
        <div className="col-lg-6">
          <div className="services-img">
            <ul>
              <li className="single-img active" style={{backgroundImage: 'linear-gradient(246deg, rgba(21, 21, 21, 0.90) 0%, rgba(21, 21, 21, 0.00) 65.56%), url(assets/img/home5/services-01.jpg)'}} />
              <li className="single-img" style={{backgroundImage: 'linear-gradient(246deg, rgba(21, 21, 21, 0.90) 0%, rgba(21, 21, 21, 0.00) 65.56%), url(assets/img/home5/services-02.jpg)'}} />
              <li className="single-img" style={{backgroundImage: 'linear-gradient(246deg, rgba(21, 21, 21, 0.90) 0%, rgba(21, 21, 21, 0.00) 65.56%), url(assets/img/home5/services-03.jpg)'}} />
              <li className="single-img" style={{backgroundImage: 'linear-gradient(246deg, rgba(21, 21, 21, 0.90) 0%, rgba(21, 21, 21, 0.00) 65.56%), url(assets/img/home5/services-04.jpg)'}} />
              <li className="single-img" style={{backgroundImage: 'linear-gradient(246deg, rgba(21, 21, 21, 0.90) 0%, rgba(21, 21, 21, 0.00) 65.56%), url(assets/img/home5/services-05.jpg)'}} />
              <li className="single-img" style={{backgroundImage: 'linear-gradient(246deg, rgba(21, 21, 21, 0.90) 0%, rgba(21, 21, 21, 0.00) 65.56%), url(assets/img/home5/services-06.jpg)'}} />
            </ul>
          </div>
        </div>
