            ...
            <div className="col-lg-4 col-sm-6">
              <div className="blog-card3 magnetic-item">
                <div className="blog-content">
                  ...
                  <div className="dash-and-blog-btn">
                    <div className="dash" />
                    <Link href="/blog-details">
                      Read More{" "}
                      <svg
                ...
                <Link href="/blog-details" className="blog-img">
                  <img src="assets/img/home3/blog-img-01.jpg" alt="" />
                </Link>
              </div>
            </div>
            <div className="col-lg-4 col-sm-6">
              <div className="blog-card3 two magnetic-item">
                <div className="blog-content">
                  <div className="blog-meta">
                    <ul className="category">
                      <li>
                ...
                <Link href="/blog-details" className="blog-img">
                  <img src="assets/img/home3/blog-img-02.jpg" alt="" />
                </Link>
              </div>
            </div>
            <div className="col-lg-4 col-sm-6">
              <div className="blog-card3 three magnetic-item">
                <div className="blog-content">
                  <div className="blog-meta">
                    <ul className="category">
                      <li>
                  ...
                  <h4 className="blog-title">
                    <Link href="/blog-details">
                      Milestone Leads the Way in Digital Transformation Way.
                    </Link>
                  </h4>
                  <div className="dash-and-blog-btn">
                    <div className="dash" />
                ...
                <Link href="/blog-details" className="blog-img">
                  <img src="assets/img/home3/blog-img-03.jpg" alt="" />
                </Link>
              </div>
            </div>
          </div>
