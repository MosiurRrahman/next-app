          ...
          <div className="row mb-60">
            <div className="col-lg-12 d-flex align-items-end justify-content-between flex-wrap gap-3">
              <div className="section-title3 text-animation">
                <h2>Latest Blog</h2>
                <p>
                  Crafting engaging and compelling blog titles is crucial for
                  attracting readers.
                </p>
              </div>
                  ...
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-card1">
                        <Link href="/blog-details" className="blog-img">
                          <img
                            src="assets/img/home6/blog-img1.jpg"
                            alt="blog-img-01"
                          />
                        </Link>
                        <div className="blog-content">
                          <ul className="mete">
                            ...
                            <li>
                              <Link href="/blog-grid">02 Apr, 2023</Link>
                            </li>
                          </ul>
                          <h4>
                            <Link href="/blog-details">
                              Exploring Project Management SaaS Trends.
                            </Link>
                          </h4>
                        </div>
                      </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-card1">
                        <Link href="/blog-details" className="blog-img">
                          <img
                            src="assets/img/home6/blog-img2.jpg"
                            alt="blog-img-01"
                          />
                        </Link>
                        <div className="blog-content">
                          <ul className="mete">
                            <li>
                              <Link href="/blog-grid">Design Trends</Link>
                            </li>
                            <li>
                              <Link href="/blog-grid">02 Mar, 2024</Link>
                            </li>
                          </ul>
                          <h4>
                            <Link href="/blog-details">
                              How Project Management SaaS Transforms Work.
                            </Link>
                          </h4>
                        </div>
                      </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-card1">
                        <Link href="/blog-details" className="blog-img">
                          <img
                            src="assets/img/home6/blog-img3.jpg"
                            alt="blog-img-01"
                          />
                        </Link>
                        <div className="blog-content">
                          <ul className="mete">
                            ...
                            <li>
                              <Link href="/blog-grid">05 Mar, 2024</Link>
                            </li>
                          </ul>
                          <h4>
                            <Link href="/blog-details">
                              Comparing Top Project Management Tools in 2024.
                            </Link>
                          </h4>
                        </div>
                      </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-card1">
                        <Link href="/blog-details" className="blog-img">
                          <img
                            src="assets/img/home6/blog-img4.jpg"
                            alt="blog-img-01"
                          />
                        </Link>
                        <div className="blog-content">
                          <ul className="mete">
                            ...
                            <li>
                              <Link href="/blog-grid">07 Mar, 2024</Link>
                            </li>
                          </ul>
                          <h4>
                            <Link href="/blog-details">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="blog-card1">
                        <Link href="/blog-details" className="blog-img">
                          <img
                            src="assets/img/home6/blog-img5.jpg"
                            alt="blog-img-01"
                          />
                        </Link>
                        <div className="blog-content">
                          <ul className="mete">
                            <li>
                              <Link href="/blog-grid">IT Consulting</Link>
                            </li>
                            <li>
                              <Link href="/blog-grid">05 Mar, 2024</Link>
                            </li>
