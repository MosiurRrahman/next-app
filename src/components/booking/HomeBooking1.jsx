            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="form-inner date">
                  ...
                  <input autoComplete="off" placeholder="date" type="text" name="checkIn" id="datepicker" className="claender hasDatepicker" />
                </div>
              </div>
