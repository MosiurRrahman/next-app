          ...
          <div className="col-lg-12">
            <div className="banner-content">
              ...
              <h1 className="text-animation">
                Mosaic Mirage <span>Studios.</span>
              </h1>
              <div className="row justify-content-end">
                <div className="col-lg-6">
                  <div className="banner-bottom-content">
                    <p>
                      Studio agencies specialize in various areas of design,
                      such as
                      <span>graphic design, web design, branding, </span> and
                      other <span>visual elements.</span>
                    </p>
