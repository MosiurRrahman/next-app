    ...
    <div className="row g-lg-4 gy-5">
      <div className="col-lg-4 wow fadeInUp" data-wow-delay="200ms">
        <div className="section-title1">
          ...
          <Link className="primary-btn2" to="/shop"><i className="bi bi-cart2" /> Go to Shop Page</Link>
        </div>
      </div>
      <div className="col-lg-4 wow zoomIn" data-wow-delay="400ms">
            ...
            <li>
              ...
              <div className="shop-card">
                ...
                <div className="content">
                  ...
                  <h6><Link to="/product-details"><span>Steering Rack</span> Advance Auto Parts is a retailer.</Link>
                  </h6>
                  <div className="content-btm">
                    <div className="price">
                      <h6>$234.00</h6>
                    </div>
                    <Link className="primary-btn2" to="#">Add to cart</Link>
                  </div>
                </div>
              </div>
            </li>
