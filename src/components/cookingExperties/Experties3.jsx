      ...
      <div className="container">
        <div className="row justify-content-center mb-45">
          <div className="col-lg-8">
            <div className="section-title3 text-center">
              <span> <img className="left-vec" src="assets/images/icon/h3-sub-title-vec.svg" alt="" />Experties<img className="right-vec" src="assets/images/icon/h3-sub-title-vec.svg" alt="" /></span>
        ...
        <div className="row justify-content-center g-4">
          <div className="col-lg-4 col-md-6 col-sm-10">
            <div className="cooking-expart-wrap">
              <div className="exparts-img">
                <img className="img-fluid" src="assets/images/bg/h3-chef-01.png" alt="" />
          ...
          <div className="col-lg-4 col-md-6 col-sm-10">
            <div className="cooking-expart-wrap">
              <div className="exparts-img">
                <img className="img-fluid" src="assets/images/bg/h3-chef-02.png" alt="" />
                <div className="social-area">
                  <div className="share-icon">
                    <i className="bi bi-plus-lg" />
                  </div>
          ...
          <div className="col-lg-4 col-md-6 col-sm-10">
            <div className="cooking-expart-wrap">
              <div className="exparts-img">
                <img className="img-fluid" src="assets/images/bg/h3-chef-03.png" alt="" />
                <div className="social-area">
                  <div className="share-icon">
                    <i className="bi bi-plus-lg" />
                  </div>
