      ...
      <div className="row d-flex justify-content-center mb-40">
        <div className="col-lg-8">
          <div className="section-title text-center">
            <span><img className="left-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" />Experties<img className="right-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" /></span>
        ...
        <Swiper {...expertiesSlider} className="swiper expart-slider">
          <div className="swiper-wrapper">
            ...
            <SwiperSlide className="swiper-slide">
              <div className="cooking-expart-wrap">
                <div className="exparts-img">
                  <img className="img-fluid" src="assets/images/bg/exparts3.png" alt="" />
                  <div className="social-area">
                    <div className="share-icon">
                      <i className="bx bx-share-alt" />
                    </div>
