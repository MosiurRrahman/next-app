            ...
            <Swiper {...settings} className="swiper teams-card-slider">
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="teams-img">
                        <img src="assets/img/home4/teams-card2-img1.png" alt="" />
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="teams-card2 style-2">
                    <div className="teams-img">
                        <img src="assets/img/home4/teams-card2-img2.png" alt="" />
                        <ul className="social-list">
                        <li>
                            <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
                        </li>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="teams-card2 style-2">
                    <div className="teams-img">
                        <img src="assets/img/home4/teams-card2-img3.png" alt="" />
                        <ul className="social-list">
                        <li>
                            <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
                        </li>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="teams-card2 style-2">
                    <div className="teams-img">
                        <img src="assets/img/home4/teams-card2-img4.png" alt="" />
                        <ul className="social-list">
                        <li>
                            <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
                        </li>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="teams-card2 style-2">
                    <div className="teams-img">
                        <img src="assets/img/home4/teams-card2-img5.png" alt="" />
                        <ul className="social-list">
                        <li>
                            <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
                        </li>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="teams-card2 style-2">
                    <div className="teams-img">
                        <img src="assets/img/home4/teams-card2-img6.png" alt="" />
                        <ul className="social-list">
                        <li>
                            <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
                        </li>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="teams-card2 style-2">
                    <div className="teams-img">
                        <img src="assets/img/home4/teams-card2-img7.png" alt="" />
                        <ul className="social-list">
                        <li>
                            <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
                        </li>
