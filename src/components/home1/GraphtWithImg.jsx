      ...
      <div className="container-fluid one">
        <div className="row g-lg-4 gy-5">
          <div className="col-lg-6">
            <div className="grap-left-img magnetic-item">
              <img src="assets/img/home1/graph-left-img.jpg" alt="" />
            </div>
          </div>
          <div className="col-lg-6">
            <div className="garph-content pl--95">
              ...
              <div className="graph-chart">
                ...
                >
                  ...
                  <Tooltip  />
                  <Legend />
                  <Bar dataKey="percentage1" fill="#789FC0" name="Series 1" >
                  <LabelList dataKey="percentage1" position="top" />
                  </Bar>
                  <Bar dataKey="percentage2" fill="#324662" name="Series 2" />
                </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
