        ...
        <div className="row g-lg-4 gy-5">
          ...
          <div className="col-lg-6">
            <ul className="industeies-list">
              <li>
                <Link legacyBehavior href="/services1"><a>Higher Education</a></Link>
              </li>
              <li>
                <Link legacyBehavior href="/services1"><a>Construction</a></Link>
              </li>
              <li>
                <Link legacyBehavior href="/services1"><a>Finance</a></Link>
              </li>
              <li>
                <Link legacyBehavior href="/services1"><a>Low Firm</a></Link>
              </li>
              <li>
                <Link legacyBehavior href="/services1"><a>Real Estate</a></Link>
              </li>
              <li>
                <Link legacyBehavior href="/services1"><a>Startup</a></Link>
              </li>
              <li>
              ...
              <li>
                <Link legacyBehavior href="/services1"><a>Oil &amp; Gas</a></Link>
              </li>
              <li>
                <Link legacyBehavior href="/services1"><a>Non-Profit</a></Link>
              </li>
              <li>
                <Link legacyBehavior href="/services1"><a>Family Business</a></Link>
              </li>
            </ul>
          </div>
        </div>
