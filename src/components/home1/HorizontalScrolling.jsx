...
const HorizontalScrolling = () => {
  ...
  <div className="single-scroll-container" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), url(assets/img/home1/scroll-bg-1.jpg)'}}>
