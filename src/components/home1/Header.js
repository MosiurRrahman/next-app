                ...
                <form>
                  ...
                  <div className="quick-search">
                    <ul>
                      <li>Quick Search :</li>
                      <li>
                        <Link legacyBehavior href="/service"><a>Technology,</a></Link>
                      </li>
                      <li>
                        <Link legacyBehavior href="/service"><a>Finance consulting,</a></Link>
                      </li>
                      <li>
                        <Link legacyBehavior href="/service"><a>Human Resources,</a></Link>
                      </li>
                      <li>
                        <Link legacyBehavior href="/service"><a>Management,</a></Link>
                      </li>
                      <li>
                        <Link legacyBehavior href="/service"><a>Marketing Research,</a></Link>
                      </li>
                      <li>
