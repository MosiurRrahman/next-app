                ...
                <div className="slider-btn-group">
                  ...
                  <div className="slider-btn next-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16">
                      <g>
                        <path fillRule="evenodd" clipRule="evenodd" d="M15.5833 8.9668H1V7.7168H15.5833V8.9668Z" />
                        <path fillRule="evenodd" clipRule="evenodd" d="M14.9589 7.7168C12.0189 7.7168 9.61719 10.3018 9.61719 13.0585V13.6835H10.8672V13.0585C10.8672 10.966 12.7355 8.9668 14.9589 8.9668H15.583V7.7168H14.9589Z" />
                        <path fillRule="evenodd" clipRule="evenodd" d="M14.9589 8.96667C12.0189 8.96667 9.61719 6.38167 9.61719 3.625V3H10.8672V3.625C10.8672 5.71833 12.7355 7.71667 14.9589 7.71667H15.583V8.96667H14.9589Z" />
                      </g>
                    </svg>
                  </div>
                </div>
                  ...
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <div className="eg-card1">
                        ...
                        <div className="card-content">
                          <Link legacyBehavior href="/services1"><a>Finance <span /></a></Link>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="eg-card1">
                        ...
                        <div className="card-content">
                          <Link legacyBehavior href="/services1"><a>Consulting  <span /></a></Link>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="eg-card1">
                        ...
                        <div className="card-content">
                          <Link legacyBehavior href="/services1"><a>Marketing <span /></a></Link>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="eg-card1">
                        ...
                        <div className="card-content">
                          <Link legacyBehavior href="/services1"><a>Finance <span /></a></Link>
                          <h5><Link legacyBehavior href="/service-details"><a>Internation Business</a></Link></h5>
                        </div>
                      </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <div className="eg-card1">
                        ...
                        <div className="card-content">
                          <Link legacyBehavior href="/services1"><a>Technology <span /></a></Link>
                          <h5><Link legacyBehavior href="/service-details"><a>Technology Consulting</a></Link></h5>
                        </div>
                      </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <div className="eg-card1">
                        ...
                        <div className="card-content">
                          <Link legacyBehavior href="/services1"><a>Health Care<span /></a></Link>
                          <h5><Link legacyBehavior href="/service-detailstml"><a>Health Care Consult</a></Link></h5>
                        </div>
                      </div>
                    </SwiperSlide>
                  </div>
