                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="package-card2">
                      ...
                      <div className="eg-tag">
                        <h4>
                          <Link href="/visa/visa-details">EGYPT</Link>
                        </h4>
                      </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="package-card2 style-2">
                      ...
                      <div className="eg-tag">
                        <h4>
                          <Link href="/visa/visa-details">NEPAL</Link>
                        </h4>
                      </div>
                      <div className="package-card2-content">
                        <div className="title">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="package-card2">
                      ...
                      <div className="eg-tag">
                        <h4>
                          <Link href="/visa/visa-details">NEW YORK</Link>
                        </h4>
                      </div>
                      <div className="package-card2-content">
                        <div className="title">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="package-card2 style-2">
                      ...
                      <div className="eg-tag">
                        <h4>
                          <Link href="/visa/visa-details">India</Link>
                        </h4>
                      </div>
                      <div className="package-card2-content">
                        <div className="title">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="package-card2">
                      ...
                      <div className="eg-tag">
                        <h4>
                          <Link href="/visa/visa-details">Brazil</Link>
                        </h4>
                      </div>
                      <div className="package-card2-content">
                        <div className="title">
