      ...
      <div className="package-card-area">
        <div className="row g-xl-4 gy-5">
          <div className="col-lg-6">
            <div className="package-card4 two"> 
              <div className="package-card-img">
                <img src="assets/img/home5/package-card4-img1.jpg" alt="" />
              </div>
              <div className="package-card-content">
                ...
                <div className="card-content-bottom">
                  <div className="price-area">
                    ...
                    <h6><strong>$</strong>1200 <span>Per Person</span></h6>
                  </div>
          ...
          <div className="col-lg-6">
            <div className="package-card4 two"> 
              <div className="package-card-img">
                <img src="assets/img/home5/package-card4-img2.jpg" alt="" />
              </div>
              <div className="package-card-content">
                <div className="card-content-top">
                ...
                <div className="card-content-bottom">
                  <div className="price-area">
                    <span>Starting Form:</span>
                    <h6><strong>$</strong>900 <span>Per Person</span></h6>
                  </div>
                  <Link href="/visa/visa-details" className="apply-btn">
                    Apply Now
                    <div className="arrow">
