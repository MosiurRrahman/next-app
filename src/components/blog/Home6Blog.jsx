  ...
  <div className="container one">
    ...
    <div className="row g-lg-4 gy-5">
      <div className="col-lg-4 col-md-6">
        <div className="blog-card style-6">
          <div className="blog-card-img-wrap">
            <Link href="/blog-details" className="card-img"><img src="assets/img/home6/blog-card-img1.jpg" alt="" /></Link>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="blog-card style-6">
          <div className="blog-card-img-wrap">
            <Link href="/blog-details" className="card-img"><img src="assets/img/home6/blog-card-img2.jpg" alt="" /></Link>
            <Link href="/blog" className="date">
      ...
      <div className="col-lg-4 col-md-6">
        <div className="blog-card style-6">
          <div className="blog-card-img-wrap">
            <Link href="/blog-details" className="card-img"><img src="assets/img/home6/blog-card-img3.jpg" alt="" /></Link>
            <Link href="/blog" className="date">
