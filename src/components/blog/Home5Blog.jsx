      ...
      <div className="col-lg-5">
        <div className="blog-card style-5">
          <div className="blog-card-img-wrap">
            <Link href="/blog/blog-details" className="card-img"><img src="assets/img/home5/blog-card-img1.jpg" alt="" /></Link>
          </div>
          <div className="blog-card-content">
            ...
            <h5><Link href="/blog/blog-details">Our Begin Now What Your Will Beanft  our Tour &amp; Travel agency.</Link></h5>
        ...
        <div className="row g-md-4 gy-5">
          <div className="col-lg-12">
            <div className="blog-card two">
              <div className="blog-card-img-wrap">
                <Link href="/blog/blog-details" className="card-img"><img src="assets/img/home5/blog-card-img2.jpg" alt="" /></Link>
              </div>
              <div className="blog-card-content">
                <div className="blog-card-content-top">
                  <ul>
                    <li>
                      By <Link href="/blog">Dani Moris</Link>
                    </li>
                    <li>
          ...
          <div className="col-md-6">
            <div className="blog-card">
              <div className="blog-card-img-wrap">
                <Link href="/blog/blog-details" className="card-img"><img src="assets/img/home5/blog-card-img3.jpg" alt="" /></Link>
              </div>
              <div className="blog-card-content two">
                <div className="blog-card-content-top">
                  <ul>
                    <li>
                ...
                <h5><Link href="/blog/blog-details">Two newest daily Lufthansi flights.</Link></h5>
                <div className="bottom-area">
                  <Link href="/blog/blog-details">View Post 
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width={14} height={12} viewBox="0 0 14 12" fill="none">
          ...
          <div className="col-md-6">
            <div className="blog-card">
              <div className="blog-card-img-wrap">
                <Link href="/blog/blog-details" className="card-img"><img src="assets/img/home5/blog-card-img4.jpg" alt="" /></Link>
              </div>
              <div className="blog-card-content two">
                <div className="blog-card-content-top">
                  <ul>
                    <li>
                      By <Link href="/blog">Jon Luis</Link>
                    </li>
                    <li>
                      <Link href="/blog">Wild Tour</Link>
                    </li>
                  </ul>
                </div>
                <h5><Link href="/blog/blog-details">Connect via Lufthansi's Two Fresh Flights.</Link></h5>
                <div className="bottom-area">
                  <Link href="/blog/blog-details">View Post 
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width={14} height={12} viewBox="0 0 14 12" fill="none">
