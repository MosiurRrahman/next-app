    ...
    <div className="row mb-50">
      <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
        <div className="section-title3">
          ...
          <p>Etiam ac tortor id purus commodo vulputate. Vestibulum porttitor erat felis and sed vehicula tortor malesuada gravida. Mauris volutpat enim.</p>
        </div>
        <Link href="/blog" className="view-btn">View All Blog
          <div className="arrow">
            <svg width={18} height={16} viewBox="0 0 18 16" xmlns="http://www.w3.org/2000/svg">
              <path d="M2.73828 11.75L15.6103 4.31833" strokeLinecap="round" />
              <path d="M13.3477 10.3057L15.6115 4.31789L9.29402 3.28456" strokeLinecap="round" />
            </svg>
          </div>
        </Link>
      </div>
