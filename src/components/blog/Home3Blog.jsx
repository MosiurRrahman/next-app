    ...
    <div className="row g-lg-4 gy-5">
      <div className="col-lg-7">
        <div className="blog-card style-3">
          <div className="blog-card-img-wrap">
            <Link href="/blog/blog-details" className="card-img"><img src="assets/img/home3/blog-card-img1.png" alt="" /></Link>
          ...
          <div className="blog-card-content">
            ...
            <h5><Link href="/blog/blog-details">Aliquam gravida purus diam seduca bibendum dolor olpobon cought our tour.</Link></h5>
          </div>
        </div>
      </div>
      <div className="col-lg-5">
        <div className="blog-card style-4">
          <div className="blog-card-img-wrap">
            <Link href="/blog/blog-details" className="card-img"><img src="assets/img/home3/blog-card-img2.png" alt="" /></Link>
          </div>
          <div className="blog-card-content">
            <div className="blog-card-content-top">
            ...
            <h5><Link href="/blog/blog-details">Our Begin Now To Benign Jordanat What You Will Be Close.</Link></h5>
