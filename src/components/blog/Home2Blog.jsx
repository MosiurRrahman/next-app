        ...
        <div className="container">
          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-6">
              <div className="blog-card style-2">
                <div className="blog-card-img-wrap">
                  <Link href="/blog/blog-details" className="card-img"><img src="assets/img/home2/blog-card-img1.png" alt="" /></Link>
            ...
            <div className="col-lg-6">
              <div className="blog-card style-2">
                <div className="blog-card-img-wrap">
                  <Link href="/blog/blog-details" className="card-img"><img src="assets/img/home2/blog-card-img2.png" alt="" /></Link>
                  <Link href="/blog" className="date">
                    <span><strong>15</strong> <br /> June</span>
                  </Link>
                </div>
                <div className="blog-card-content">
                  <div className="blog-card-content-top"> 
                    <ul>
                      <li>
                        By <Link href="/blog">Dale Stayel</Link>
                      </li>
                      <li>
                  ...
                  <h5><Link href="/blog/blog-details">Aliquam gravida purus diam separate bibendum dolore. </Link></h5>
                  <div className="bottom-area">
                    <Link href="/blog/blog-details">View Post 
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={12} viewBox="0 0 14 12" fill="none">
