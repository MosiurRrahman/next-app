 ...
 const settings = useMemo(()=>{
  ...
  return (
    ...
    <div className="container">
        ...
        <div className="row">
            <div className="col-lg-12">
            <Swiper {...settings} className="swiper package-card-slider mb-60">
                <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                    <div className="package-card3">
                    <Link href="/package/package-details" className="package-card-img">
                        <img src="assets/img/home2/package-card3-img1.png" alt="" />
                        <div className="batch">
                        <span>Popular</span>
                        </div>
                    </Link>
                ...
                <SwiperSlide className="swiper-slide">
                    <div className="package-card3">
                    <Link href="/package/package-details" className="package-card-img">
                        <img src="assets/img/home2/package-card3-img2.png" alt="" />
                    ...
                    <div className="package-card-content">
                        ...
                        <h5><Link href="/package/package-details">Proin congue gravida eratqus convallis sem.</Link></h5>
                        <ul className="feature-list">
                            <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14">
                                <g clipPath="url(#clip0_1225_43)">
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="package-card-content">
                        ...
                        <h5><Link href="/package/package-details">Duis sed metus condimentum sapien sodales.</Link></h5>
                        <ul className="feature-list">
                            <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14">
                                <g clipPath="url(#clip0_1225_43)">
                        ...
                        <div className="price-area">
                            <span className="title">Starting Form:</span>
                            <h6><sub>$</sub>50.00 <del>$70.00</del></h6>
                            <span>Per Person</span>
                        </div>
                        <Link href="/package/package-details" className="primary-btn2">Book a Trip
                            <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="package-card-content">
                        ...
                        <h5><Link href="/package/package-details">An exploration of history and culture.</Link></h5>
                        <ul className="feature-list">
                            <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14">
                                <g clipPath="url(#clip0_1225_43)">
                        ...
                        <div className="price-area">
                            <span className="title">Starting Form:</span>
                            <h6><sub>$</sub>90.00 <del>$130.00</del></h6>
                            <span>Per Person</span>
                        </div>
                        <Link href="/package/package-details" className="primary-btn2">Book a Trip
                            <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="package-card-content">
                        ...
                        <h5><Link href="/package/package-details">A tour of historical and cultural aspects.</Link></h5>
                        <ul className="feature-list">
                            <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14">
                                <g clipPath="url(#clip0_1225_43)">
                        ...
                        <div className="price-area">
                            <span className="title">Starting Form:</span>
                            <h6><sub>$</sub>65.00 <del>$110.00</del></h6>
                            <span>Per Person</span>
                        </div>
                        <Link href="/package/package-details" className="primary-btn2">Book a Trip
                            <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <div className="package-card-content">
                        ...
                        <h5><Link href="/package/package-details">A pilgrimage through history and culture.</Link></h5>
                        <ul className="feature-list">
                            <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14">
                                <g clipPath="url(#clip0_1225_43)">
            ...
            <div className="slide-and-view-btn-grp style-2">
                ...
                <Link  href="/package" className="secondary-btn2">View All Package</Link>
