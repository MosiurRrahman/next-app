...
import AdvanceSearch from '../Home4/AdvanceSearch'
const initialState = {
  activeMenu: "",
  activeSubMenu: "",
  isSidebarOpen: false,
...
function Header() {
 ...
 <AdvanceSearch toggleMenu={toggleMenu} state = {state}/>
  <div className={`${state.isSidebarOpen?"show-menu":""} sidebar-menu`}>
    <div className="mobile-logo-area d-flex justify-content-between align-items-center">
      ...
      <div className="menu-button menu-close-btn" onClick={toggleSidebar}>
        <i className="bi bi-x" />
      </div>
    </div>
    ...
    <li className={`menu-item-has-children ${ currentRoute === "/" ? "active" : ""}`}>
          ...
          <li><Link legacyBehavior href="/index4"><a className="active">Home 04</a></Link></li>
  ...
  <header className="header-area style-4">
    <div onClick={toggleSidebar} className={`menu-button sidebar-button mobile-menu-btn ${state.isSidebarOpen ? "active" : "" }`}>
    ...
    <div className="header-logo">
      <a href="index.html"><img alt="image" className="img-fluid" src="assets/img/white-logo.svg" /></a>
    </div>
    <div className="nav-right d-lg-flex d-none jsutify-content-end align-items-center">
      <div className="header-right">
        <ul>
          <li>
            <div className="search-btn" onClick={()=>toggleMenu("search")}>
              <a>
