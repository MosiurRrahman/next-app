...
import tourData from "../../data/popular_tour.json";
            ...
            <div className="col-lg-12">
              <div className="tab-content" id="pills-tab4Content">
                ...
                >
                  <Swiper
                    {...settings}
                    className="swiper package-card-tab-slider"
                  >
                  ...
                  <div className="row mt-50">
                    <div className="col-lg-12">
                      <div className="slider-btn-grp2">
                        ...
                        <Link href="/package-grid" className="secondary-btn1">
                          View All Package
                        </Link>
...
export default Home1popularTour;
