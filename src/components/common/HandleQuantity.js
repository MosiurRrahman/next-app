...
function HandleQuantity() {
  ...
  const [state1, dispatch1] = useReducer(quantityReducer, { quantity: initialQuantity });
  ...
  return (
    <div className="quantity-counter">
      <a className="quantity__minus" style={{ cursor: "pointer" }} onClick={decrement1}>
      ...
      />
      <a className="quantity__plus" style={{ cursor: "pointer" }} onClick={increment1}>
