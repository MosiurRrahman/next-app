              ...
              <ul className="main-menu">
                <li className={state.activeMenu === "home" ? "active" : ""}>
                  ...
                  >
                    <i
                      className={`bi ${
                        state.activeMenu === "home" ? "bi-dash" : "bi-plus"
                      }`}
                  ...
                  >
                    <li className={state.activeMenu === "home" ? "active" : ""}>
                      ...
                      <span className="dropdown-icon2 two">
                        <i
                          className={`bi ${
                            state.activeSubMenu === "light-version"
                              ? "bi-dash"
                              : "bi-plus"
                          }`}
                          onClick={() => toggleSubMenu("light-version")}
                        />
                      </span>
                      <ul
                        className={`submenu-list ${
                    ...
                    <li
                      className={
                        state.activeSubMenu === "dark-version" ? "active" : ""
                      }
                    >
                      ...
                      <span className="dropdown-icon2 two">
                        <i
                          className={`bi ${
                            state.activeSubMenu === "dark-version"
                              ? "bi-dash"
                              : "bi-plus"
                          }`}
                          onClick={() => toggleSubMenu("dark-version")}
                        />
                      </span>
                      <ul
                        className={`submenu-list ${
                ...
                <li className={state.activeMenu === "service" ? "active" : ""}>
                  ...
                  >
                    <i
                      className={`bi ${
                        state.activeMenu === "service" ? "bi-dash" : "bi-plus"
                      }`}
                ...
                <li className={state.activeMenu === "page" ? "active" : ""}>
                  ...
                  <span
                    className={`dropdown-icon2 ${
                      state.activeMenu === "page" ? "active" : ""
                    } `}
                  >
                    <i
                      className={`bi ${
                        state.activeMenu === "page" ? "bi-dash" : "bi-plus"
                      }`}
                  ...
                  >
                    ...
                    <li>
                      ...
                      <span className="dropdown-icon2 two">
                        <i
                          className={`bi ${
                            state.activeSubMenu === "caseStudy"
                              ? "bi-dash"
                              : "bi-plus"
                          }`}
                          onClick={() => toggleSubMenu("caseStudy")}
                        />
                      </span>
                      <ul
                        className={`submenu-list ${
                          state.activeSubMenu === "caseStudy" ? "active" : ""
                        }`}
                      >
                        <li>
                    ...
                    <li>
                      ...
                      <ul
                        className={`submenu-list ${
                          state.activeSubMenu === "blog" ? "active" : ""
                        }`}
                      >
                        <li>
                    ...
                    <li>
                      ...
                      <ul
                        className={`submenu-list ${
                          state.activeSubMenu === "carrer" ? "active" : ""
                        }`}
                      >
                        <li>
                    ...
                    <li>
                      ...
                      <span className="dropdown-icon2 two">
                        <i
                          className={`bi ${
                            state.activeSubMenu === "sho["
                              ? "bi-dash"
                              : "bi-plus"
                          }`}
                          onClick={() => toggleSubMenu("sho[")}
                        />
                      </span>
                      <ul
                        className={`submenu-list ${
                          state.activeSubMenu === "sho[" ? "active" : ""
                        }`}
                      >
                        <li>
                          <Link href="/shop">Shop</Link>
                ...
                <li
                  className={state.activeMenu === "portfolio" ? "active" : ""}
                >
                  <a href="#">Portfolio </a>
                  <span
                    className={`dropdown-icon2 ${
                      state.activeMenu === "portfolio" ? "active" : ""
                    } `}
                  >
                    <i
                      className={`bi ${
                        state.activeMenu === "portfolio" ? "bi-dash" : "bi-plus"
                      }`}
                      onClick={() => collapseMenu("portfolio")}
                    />
                  </span>
                  <ul
                    className={`submenu-list ${
