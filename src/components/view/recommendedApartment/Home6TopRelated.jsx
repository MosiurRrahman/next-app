                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="product-card4 style-3">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Cornerstone Properties</a></Link>
                              </h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home1/icon/bed2.svg" alt="" />
                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="product-card4 style-3">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Blue Sky Investments</a></Link>
                              </h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home1/icon/bed2.svg" alt="" />
