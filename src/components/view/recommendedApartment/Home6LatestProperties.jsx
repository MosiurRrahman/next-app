              ...
              <div className="col-lg-4 col-md-6  wow fadeInUp" data-wow-delay="200ms">
                <div className="product-card4 style-3">
                  ...
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Keystone Realty</a></Link></h6>
                    ...
                    <div className="button-and-price">
                      <Link legacyBehavior href="/poperty-list/deatils1"><a className="primary-btn7">View Details</a></Link>
              ...
              <div className="col-lg-4 col-md-6  wow fadeInUp" data-wow-delay="300ms">
                <div className="product-card4 style-3">
                  ...
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Castle Gate Realty</a></Link></h6>
                    <ul className="features">
                      <li>
                        <img src="assets/img/home1/icon/bed2.svg" alt="" />
                        04 Beds
              ...
              <div className="col-lg-4 col-md-6  wow fadeInUp" data-wow-delay="400ms">
                <div className="product-card4 style-3">
                  ...
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Cornerstone Properties</a></Link></h6>
                    <ul className="features">
                      <li>
                        <img src="assets/img/home1/icon/bed2.svg" alt="" />
                        04 Beds
              ...
              <div className="col-lg-4 col-md-6  wow fadeInUp" data-wow-delay="600ms">
                <div className="product-card4 style-3">
                  ...
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Blue Sky Investments</a></Link></h6>
                    <ul className="features">
                      <li>
                        <img src="assets/img/home1/icon/bed2.svg" alt="" />
                        04 Beds
              ...
              <div className="col-lg-4 col-md-6  wow fadeInUp" data-wow-delay="500ms">
                <div className="product-card4 style-3">
                  ...
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Prodigy Realty</a></Link></h6>
                    <ul className="features">
                      <li>
                        <img src="assets/img/home1/icon/bed2.svg" alt="" />
                        04 Beds
