          ...
          <SwiperSlide className="swiper-slide">
            <div className="feature-card">
              ...
              <div className="product-content">
                ...
                <h5><Link legacyBehavior href="/poperty-list/deatils1"><a>Quest Properties</a></Link></h5>
          ...
          <SwiperSlide className="swiper-slide">
            <div className="feature-card">
              ...
              <div className="product-content">
                ...
                <h5><Link legacyBehavior href="/poperty-list/deatils1"><a>Stellar Gate Realty </a></Link></h5>
                <ul className="features">
                  <li>
                    <img src="assets/img/home2/icon/bed1.svg" alt="" />
                    06 Beds
          ...
          <SwiperSlide className="swiper-slide">
            <div className="feature-card">
              ...
              <div className="product-content">
                ...
                <h5><Link legacyBehavior href="/poperty-list/deatils1"><a>Zephyr Properties</a></Link></h5>
                <ul className="features">
                  <li>
                    <img src="assets/img/home2/icon/bed1.svg" alt="" />
                    06 Beds
