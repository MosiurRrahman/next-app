                ...
                <div className="product-card4">
                  ...
                  <div className="product-content">
                    <div className="location">
                      <Link legacyBehavior href="/property-list/left-sidebar"><a><i className="bi bi-geo-alt" />
                        Panama City</a></Link>
                    </div>
                    ...
                    <div className="button-and-price">
                      <Link legacyBehavior href="/poperty-list/deatils1"><a className="primary-btn3">View Details</a></Link>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="product-card4">
                  ...
                  <div className="product-content">
                    ...
                    <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Horizon Realty Services</a></Link></h6>
                    <ul className="features">
                      <li>
                        <img src="assets/img/home1/icon/bed2.svg" alt="" />
                        04 Beds
