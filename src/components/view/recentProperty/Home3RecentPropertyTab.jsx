                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="product-card3 style-2">
                        ...
                        <div className="product-content">
                          ...
                          <h5><Link legacyBehavior href="/poperty-list/deatils1"><a>Nimbus Properties</a></Link></h5>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="product-card3 style-2">
                        ...
                        <div className="product-content">
                          ...
                          <h5><Link legacyBehavior href="/poperty-list/deatils1"><a>Radiant Roofs Real Estate</a></Link></h5>
                          <ul className="features">
                            <li>
                              <img src="assets/img/home1/icon/bed2.svg" alt="" />
                              04 Beds
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="product-card3 style-2">
                        ...
                        <div className="product-content">
                          ...
                          <h5><Link legacyBehavior href="/poperty-list/deatils1"><a>Luminary Real Estate</a></Link></h5>
                          <ul className="features">
                            <li>
                              <img src="assets/img/home1/icon/bed2.svg" alt="" />
                              04 Beds
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="product-card3 style-2">
                        ...
                        <div className="product-content">
                          ...
                          <h5><Link legacyBehavior href="/poperty-list/deatils1"><a>Equinox Properties</a></Link></h5>
                          <ul className="features">
                            <li>
                              <img src="assets/img/home1/icon/bed2.svg" alt="" />
                              04 Beds
