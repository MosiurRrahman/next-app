                    ...
                    <div className="swiper-wrapper">
                        ...
                        <div className="product-card2 two">
                            ...
                            <div className="details-btn">
                                <Link legacyBehavior href="/poperty-list/deatils1"><a><i className="bi bi-arrow-right-short" /></a></Link>
                            </div>
                            <div className="price">
                                <strong>$32,445.00</strong>
                            </div>
                            <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Azure Horizons</a></Link></h6>
                        ...
                        <div className="product-card2 two">
                            ...
                            <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Nexus Realty</a></Link></h6>
                            <ul className="features">
                                <li>
                                <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                04 Beds
                        ...
                        <div className="product-card2 two">
                            ...
                            <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Astral Homes</a></Link></h6>
                            <ul className="features">
                                <li>
                                <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                04 Beds
                        ...
                        <div className="product-card2 two">
                            ...
                            <h6><Link legacyBehavior href="/poperty-list/deatils1"><a>Nimbus Properties</a></Link></h6>
                            <ul className="features">
                                <li>
                                <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                04 Beds
