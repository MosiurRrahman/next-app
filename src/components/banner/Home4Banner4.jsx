    ...
    <div className="col-xl-3">
      <div className="home4-banner3-wrapper">
        ...
        <div className="home4-banner3-content">
          ...
          <h2>Your next trip <br /> <strong>25% Off</strong></h2>
          <Link href="/package" className="primary-btn1">Book A Trip</Link>
        </div>
      </div>
    </div>
      ...
      <div className="package-card-slider-wrapper">
              ...
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="package-card3 style-4">
                    <Link href="/package/package-details" className="package-card-img">
                      <img src="assets/img/home2/package-card3-img7.png" alt="" />
                      <div className="batch">
                        <span>Featured</span>
                      </div>
                    </Link>
                    <div className="package-card-content">
                      <div className="card-content-top">
                        <div className="destination-and-date-area">
                          <div className="destination">
                            ...
                            <ul className="destination-list">
                              ...
                              <li><Link href="/package">Hungry</Link></li>
                            </ul>
                          </div>
                          <div className="date">
                            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16">
                        ...
                        <div className="location-area">
                          <ul className="location-list scrollTextAni">
                            <li><Link href="/package">Izmir</Link></li>
                            <li><Link href="/package">Istanbul</Link></li>
                            <li><Link href="/package">Konya</Link></li>
                            <li><Link href="/package">Budapest</Link></li>
                            <li><Link href="/package">Debrecen</Link></li>
                            <li><Link href="/package">Szombathely</Link></li>
                          </ul>
                        </div>
                      </div>
                      <div className="card-content-bottom">
                        <div className="price-area">
                          ...
                          <h6><sub>$</sub>3860 <del>$5000</del></h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="package-card3 style-4">
                    <Link href="/package/package-details" className="package-card-img">
                      <img src="assets/img/home2/package-card3-img8.png" alt="" />
                    </Link>
                    <div className="package-card-content">
                      <div className="card-content-top"> 
                        <div className="destination-and-date-area">
                          <div className="destination">
                            ...
                            <ul className="destination-list">
                              ...
                              <li><Link href="/package">Indonesia</Link></li>
                            </ul>
                          </div>
                          <div className="date">
                            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16">
                        ...
                        <h5><Link href="/package/package-details">Maecenas interdum metus la ut faucibus.</Link></h5>
                        <div className="location-area">
                          <ul className="location-list scrollTextAni">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="package-card3 style-4">
                    <Link href="/package/package-details" className="package-card-img">
                      <img src="assets/img/home2/package-card3-img9.png" alt="" />
                    ...
                    <div className="package-card-content">
                      <div className="card-content-top">
                        <div className="destination-and-date-area">
                          <div className="destination">
                            ...
                            <ul className="destination-list">
                              ...
                              <li><Link href="/package">Bangladesh</Link></li>
                            </ul>
                          </div>
                          <div className="date">
                            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16">
                        ...
                        <h5><Link href="/package/package-details">Dapibus vitae sapien eteleme Praesent tinca.</Link></h5>
                        <div className="location-area">
                          <ul className="location-list scrollTextAni">
                      ...
                      <div className="card-content-bottom">
                        <div className="price-area">
                          <span className="title">Starting Form:</span>
                          <h6><sub>$</sub>3500 <del>$4000</del></h6>
                          <span>Per Person</span>
                        </div>
                        <div className="rating-area mb-0">
                          <ul className="rating">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="package-card3 style-4">
                    <Link href="/package/package-details" className="package-card-img">
                      <img src="assets/img/home2/package-card3-img3.png" alt="" />
                    </Link>
                    <div className="package-card-content">
                      <div className="card-content-top"> 
                        <div className="destination-and-date-area">
                          <div className="destination">
                            ...
                            <ul className="destination-list">
                              ...
                              <li><Link href="/package">Pakistan</Link></li>
                            </ul>
                          </div>
                          <div className="date">
                            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16">
                        ...
                        <h5><Link href="/package/package-details">Suspendisse placerat enim at suscipit.</Link></h5>
                        <div className="location-area">
                          <ul className="location-list scrollTextAni">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="package-card3 style-4">
                    <Link href="/package/package-details" className="package-card-img">
                      <img src="assets/img/home4/package-card-img1.jpg" alt="" />
                      <div className="batch yellow">
                        <span>Popular</span>
                      </div>
                    </Link>
                    <div className="package-card-content">
                      <div className="card-content-top">
                        <div className="destination-and-date-area">
                          <div className="destination">
                            ...
                            <ul className="destination-list">
                              ...
                              <li><Link href="/package">Spain</Link></li>
                            </ul>
                          </div>
                          <div className="date">
                            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16">
                        ...
                        <h5><Link href="/package/package-details">faucibus orci luctus et ultric posuere cubilia.</Link></h5>
                        <div className="location-area">
                          <ul className="location-list scrollTextAni">
                      ...
                      <div className="card-content-bottom">
                        <div className="price-area">
                          <span className="title">Starting Form:</span>
                          <h6><sub>$</sub>4200 <del>$5200</del></h6>
                          <span>Per Person</span>
                        </div>
                        <div className="rating-area mb-0">
                          <ul className="rating">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="package-card3 style-4">
                    <Link href="/package/package-details" className="package-card-img">
                      <img src="assets/img/home4/package-card-img2.jpg" alt="" />
                      <div className="batch yellow">
                        <span>Popular</span>
                      </div>
                    </Link>
                      ...
                      <div className="card-content-top">
                        <div className="destination-and-date-area">
                          <div className="destination"> 
                            ...
                            <ul className="destination-list">
                              <li><Link href="/package">Saudi Arab</Link></li>
                              <li><Link href="/package">Qatar</Link></li>
                            </ul>
                          </div>
                          <div className="date">
                            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16">
                        ...
                        <h5><Link href="/package/package-details">Quisque eleifend leo quis acc ultrices.</Link></h5>
                        <div className="location-area">
                          <ul className="location-list scrollTextAni">
        ...
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-center">
            <Link href="/package" className="primary-btn1">View All Package</Link>
          </div>
        </div>
      </div>
    </div>
