          ...
          <Swiper {...settings} className="swiper home2-banner-slider">
            <div className="swiper-wrapper">
              <SwiperSlide className="swiper-slide">
                <div className="banner-bg" style={{ backgroundImage: 'linear-gradient(180deg, rgba(11, 12, 12, 0.45) 0%, rgba(11, 12, 12, 0.45) 100%), url(../assets/img/home2/home2-banner-img1.jpg)' }}>
                </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="banner-bg" style={{ backgroundImage: 'linear-gradient(180deg, rgba(11, 12, 12, 0.45) 0%, rgba(11, 12, 12, 0.45) 100%), url(../assets/img/home2/home2-banner-img2.jpg)' }}>
                </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="banner-bg" style={{ backgroundImage: 'linear-gradient(180deg, rgba(11, 12, 12, 0.45) 0%, rgba(11, 12, 12, 0.45) 100%), url(../assets/img/home2/home2-banner-img3.jpg)' }}>
                </div>
              </SwiperSlide>
              <SwiperSlide className="swiper-slide">
                <div className="banner-bg" style={{ backgroundImage: 'linear-gradient(180deg, rgba(11, 12, 12, 0.45) 0%, rgba(11, 12, 12, 0.45) 100%), url(../assets/img/home2/home2-banner-img4.jpg)' }}>
                </div>
              </SwiperSlide>
            </div>
          </Swiper>
                ...
                <div className="banner-wrapper">
                  <div className="banner-content">
                    ...
                    <div className="button-area">
                      <Link className="primary-btn btn-hover two" href="/auction-grid">
                        Start A Bid
                      ...
                      <Link className="primary-btn btn-hover white-bg two" href="/auction-grid">
                        View All Auction
                        <span />
                      </Link>
                    </div>
