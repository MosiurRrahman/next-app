          ...
          <div className="row">
            <div className="col-lg-12 mb-30">
              <div className="banner4-card four">
                <img src="assets/img/home3/banner4-card-img1.png" alt="" />
                <div className="banner4-content-wrapper">
                  <div className="banner4-content">
                    <span>Savings worldwide</span>
                    <h3>20% Off</h3>
                    <Link href="/package" className="text">Discover Great Deal</Link>
                    <Link href="/package" className="primary-btn1">View This Trip</Link>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-lg-12">
              <div className="banner2-card five">
                <img src="assets/img/home3/banner4-card-img2.png" alt="" />
                <div className="banner2-content-wrap d-flex align-items-center">
                  <div className="w-100 d-flex flex-column align-items-end">
                    <div className="banner2-content">
                      <span>Savings worldwide</span>
                      <h5>Up to <span>40%</span> Off Honeymoon.</h5>
                      <Link href="/package" className="secondary-btn1">View This Trip</Link>
                    </div>
                  </div>
                </div>
              </div>
