        ...
        <div className="container-fluid">
          <div className="video-wrapper">
            <div className="play-icon">
              <svg className="play" width={28} height={32} viewBox="0 0 28 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg className="close-icon" width={31} height={31} viewBox="0 0 31 31" xmlns="http://www.w3.org/2000/svg">
                <g>
