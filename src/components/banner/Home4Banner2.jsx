        ...
        <div className="swiper home4-banner2-slider">
            ...
            <div className="swiper-slide">
                ...
                <div className="col-lg-4 p-0">
                    ...
                    <Link href="/package/" className="secondary-btn1">Book A Trip</Link>
                    </div>
                </div>
                <div className="col-lg-8 p-0">
                    <div className="home4-banner2-img">
                    <img src="assets/img/home4/home4-banner2-img1.png" alt="" />
                    </div>
                </div>
                </div>
            </div>
            <div className="swiper-slide">
                ...
                <div className="col-lg-8 p-0">
                    <div className="home4-banner2-img">
                    <img src="assets/img/home4/home4-banner2-img2.png" alt="" />
                    </div>
                </div>
                </div>
            </div>
