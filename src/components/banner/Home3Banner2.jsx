      ...
      <div className="home3-banner2-section mb-110">
        <div className="container-fluid">
          <div className="row gy-5 align-items-center">
            <div className="col-xl-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="single-banner" style={{ backgroundImage: 'url(../assets/img/home3/home3-banner2-bg1.png), linear-gradient(180deg, rgba(126, 82, 55, 1) 0%, rgba(126, 82, 55, 1) 100%)' }}>
                <div className="batch">
                ...
                <div className="row">
                  <div className="col-md-6 d-flex align-items-center">
                    <div className="banner2-content">
                      ...
                      <Link className="primary-btn2 btn-hover" href="/antiques-auction/auction-details">
                        Bid Now
            ...
            <div className="col-xl-6 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="single-banner two" style={{ backgroundImage: 'url(../assets/img/home3/home3-banner2-bg2.png), linear-gradient(180deg, rgba(191, 199, 115, 1) 0%, rgba(191, 199, 115, 1) 100%)' }}>
                <div className="row">
                  <div className="col-md-6 d-flex align-items-center">
                    <div className="banner2-content">
                      <div className="price-area">
