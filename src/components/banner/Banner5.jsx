...
const Banner5 = () => {
  ...
  <Swiper {...settings} className="swiper home5-banner-slider">
    <div className="swiper-wrapper">
      <SwiperSlide className="swiper-slide">
        <div className="banner-bg" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.5) 100%), url(../assets/img/home5/home5-banner-img1.jpg)'}}>
        </div>
      </SwiperSlide>
      <SwiperSlide className="swiper-slide">
        <div className="banner-bg" style={{backgroundImage: 'linear-gradient(180deg, rgba(11, 12, 12, 0.6) 0%, rgba(11, 12, 12, 0.6) 100%), url(../assets/img/home5/home5-banner-img2.jpg)'}}>
        </div>
      </SwiperSlide>
      <SwiperSlide className="swiper-slide">
        <div className="banner-bg" style={{backgroundImage: 'linear-gradient(180deg, rgba(11, 12, 12, 0.6) 0%, rgba(11, 12, 12, 0.6) 100%), url(../assets/img/home5/home5-banner-img3.jpg)'}}>
        </div>
      </SwiperSlide>
    </div>
  </Swiper>
  <div className="banner-wrapper">
    <div className="banner-content">
      ...
      <h1>Select <span>Our Product</span> At Our Auction.</h1>
      <p>Join us as we carve a path to success, driven by passion, powered by innovation, and  we're here to turn them into reality.</p>
      <div className="button-area">
        <Link className="primary-btn2 btn-hover" href="/gadget-and-technology/auction-grid">
          Start A Bid
        ...
        <Link className="primary-btn4 btn-hover" href="/gadget-and-technology/auction-grid">
          View All Auction
          <span />
        </Link>
      </div>
