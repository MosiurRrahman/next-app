            ...
            <table className="eg-table table category-table mb-30">
              ...
              <tbody>
                <tr>
                  ...
                  <td data-label="Company">
                    <Link legacyBehavior href="/company-dashboard">
                      <a className="company-btn">Tech.Bath Com... </a>
                    </Link>
                  </td>
                ...
                <tr>
                  ...
                  <td data-label="Company">
                    <Link legacyBehavior href="/company-details">
                      <a className="company-btn">Gangster Group</a>{" "}
                    </Link>
                  </td>
                  <td data-label="Action">
                    <button className="view-btn">Apply Now</button>
                ...
                <tr>
                  ...
                  <td data-label="Company">
                    <Link legacyBehavior href="/company-details">
                      <a className="company-btn">Marko-land Ltd</a>
                    </Link>
                  </td>
                  <td data-label="Action">
                    <button className="view-btn">Apply Now</button>
                ...
                <tr>
                  ...
                  <td data-label="Company">
                    <Link legacyBehavior href="/company-details">
                      <a className="company-btn"> Bistro.Tech Group</a>
                    </Link>
                  </td>
                  <td data-label="Action">
                    <button className="view-btn">Apply Now</button>
