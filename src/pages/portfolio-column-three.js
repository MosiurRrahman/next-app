...
function PortfolioColumnThree() {
  ...
  return (
    <>
      <Layout>
        <Breadcrumb
          pageName="Portfolio Grid Three"
          pageTitle="Portfolio Grid Three"
        />
            ...
            <div className="row grid g-4 mb-70">
              {items.slice(0, 6).map((element, index) => {
                return (
                  <div
                    key={element.id}
                    className="col-lg-4 col-md-6 col-sm-10  grid-item grid-item "
                  >
...
export default PortfolioColumnThree;
