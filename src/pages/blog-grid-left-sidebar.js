...
const BlogGridLefSidebarPage = () => {
  return (
    <>
    <div className="blog-left-sidebar-section mt-110 mb-110">
                ...
                <div className="article-card">
                  <div className="article-image">
                    ...
                    <div className="blog-date">
                      <Link legacyBehavior href="/blog-grid">{e.date}</Link>
                    </div>
                  </div>
...
export default BlogGridLefSidebarPage
