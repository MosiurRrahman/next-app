    ...
    <div className="row g-lg-5 gy-5">
      <div className="col-lg-5">
        <div className="faq-left-img">
          <img className="img-fluid" src="assets/images/bg/faq-big-img.png" alt="faq-big-img" />
          <div className="sm-img">
            <img className="img-fluid" src="assets/images/bg/faq-sm-img.png" alt="faq-sm-img" />
          </div>
        </div>
      </div>
      <div className="col-lg-7">
        <div className="section-title">
          <span><img className="left-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" />General Question<img className="right-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" /></span>
            ...
            <div className="accordion-item">
              ...
              <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div className="accordion-body">
                  There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightl
                </div>
              </div>
            </div>
            <div className="accordion-item">
    ...
    <div className="row d-flex align-items-center justify-content-center mb-40">
      <div className="col-lg-8">
        <div className="section-title text-center">
          <span><img className="left-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" />Online Reserve<img className="right-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" /></span>
