    ...
    <>
            ...
            <div className="col-12">
              <div className="section-title-one mb-30">
                ...
                <h3>
                  ...
                  even slightly believable the majority have suffered
                  alteration.
                </h3>
              </div>
      ...
      <div className="recent-casestudy-section pt-120 pb-120 mobile-padding">
        <div className="container">
          ...
          <div className="row">
            <div className="col-12">
              <div className="swiper recent-casestudy-slider-one">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="recent-casestudy-one">
                      <a href="portfolio-details.html" className="big-arrow">
                        <img
                      ...
                      <div className="recent-casestudy-content">
                        ...
                        <h3>
                          <a
                            ...
                            data-cursor="View Details"
                          >
                            Best Choise To Change Business Progress.
                          </a>
                        </h3>
                      </div>
                    </div>
                      ...
                      <div className="recent-casestudy-content">
                        ...
                        <h3>
                          <a
                            ...
                            data-cursor="View Details"
                          >
                            To Improve Development Skills With TechGen.
                          </a>
                        </h3>
                      </div>
                    </div>
        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10 mb-40">
              <div className="swiper testi-content-slider">
            ...
            <div className="row justify-content-center align-items-center">
              ...
              <div className="col-lg-4 order-lg-2 order-1 d-flex justify-content-center">
                <div className="swiper testi-image-slider">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-12">
              ...
              <div className="swiper customer-slider">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                ...
                <div className="blog-content">
                  <h4>
                    <a href="blog-details.html" data-cursor="Blog Details">
                      Business Strategy Most Popular System To Grow.
                    </a>
                  </h4>
                  <a href="blog-details.html" className="readmore-btn">
                    Read More
                    <i className="bi bi-arrow-right" />
                  </a>
                </div>
            ...
            <div className="col-lg-6">
              <div className="blog-one-single">
                ...
                <div className="blog-content">
                  <h4>
                    <a href="blog-details.html" data-cursor="Blog Details">
                      Grow Your Business With Management With Us.
                    </a>
                  </h4>
                  <a href="blog-details.html" className="readmore-btn">
                    Read More
...
export default IndexBusinessConsult;
