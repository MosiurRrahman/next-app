                  ...
                  <div className="auction-info mb-50">
                    <div className="countdown-timer">
                      <ul data-countdown="2023-10-23 12:00:00">
                        <li className="times" data-days={1}>00</li>
                        <li>
                        ...
                        <li className="times" data-hours={1}>00</li>
                        <li>
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={24} viewBox="0 0 4 24">
                            <circle cx={2} cy={2} r={2} />
                            <circle cx={2} cy={22} r={2} />
                        ...
                        <li className="times" data-minutes={1}>00</li>
                        <li>
                          <svg xmlns="http://www.w3.org/2000/svg" width={4} height={24} viewBox="0 0 4 24">
                            <circle cx={2} cy={2} r={2} />
                            <circle cx={2} cy={22} r={2} />
                        ...
                        <li className="times" data-seconds={1}>00</li>
                      </ul>
                    </div>
