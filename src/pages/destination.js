...
import destinationCardData from "../components/data/destination_card.json";
...
export default function Destination() {
  ...
  return (
    <Layout>
      <Breadcumb pageName="Destination" pageTitle="Destination" />
      <div className="destinations-area pt-120">
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-9 col-md-9">
              <div className="row destinations-2">
                <Swiper className="swipper" {...destinationSlide} {...slider4}>
                  <div className="swipper-wrapper">
          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-9">
              <div className="row destinations-1">
                <Swiper {...destinationSlide} {...slider5} className="swipper">
                  <div className="swipper-wrapper">
