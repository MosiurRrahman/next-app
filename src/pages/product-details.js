...
const ProductDetails = () => {
  ...
  <div className="container">
    <div className="row g-lg-4 gy-5 mb-90">
      ...
      <div className="col-lg-6">
        <div className="product-details-content">
          ...
          <h4>Steering system (steering wheel, steering column, power steering pump)</h4>
          ...
          <div className="product-quantity d-flex align-items-center justify-content-start">
            ...
            <Link to="/cart" className="primary-btn3">Add To Cart</Link>
          ...
          <ul className="aditional-info">
            ...
            <li><span>Category:</span> <Link to="/shop">Car steering</Link></li>
            <li><span>Tags:</span> <Link to="/product-details">Nissan,</Link> <Link to="/product-details">Steering, </Link> <Link to="/product-details">parts</Link></li>
            <li><span>Share:</span>
    ...
    <div className="row mb-90">
      <div className="col-lg-12">
        <div className="nav nav2 nav  nav-pills" id="v-pills-tab2" role="tablist" aria-orientation="vertical">
          <button className="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="false">Product Details</button>
        ...
        <div className="tab-content tab-content2" id="v-pills-tabContent2">
          <div className="tab-pane fade active show" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
            <div className="description">
              <p>The steering system in a vehicle is responsible for allowing the driver to control
                the direction of the vehicle's movement. It consists of several components,
                including the steering wheel, steering column, and power steering pump. It's worth
                noting that there are different types of steering systems used in vehicles,
                including rack-and-pinion and recirculating ball steering systems. While the basic
                principles remain the same, the specific design and components may vary between
                different vehicle models and manufacturers.</p>
              <ul>
                <li><strong>Steering Wheel:</strong> The steering wheel is the part of the steering
                  system that the driver directly interacts with. It is typically a circular
                  device that the driver uses to turn the front wheels of the vehicle. The
                  steering wheel is connected to the steering column.</li>
                <li><strong>Steering Column:</strong> The steering column is a shaft-like structure
                  that connects the steering wheel to the steering gear or rack. It serves as a
                  pathway for transferring the driver's input from the steering wheel to the
                  steering gear.</li>
                <li><strong>Power Steering Pump:</strong> In modern vehicles, many steering systems
                  are equipped with power steering, which assists the driver in turning the wheels
                  with less effort. The power steering pump is a hydraulic pump</li>
              </ul>
              <p>When the driver turns the steering wheel, the movement is transmitted through the
                steering column to the steering gear or rack. The steering gear or rack converts the
                rotational motion of the steering wheel into linear motion, which ultimately
                controls the movement of the vehicle's front wheels. If power steering is present,
                the power steering pump helps apply hydraulic pressure to assist in turning the
                wheels.</p>
            </div>
          </div>
            ...
            <div className="addithonal-information">
              <table className="table total-table2">
                <tbody>
                  ...
                  <tr>
                    <td>Model Name</td>
                    <td>Pyhodi9acsriobv1</td>
                  </tr>
                  <tr>
                    <td>Compatible Devices</td>
                    <td>Playstation 3, PC, Xbox One, Android</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>4.17 x 11.42 x 11.42 inches</td>
                  </tr>
                  <tr>
                    <td>Manufacturer recommended age</td>
                    <td>12 months and up</td>
                  </tr>
                  <tr>
                    <td>Manufacturer</td>
                    <td>Pyhodi</td>
    ...
    <div className="row mb-90">
      <div className="col-lg-12">
        <div className="section-title">
          <h4>Related Car Parts</h4>
        </div>
      </div>
      <div className="col-lg-12 mb-40">
        <div className="swiper product-details-slider">
            ...
            <div className="swiper-slide">
              <div className="shop-card2">
                ...
                <div className="content">
                  ...
                  <h6><Link  to="/product-details">Steering Rack Advance Auto Parts is a retailer.</Link>
                  </h6>
            ...
            <div className="swiper-slide">
              <div className="shop-card2">
                ...
                <div className="content">
                  ...
                  <h6><Link  to="/product-details">Jekit 355*32mm assembled brake disks.</Link>
                  </h6>
                  <div className="content-btm">
                    <div className="price">
                      <h6>$214.00 <del>$234.00</del></h6>
            ...
            <div className="swiper-slide">
              <div className="shop-card2">
                ...
                <div className="content">
                  ...
                  <h6><Link  to="/product-details">Pump Water Audi Seat Skoda Vw Skf Vkpc 81620.</Link>
                  </h6>
                  <div className="content-btm">
                    <div className="price">
                      <h6>$214.00 <del>$234.00</del></h6>
            ...
            <div className="swiper-slide">
              <div className="shop-card2">
                ...
                <div className="content">
                  ...
                  <h6><Link  to="/product-details">Tech master New Brand Carbon ceramic brakes. </Link>
                  </h6>
                  <div className="content-btm">
                    <div className="price">
                      <h6>$214.00 <del>$234.00</del></h6>
            ...
            <div className="swiper-slide">
              <div className="shop-card2">
                ...
                <div className="content">
                  ...
                  <h6><Link  to="/product-details">WJB WA512187 - Rear Wheel Hub Bearing Assembly.</Link>
                  </h6>
                  <div className="content-btm">
                    <div className="price">
                      <h6>$214.00 <del>$234.00</del></h6>
    ...
    <div className="row">
      <div className="col-lg-12">
        <div className="section-title">
          <h4>Recently Viewed Car Parts</h4>
        </div>
      </div>
      <div className="col-lg-12 mb-40">
        <div className="swiper product-details-slider2">
          <div className="swiper-wrapper">
            <div className="swiper-slide">
              <div className="shop-card2">
                <div className="shop-img">
      ...
      <div className="col-lg-12 divider">
        <div className="slider-btn-group style-2 justify-content-md-between justify-content-center">
          ...
          <div className="view-btn-area">
            <p>There are More Car Parts Available</p>
            <Link className="view-btn" to="/shop">View More</Link>
          </div>
          <div className="slider-btn next-2 d-md-flex d-none">
            <svg width={11} height={19} viewBox="0 0 8 13" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 6.50008L0 0L5.09091 6.50008L0 13L8 6.50008Z" />
