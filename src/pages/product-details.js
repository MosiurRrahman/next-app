...
function ProductDetailsPage() {
  ...
  <div className="container">
      ...
      <div className="col-lg-6">
        <div className="product-details-content">
          ...
          <ul className="aditional-info">
            ...
            <li><span>Category:</span> <Link legacyBehavior href="/shop"><a>Car steering</a></Link></li>
            <li><span>Tags:</span> <Link legacyBehavior href="/product-details"><a>Nissan,</a></Link> <Link legacyBehavior href="/product-details"><a>Steering,</a></Link> <Link legacyBehavior href="/product-details"><a>parts</a></Link></li>
            <li><span>Share:</span>
    ...
    <div className="row">
      ...
      <div className="col-lg-12 mb-40">
        <Swiper {...productSlide2} className="swiper product-details-slider2">
          <div className="swiper-wrapper">
            <SwiperSlide className="swiper-slide">
              <div className="shop-card2">
                <div className="shop-img">
