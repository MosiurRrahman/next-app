...
import packageData from "../components/data/package_grid.json";
...
export default function PackageSidebarPage() {
  return (
    <Layout>
      <Breadcumb pageName="Package Sidebar" pageTitle="Package Sidebar" />
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="row">
                {packageData.slice(0, 8).map((data) => {
                  const { id, image, price, time, rating, title } = data;
                  return (
