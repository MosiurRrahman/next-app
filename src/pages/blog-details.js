                ...
                <div className="row g-lg-5 gy-5">
                    <div className="col-lg-8">
                        ...
                        <div className="news-content">
                            ...
                            <p className="mb-10">"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque , totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicaboconsequuntur magni dolores eos qui ratione. </p>
                            <p>"But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure.</p>
                        </div>
                        <blockquote className="wp-block-quote">
                            <h3>“expound the actual teachings of the great explorer of the truth, the master-builder of human happiness”.</h3>
                            <div className="author-area">
                            <h5><img className="left-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" />Mr. Robert Jack</h5>
                            </div>
                        </blockquote>
                        <h3 className="title2">Cooking Delicious Food Our Experties Chef.</h3>
                        <div className="row g-4 mb-20">
                            <div className="col-lg-6 col-md-6">
                            <ul className="blog-dt-features">
                                <li><i className="bi bi-chevron-double-right" />Denouncing pleasure and praising pain.</li>
                                <li><i className="bi bi-chevron-double-right" />Complete account of the system.</li>
                                <li><i className="bi bi-chevron-double-right" />Inventore veritatis et quasi architecto.</li>
                                <li><i className="bi bi-chevron-double-right" />Master-builder of human happiness.</li>
                                <li><i className="bi bi-chevron-double-right" />Natus error sit voluptatem accusantium.</li>
                                <li><i className="bi bi-chevron-double-right" />Expound the actual teachings of the great. </li>
                                <li><i className="bi bi-chevron-double-right" />Mistaken idea of denouncing pleasure. </li>
                                <li><i className="bi bi-chevron-double-right" />Sed ut perspiciatis unde omnis iste natus.</li>
                            </ul>
                            </div>
                            <div className="col-lg-6 col-md-6">
                            <div className="blog-dt-1">
                                <img className="img-fluid" src="assets/images/blog/blog-dt-1.png" alt="blog-dt-1" />
                            </div>
                            </div>
                        </div>
                        ...
                        <div className="row pt-40 g-4">
                            ...
                            <div className="blog-dt-img-2">
                                <img className="img-fluid" src="assets/images/blog/blog-dt-2.png" alt="" />
                            </div>
                            </div>
                            <div className="col-lg-6 col-sm-6">
                            <div className="blog-dt-img-2">
                                <img className="img-fluid" src="assets/images/blog/blog-dt-3.png" alt="" />
                            </div>
                            </div>
                        </div>
