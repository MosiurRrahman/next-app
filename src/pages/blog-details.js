      ...
      <div className="col-lg-8">
        ...
        <div className="blog-tag-social-area">
          <div className="bolg-tag">
            <h6>Tag:</h6>
            <ul>
              <li><Link to="blog-standard">Brand Car,</Link></li>
              <li><Link to="blog-standard">Driving,</Link></li>
              <li><Link to="blog-standard">Car Service,</Link></li>
              <li><Link to="blog-standard">Car Advice</Link></li>
            </ul>
          </div>
          <div className="social-area">
            <h6>Share:</h6>
            <ul className="social-link d-flex align-items-center">
              <li><Link to="https://www.facebook.com/"><i className="bx bxl-facebook" /></Link></li>
              <li><Link to="https://twitter.com/"><i className="bx bxl-twitter" /></Link></li>
              <li><Link to="https://www.pinterest.com/"><i className="bx bxl-linkedin" /></Link></li>
              <li><Link to="https://www.instagram.com/"><i className="bx bxl-instagram" /></Link></li>
            </ul>
          </div>
        </div>
            ...
            <div className="details-navigation">
              <div className="single-navigation">
                ...
                <div className="content">
                  ...
                  <h6><Link to="blog-details">The Car Enthusiast: Exploring the World of Cars and Driving</Link></h6>
                </div>
              </div>
