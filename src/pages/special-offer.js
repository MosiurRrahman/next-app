                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                          <div className="product-card4">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link  to="/car-deatils">Mercedes-Benz C-Class-2023</Link></h6>
                              ...
                              <div className="button-and-price">
                                 <Link  to="/car-deatils" className="primary-btn3">View Details</Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                          <div className="product-card4">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link  to="/car-deatils">Tesla Model S-2023</Link></h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home4/icon/miles.svg" alt="" />
                                  2500 miles
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="400ms">
                          <div className="product-card4">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link  to="/car-deatils">Cadillac Escalade-2023</Link></h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home4/icon/miles.svg" alt="" />
                                  2500 miles
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                          <div className="product-card4">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link  to="/car-deatils">Subaru Outback-2023</Link></h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home4/icon/miles.svg" alt="" />
                                  2500 miles
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                          <div className="product-card4">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link  to="/car-deatils">Kia Telluride-2023</Link></h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home4/icon/miles.svg" alt="" />
                                  2500 miles
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                          <div className="product-card4">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link  to="/car-deatils">Volkswagen Golf-2023</Link></h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home4/icon/miles.svg" alt="" />
                                  2500 miles
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                          <div className="product-card4">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link  to="/car-deatils">Lexus RX-2021</Link></h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home4/icon/miles.svg" alt="" />
                                  2500 miles
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="400ms">
                          <div className="product-card4">
                            ...
                            <div className="product-content">
                              ...
                              <h6><Link  to="/car-deatils">Nissan Altima-2022</Link></h6>
                              <ul className="features">
                                <li>
                                  <img src="assets/img/home4/icon/miles.svg" alt="" />
                                  2500 miles
