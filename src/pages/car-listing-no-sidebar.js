...
function CarListingNoSidebarPage() {
            ...
            <div className="col-xl-12">
                ...
                <div className={`list-grid-product-wrap ${activeClass}`}>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="400ms">
                        ...
                        <div className="product-content">
                            <h5><Link  to="/car-deatils"> Cadillac Escalade-2023</Link></h5>
                            <div className="price-location">
                            <div className="price">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        ...
                        <div className="product-content">
                            <h5><Link  to="/car-deatils"> Subaru Outback-2023</Link></h5>
                            <div className="price-location">
                            <div className="price">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                        ...
                        <div className="product-content">
                            <h5><Link  to="/car-deatils"> Kia Telluride-2023</Link></h5>
                            <div className="price-location">
                            <div className="price">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        ...
                        <div className="product-content">
                            <h5><Link  to="/car-deatils"> Volkswagen Golf-2023</Link></h5>
                            <div className="price-location">
                            <div className="price">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                        ...
                        <div className="product-content">
                            <h5><Link  to="/car-deatils"> Lexus RX-2021</Link></h5>
                            <div className="price-location">
                            <div className="price">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="400ms">
                        ...
                        <div className="product-content">
                            <h5><Link  to="/car-deatils"> Nissan Altima-2022</Link></h5>
                            <div className="price-location">
                            <div className="price">
                                <strong>$7,656.00</strong>
                            </div>
...
export default CarListingNoSidebarPage