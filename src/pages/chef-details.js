    ...
    <div className="row align-items-center g-lg-5 gy-5 mb-60">
        ...
        <div className="chef-introduction">
          ...
          <div className="about-chef">
            ...
            <div className="chef-contact">
              <ul>
                <li><strong>Department:</strong> Senior Chef.</li>
                <li><strong>Experience:</strong> 15 Years.</li>
                <li><strong>Phone:</strong> <a href="tel:+990-8879756">+990-8879756.</a></li>
              </ul>
              <ul>
                <li><strong>Email:</strong> <a href="mailto:info@example.com"> info@example.com</a></li>
                <li><strong>Fax:</strong> <a href="fax:+00788-75578">+00788-75578</a></li>
              </ul>
            </div>
            ...
            <div className="divider">
              <img src="assets/images/bg/chef-dt-shape.png" alt="chef-dt-shape" />
            </div>
          </div>
        </div>
      </div>
      <div className="col-lg-6">
        <div className="chef-dt-img">
          <img className="img-fluid" src="assets/images/bg/chef-dt-1.png" alt="chef-dt-1" />
        </div>
      </div>
    </div>
          ...
          <ul className="skills-bar-container">
            <li>
              <div className="progressbar-title">
                <h4>Sea Food</h4>
                <span className="percent" id="html-pourcent">90%</span>
              </div>
            ...
            <li>
              <div className="progressbar-title">
                <h4>Soup Item</h4>
                <span className="percent" id="css-pourcent">80%</span>
              </div>
              <div className="bar-container">
            ...
            <li>
              <div className="progressbar-title">
                ...
                <span className="percent" id="javascript-pourcent">93%</span>
              </div>
              <div className="bar-container">
