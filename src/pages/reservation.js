    ...
    <div className="container">
      <div className="row d-flex justify-content-center mb-40">
        <div className="col-lg-8">
          <div className="section-title text-center">
            <span><img className="left-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" />Best Offer<img className="right-vec" src="assets/images/icon/sub-title-vec.svg" alt="sub-title-vec" /></span>
      ...
      <div className="row g-4">
        <div className="col-lg-6 col-md-6">
          <div className="best-offer-wrap clearfix">
            <div className="best-offer-img">
              <img className="img-fluid" src="assets/images/bg/best-offer-img1.png" alt="best-offer-img1" />
        ...
        <div className="col-lg-6 col-md-6">
          <div className="best-offer-wrap clearfix">
            <div className="best-offer-img">
              <img className="img-fluid" src="assets/images/bg/best-offer-img2.png" alt="best-offer-img1" />
              <div className="price-tag">
                <span>$55</span>
              </div>
            </div>
