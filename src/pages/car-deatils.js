                    ...
                    <div className="tab-pane fade show active" id="new-car" role="tabpanel" aria-labelledby="new-car-tab">
                      <div className="product-st-card1 two mb-30">
                        ...
                        <div className="product-content">
                          <h6><Link   to="/car-deatils">Mercedes-Benz-2023</Link></h6>
                      ...
                      <div className="product-st-card1 two mb-30">
                        ...
                        <div className="product-content">
                          <h6><Link   to="/car-deatils">Hyundai Sonata-2022</Link></h6>
                          <ul className="features">
                            <li>
                              <img src="assets/img/home4/icon/menual.svg" alt="" />
                              Automatic
                      ...
                      <div className="product-st-card1 two mb-30">
                        ...
                        <div className="product-content">
                          <h6><Link   to="/car-deatils">Lexus RX-2023</Link></h6>
                          <ul className="features">
                            <li>
                              <img src="assets/img/home4/icon/menual.svg" alt="" />
                              Automatic
                      ...
                      <div className="product-st-card1 two mb-30">
                        ...
                        <div className="product-content">
                          <h6><Link   to="/car-deatils">Ferrari 458 Italia</Link></h6>
                          <ul className="features">
                            <li>
                              <img src="assets/img/home4/icon/menual.svg" alt="" />
                              Automatic
                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="product-card">
                      ...
                      <div className="product-content">
                        <h5><Link   to="/car-deatils">Mercedes-Benz C-Class-2023</Link></h5>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="product-card">
                      ...
                      <div className="product-content">
                        <h5><Link   to="/car-deatils">Chevrolet Silverado-2023</Link></h5>
                        <div className="price-location">
                          <div className="price">
                            <strong>$7,656.00</strong>
                          </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="product-card">
                      ...
                      <div className="product-content">
                        <h5><Link   to="/car-deatils">Hyundai Sonata-2022</Link></h5>
                        <div className="price-location">
                          <div className="price">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="product-card">
                      ...
                      <div className="product-content">
                        <h5><Link   to="/car-deatils">Jeep Grand Cherokee-2022</Link></h5>
                        <div className="price-location">
                          <div className="price">
            ...
            <div className="col-lg-12 divider">
              <div className="slider-btn-group style-2 justify-content-md-between justify-content-center">
                ...
                <div className="view-btn-area">
                  ...
                  <Link    to="/single-brand-category"><a className="view-btn">View More</a></Link>
                </div>
                  ...
                  <div className="col-lg-12 divider">
                    <div className="slider-btn-group style-2 justify-content-md-between justify-content-center">
                      ...
                      <div className="view-btn-area">
                        ...
                        <Link    to="/customer-review"><a className="view-btn">View All Review</a></Link>
                      </div>
