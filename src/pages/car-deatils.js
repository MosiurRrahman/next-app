            ...
            <div className="col-lg-4">
              <div className="car-details-sidebar">
                <div className="contact-info mb-50">
                  <div className="single-contact" id="phoneNumber" data-phone={+990737621432}>
                    <a><i className="bx bx-phone-call" />Show Number</a>
                  </div>
                  <div className="single-contact" id="emailAdress" data-email="info@gmail.com">
                    <a><i className="bx bx-at" />Email Now</a>
                  </div>
                  <div className="single-contact" id="emailAdresss" data-whatsapp={+990737621432} data-emails="https://api.whatsapp.com/send?phone=990737621432&text=Hello this is the starting message">
                    <a><i className="bx bxl-whatsapp" />Whatsapp</a>
                  </div>
                </div>
