...
<>
  <InnerPageHeader6/>
  <Breadcrumb6 pagetitle={"Category"} currentPage={"Category"}/>
      ...
      <div className="row gy-5 row-cols-xxl-6 row-cols-xl-5 row-cols-md-4 row-cols-sm-3 row-cols-2">
        <div className="col wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
          <div className="category-card">
            <Link href="/book-and-comic/auction-sidebar" className="category-img">
              <img src="/assets/img/home1/category-img1.jpg" alt="" />
            </Link>
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Automotive</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="300ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Antiques</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Digital Art</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="500ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Books &amp; Comic</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Old Coin</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="700ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Gadget</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Jewelry</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Real Estate</Link></h5>
              <span>45,680 Item</span>
            </div>
          </div>
        </div>
        <div className="col wow animate fadeInDown" data-wow-delay="700ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Fashion</Link></h5>
              <span>41,250 Item</span>
            </div>
          </div>
        </div>
        <div className="col wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Ceramics</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="500ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Instruments</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Toys &amp; Games</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="300ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Gadgets</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Automobiles</Link></h5>
        ...
        <div className="col wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
          <div className="category-card">
            ...
            <div className="category-content">
              <h5><Link href="/book-and-comic/auction-sidebar">Decorative Art</Link></h5>
