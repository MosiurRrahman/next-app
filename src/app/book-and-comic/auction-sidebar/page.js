            ...
            >
              ...
              <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div className="auction-card style-6">
                  <div className="auction-card-img-wrap">
                    <Link href="/book-and-comic/auction-details" className="card-img">
                      <img src="../assets/img/home6/auction-img9.jpg" alt="" />
                    </Link>
                    <div className="batch">
                      <span className="live">
                        <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="auction-card-content">
                    <h6><Link href="/book-and-comic/auction-details">Complete Collection Box Set Christopher Fraying.</Link></h6>
                    <div className="price-and-code-area">
                      <div className="price">
                        <span>Current Bid at:</span>
                        <strong>$2,898</strong>
              ...
              <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div className="auction-card style-6">
                  <div className="auction-card-img-wrap">
                    <Link href="/book-and-comic/auction-details" className="card-img">
                      <img src="../assets/img/home6/auction-img10.jpg" alt="" />
                    </Link>
                    <div className="batch">
                      <span className="live">
                        <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="auction-card-content">
                    <h6><Link href="/book-and-comic/auction-details">Unique Discover Rare Edition of criminal Successor.</Link></h6>
                    <div className="price-and-code-area">
                      <div className="price">
                        <span>Current Bid at:</span>
                        <strong>$2,589</strong>
              ...
              <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div className="auction-card style-6">
                  <div className="auction-card-img-wrap">
                    <Link href="/book-and-comic/auction-details" className="card-img">
                      <img src="../assets/img/home6/auction-img11.jpg" alt="" />
                    </Link>
                    <div className="batch">
                      <span className="upcoming">
                        <svg width={9} height={9} viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="auction-card-content">
                    <h6><Link href="/book-and-comic/auction-details">Cultural Artifa Special Edition of Silver Surfer.</Link></h6>
                    <div className="price-and-code-area">
                      <div className="price">
                        <span>Current Bid at:</span>
                        <strong>$2,649</strong>
              ...
              <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                <div className="auction-card style-6">
                  <div className="auction-card-img-wrap">
                    <Link href="/book-and-comic/auction-details" className="card-img">
                      <img src="../assets/img/home6/auction-img12.jpg" alt="" />
                    </Link>
                    <div className="batch">
                      <span className="live">
                        <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="auction-card-content">
                    <h6><Link href="/book-and-comic/auction-details">Victorian silver color wall old book set.</Link></h6>
                    <div className="price-and-code-area">
                      <div className="price">
                        <span>Current Bid at:</span>
                        <strong>$2,545</strong>
