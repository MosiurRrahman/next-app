      ...
      <div className="row gy-5 mb-110">
        ...
        <div className="col-lg-6">
          <div className="product-details-content">
            <h3>ZARA Crimson</h3>
            <p>ZARA Crimson Perfume is a captivating fragrance that embodies the essence of elegance
            ...
            <div className="product-quantity d-flex align-items-center justify-content-start">
              ...
              <Link href="/cart" className="primary-btn5 black btn-hover">Add To Cart
            ...
            <ul className="aditional-info">
              ...
              <li><span>Tags:</span> <Link href="/product-details">Aura,</Link> <Link href="/product-details">Dusk, </Link> <Link href="/product-details">Azure</Link></li>
            </ul>
          </div>
        </div>
      </div>
                      ...
                      <div className="review-form">
                        ...
                        <form>
                          <div className="row">
                            ...
                            <div className="col-lg-12">
                              <button className="primary-btn5 black btn-hover" type="submit">
                                Submit Now
