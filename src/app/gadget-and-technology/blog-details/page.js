              ...
              <div className="blog-details-author-meta">
                <div className="author-area">
                  ...
                  <div className="author-content">
                    <h6>
                      By, <Link href="/gadget-and-technology/blog-grid">Cooper Jogan</Link>
                    </h6>
                  </div>
                </div>
                <ul>
              ...
              <div className="sidebar-area">
                ...
                <div className="single-widget mb-30">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/gadget-and-technology/blog-grid">20 February, 2024</Link>
                      <h6>
                        <Link href="/gadget-and-technology/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/gadget-and-technology/blog-grid">12 January, 2024</Link>
                      <h6>
                        <Link href="/gadget-and-technology/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/gadget-and-technology/blog-grid">04 January, 2024</Link>
                      <h6>
                        <Link href="/gadget-and-technology/blog-details">
                ...
                <div className="single-widget mb-30">
                  ...
                  <ul className="tag-list">
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Porcelain</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Manuscripts</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Ceramics</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Renaissance</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Baroque Art</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Rococo Art</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Romanticism</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Photography</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/blog-grid">Smartwatches</Link>
                    </li>
                  </ul>
                </div>
            ...
            <div className="col-lg-12">
              <div className="details-navigation">
                <div className="single-navigation">
                  <Link href="/gadget-and-technology/blog-details" className="nav-btn">
                    <div className="arrow">
                      <svg
                        width={16}
                        height={13}
