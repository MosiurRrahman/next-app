...
const AuctionSidebarPage = () => {
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
    <div className="auction-card style-5">
      ...
      <div className="auction-card-content">
        <h6><Link href="/gadget-and-technology/auction-details">Stream Tech Digital Camera Stick Free.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$8,974</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="auction-card style-5">
      ...
      <div className="auction-card-content">
        <h6><Link href="/gadget-and-technology/auction-details">Streamline new and treandy Smartwatch.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$2,898</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
    <div className="auction-card style-5">
      ...
      <div className="auction-card-content">
        <h6><Link href="/gadget-and-technology/auction-details">Pixel Perfect HD Smart Virtual Reality For You.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$4,648</strong>
