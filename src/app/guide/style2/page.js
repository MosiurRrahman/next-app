  ...
  <div className="container">
    <div className="row g-lg-4 gy-5">
        ...
        <div className="teams-card2">
          <div className="teams-img">
            ...
            <ul className="social-list">
              ...
              <li>
                <a href="https://twitter.com/"><svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16">
      ...
      <div className="col-xl-3 col-lg-4 col-sm-6">
        <div className="teams-card2">
          <div className="teams-img">
            <img src="/assets/img/innerpage/guide2-img1.png" alt="" />
            <ul className="social-list">
              <li>
                <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
              </li>
      ...
      <div className="col-xl-3 col-lg-4 col-sm-6">
        <div className="teams-card2">
          <div className="teams-img">
            <img src="/assets/img/innerpage/guide2-img2.png" alt="" />
            <ul className="social-list">
              <li>
                <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
              </li>
      ...
      <div className="col-xl-3 col-lg-4 col-sm-6">
        <div className="teams-card2">
          <div className="teams-img">
            <img src="/assets/img/innerpage/guide2-img3.png" alt="" />
            <ul className="social-list">
              <li>
                <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
              </li>
      ...
      <div className="col-xl-3 col-lg-4 col-sm-6">
        <div className="teams-card2">
          <div className="teams-img">
            <img src="/assets/img/innerpage/guide2-img4.png" alt="" />
            <ul className="social-list">
              <li>
                <a href="https://www.instagram.com/"><i className="bx bxl-instagram" /></a>
              </li>
