     ...
     <div className="home6-search-area two mb-100">
        ...
        <div className="row row-cols-xl-5 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4 justify-content-center">
            ...
            <div className="form-inner">
                ...
                <SelectComponent options={["For Sale","For Rent","Devlopment"]} placeholder="Select" />
            </div>
            </div>
            <div className="col">
            <div className="form-inner">
            ...
            <div className="row g-xl-4 gy-5">
                <div className="col-xl-12">
                    ...
                    <div className="col-lg-12">
                        ...
                        <p>Showing <strong>2,928</strong> property  available in stock</p>
                        <div className="filter-view">
                            <div className="filter-atra">
                            <h6>Filter By:</h6>
                            <form>
                                <div className="form-inner">
                                <SelectComponent placeholder={"Select Price"} options={["Highest Price","Low Price"]}/>
                    ...
                    <div className={`list-grid-product-wrap ${!isGridView ?"list":"grid"}-group-wrapper`}>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Harmony House</a></Link></h6>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Evergreen Realty</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="400ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Paradise Heights</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Serene Homes</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Riverside Retreat</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="400ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Riverfront Residence</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Lakeside Haven</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Tranquil Haven</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="400ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Whispering Pines</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Meadowview Manor</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Blissful Bungalow</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="400ms">
                            ...
                            <div className="product-content">
                                ...
                                <h6><Link legacyBehavior href="/property-list/deatils1"><a>Mountain View Villa</a></Link></h6>
                                <ul className="features">
                                <li>
                                    <img src="assets/img/home1/icon/bed2.svg" alt="" />
                                    04 Beds
