...
const BlogListPage = () => {
  return (
    <MainLayout>
      <div
        className="blog-list-section scroll-margin pt-120 mb-120"
        id="blog-grid"
      >
                ...
                <div className="col-lg-7">
                  <div className="blog-card-content-wrap">
                    <div className="blog-card-content">
                      ...
                      <p>
                        There are many variations of simply free text passages
                        of available bumo the majority have suffered alteration
                        in some form, by injected humanjort randomised words
                        which don't slightly.
                      </p>
                    </div>
                    <div className="button-area">
                      <Link href="/blog/blog-details" className="read-more-btn">
