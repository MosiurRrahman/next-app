...
const BlogPage = () => {
    ...
    // Filter blogs by category from URL params or search params
    const categoryFilter = category || searchParams.get('category')
    const filteredBlogs = categoryFilter
        ? blog_grid.filter(blog => slugify(blog.category) === slugify(categoryFilter))
        : blog_grid
    ...
    return (
        <div>
            ...
            <Breadcrum pageTitle={categoryFilter || 'Blog'} pagename={'Blog'} />
                                        ...
                                        <div className="card-content">
                                            <div className="blog-meta">
                                                ...
                                                <ul className="category">
                                                    <li>
                                                        <Link href={`/blog?category=${slugify(item.category)}`}>
                                                            {item.category}
                                                        </Link>
                                                    </li>
                                                </ul>
