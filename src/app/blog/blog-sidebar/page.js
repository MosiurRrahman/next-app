    ...
    <div className="container">
        ...
        <div className="col-lg-4 order-lg-1 order-2">
            ...
            <div className="single-widget mb-30">
                ...
                <li>
                    <Link href="/blog">Cultural Exploration
                    <span>(20)</span>
                    </Link>  
                </li>
                <li>
                    <Link href="/blog">Adventure Safari
                    <span>(35)</span>
                    </Link>
                </li>
                <li>
                    <Link href="/blog">Nature Excursion
                    <span>(25)</span>
                    </Link>
                </li>
                <li>
                    <Link href="/blog">Cruise Voyage
                    <span>(18)</span>
                    </Link>
                </li>
                <li>
                    <Link href="/blog">City Discovery
                    <span>(06)</span>
                    </Link>
                </li>
                <li>
                    <Link href="/blog">Educational Journey
                    <span>(08)</span>
                    </Link>
                </li>
                <li>
        ...
        <div className="col-lg-8 order-lg-2 order-1">
            ...
            <div className="col-md-6">
                ...
                <div className="blog-card-img-wrap">
                    <Link href="/blog/blog-details" className="card-img"><img src="/assets/img/home4/blog-card-img1.jpg" alt="" /></Link>
                ...
                <div className="blog-card-content">
                    ...
                    <h5><Link href="/blog/blog-details">semper nulla vestibul umdot vitae Morbi semper.</Link></h5>
            ...
            <div className="col-md-6">
                <div className="blog-card">
                <div className="blog-card-img-wrap">
                    <Link href="/blog/blog-details" className="card-img"><img src="/assets/img/home4/blog-card-img2.jpg" alt="" /></Link>
                    <Link href="/blog" className="date">
                    <span><strong>18</strong> <br /> August</span>
                    </Link>
                </div>
                <div className="blog-card-content">
                    <div className="blog-card-content-top">
                    ...
                    <h5><Link href="/blog/blog-details">nisi laoreet Etiam fringilland mauris vitae arcu.</Link></h5>
                    <div className="bottom-area">
                    <Link href="/blog/blog-details">View Post 
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={12} viewBox="0 0 14 12" fill="none">
            ...
            <div className="col-md-6">
                <div className="blog-card">
                <div className="blog-card-img-wrap">
                    <Link href="/blog/blog-details" className="card-img"><img src="/assets/img/home4/blog-card-img3.jpg" alt="" /></Link>
                    <Link href="/blog" className="date">
                    <span><strong>16</strong> <br /> August</span>
                    </Link>
                </div>
                <div className="blog-card-content">
                    <div className="blog-card-content-top">
                    ...
                    <h5><Link href="/blog/blog-details">Two newest daily Lufthansan flights connect.</Link></h5>
                    <div className="bottom-area">
                    <Link href="/blog/blog-details">View Post 
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={12} viewBox="0 0 14 12" fill="none">
            ...
            <div className="col-md-6">
                <div className="blog-card">
                <div className="blog-card-img-wrap">
                    <Link href="/blog/blog-details" className="card-img"><img src="/assets/img/innerpage/blog-grid-img1.jpg" alt="" /></Link>
                    <Link href="/blog" className="date">
                    <span><strong>05</strong> <br /> August</span>
                    </Link>
                </div>
                <div className="blog-card-content">
                    <div className="blog-card-content-top">
                    ...
                    <h5><Link href="/blog/blog-details">The Nomadic Explorer Discovi Hidden Gems.</Link></h5>
                    <div className="bottom-area">
                    <Link href="/blog/blog-details">View Post 
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={12} viewBox="0 0 14 12" fill="none">
            ...
            <div className="col-md-6"> 
                <div className="blog-card">
                <div className="blog-card-img-wrap">
                    <Link href="/blog/blog-details" className="card-img"><img src="/assets/img/innerpage/blog-grid-img2.jpg" alt="" /></Link>
                    <Link href="/blog" className="date">
                    <span><strong>10</strong> <br /> August</span>
                    </Link>
                </div>
                <div className="blog-card-content">
                    <div className="blog-card-content-top">
                    ...
                    <h5><Link href="/blog/blog-details">Passport Diariesoni Journeys and Experiences</Link></h5>
                    <div className="bottom-area">
                    <Link href="/blog/blog-details">View Post 
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={12} viewBox="0 0 14 12" fill="none">
            ...
            <div className="col-md-6"> 
                <div className="blog-card">
                <div className="blog-card-img-wrap">
                    <Link href="/blog/blog-details" className="card-img"><img src="/assets/img/innerpage/blog-grid-img3.jpg" alt="" /></Link>
                    <Link href="/blog" className="date">
                    <span><strong>25</strong> <br /> June</span>
                    </Link>
                </div>
                <div className="blog-card-content">
                    <div className="blog-card-content-top">
                    ...
                    <h5><Link href="/blog/blog-details">Roaming Free Adventures Off the Beaten Path.</Link></h5>
                    <div className="bottom-area">
                    <Link href="/blog/blog-details">View Post 
                        <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={12} viewBox="0 0 14 12" fill="none">
