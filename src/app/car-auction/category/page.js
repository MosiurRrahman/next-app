    ...
    <div className="row gy-sm-5 g-4 row-cols-xxl-6 row-cols-xl-5 row-cols-md-4 row-cols-sm-3 row-cols-2">
      <div className="col wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Mercedes</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="300ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Toyota Camry</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">BMW</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="500ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Tesla</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Hyundai</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="700ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Nissan Rogue</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Honda</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Chevrolet</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="700ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Land Rover</Link></h5>
            <span>6,698 Item</span>
          </div>
        </div>
      </div>
      <div className="col wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Audi</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="500ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Bentley</Link></h5>
            <span>6,698 Item</span>
          </div>
        </div>
      </div>
      <div className="col wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Ferrari</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="300ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Ford</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Lamborghini</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div className="category-card2 two">
          ...
          <div className="category-content">
            <h5><Link href="/car-auction/auction-sidebar">Lexus</Link></h5>
