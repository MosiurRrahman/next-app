              ...
              <div className="blog-details-author-meta">
                <div className="author-area">
                  ...
                  <div className="author-content">
                    <h6>
                      By, <Link href="/car-auction/blog-grid">Cooper Jogan</Link>
                    </h6>
                  </div>
                </div>
                <ul>
                ...
                <div className="single-widget mb-30">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/car-auction/blog-grid">20 February, 2024</Link>
                      <h6>
                        <Link href="/car-auciton/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/car-auction/blog-grid">12 January, 2024</Link>
                      <h6>
                        <Link href="/car-auciton/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/car-auction/blog-grid">04 January, 2024</Link>
                      <h6>
                        <Link href="/car-auciton/blog-details">
