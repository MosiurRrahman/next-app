      ...
      <div className="single-widget">
        ...
        <div className="highest-bidding-widget mb-20">
          <div className="highest-bidding-img">
            <Link href="/car-auction/auction-details"><img src="/assets/img/inner-pages/highest-bidding-img1.jpg" alt="" /></Link>
          </div>
          <div className="highest-bidding-content">
            <h6><Link href="/car-auction/auction-details">Poutsicle Hydratingani Stain offering.</Link></h6>
        ...
        <div className="highest-bidding-widget mb-20">
          <div className="highest-bidding-img">
            <Link href="/car-auction/auction-details"><img src="/assets/img/inner-pages/highest-bidding-img2.jpg" alt="" /></Link>
          </div>
          <div className="highest-bidding-content">
            <h6><Link href="/car-auction/auction-details">Heritage Had Curating Watch.</Link></h6>
            <div className="price-area">
              <span>Current Bid at:</span>
              <strong>$2,458</strong>
            </div>
        ...
        <div className="highest-bidding-widget">
          <div className="highest-bidding-img">
            <Link href="/car-auction/auction-details"><img src="/assets/img/inner-pages/highest-bidding-img3.jpg" alt="" /></Link>
          </div>
          <div className="highest-bidding-content">
            <h6><Link href="/car-auction/auction-details">Art decorat bronze sculpture.</Link></h6>
            <div className="price-area">
              <span>Current Bid at:</span>
              <strong>$2,878</strong>
            </div>
        ...
        <div className="row g-4 mb-60">
            ...
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                ...
                <div className="author-and-btn-area">
                  <Link href="/car-auction/store-details" className="author-area">
                  ...
                  <Link href="/car-auction/auction-details" className="bid-btn">
                    Bid Now
                  </Link>
                </div>
              </div>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Heritage had curating watch time
                    treasures.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Canvas code redefining art in the digital
                    realm.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Nomism on nexus connecting collectors to coins.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$5,635</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Vintage valor embracing then elegance of eras past.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$2,898</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Canvas &amp; culture brush withn elegance auction.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$9,458</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Nostalgian hookup memories reside in every piece.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$8,687</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Coin crest cresting the peak of numismatic.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$5,578</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Pixela prodigy inspiring pixels time creators one.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                ...
                <div className="author-and-btn-area">
                  ...
                  <Link href="/car-auction/auction-details2" className="bid-btn">
                    Notify Me
                  </Link>
                </div>
              </div>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Gizmo galaxy your universent of cutting edge tech.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/car-auction/auction-details">Electro edge redefining times possibilities gadget.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
