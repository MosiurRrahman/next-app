      ...
      <div className="col-lg-8">
        <div className="row gy-5 mb-70">
          <div className="col-lg-12">
            <div className="blog-card1">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/innerpage/blog-st-img1.jpg" alt="blog-img-01" />
              </Link>
              <div className="blog-content">
                ...
                <h4><Link href="/blog-details">Celebrates Major Milestone in Digital Services</Link>
                </h4>
                <p>Allow for ample white space to avoid overwhelming the reader. White space helps
                  in emphasizing key points and improving readability.</p>
          ...
          <div className="col-lg-12">
            <div className="blog-card1">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/innerpage/blog-st-img2.jpg" alt="blog-img-02" />
              </Link>
              <div className="blog-content">
                <ul className="mete">
                ...
                <p>To keep the reader from becoming overwhelmed, leave plenty of white space. Key
                  ideas are emphasized and readability is enhanced with the use of white space.
                </p>
                <a className="explore-btn" href="/blog-details">
                  Read More
                  <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-lg-12">
            <div className="blog-card1">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/innerpage/blog-st-img3.jpg" alt="blog-img-03" />
              </Link>
              <div className="blog-content">
                <ul className="mete">
                ...
                <h4><Link href="/blog-details">Leads the Way in Digital Transformation.</Link></h4>
                <p>To prevent overloading the reader, leave enough of white space. White space
                  enhances readability and serves to highlight important ideas.</p>
                <a className="explore-btn" href="/blog-details">
                  Read More
                  <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M10.9532 0.0585938L10.7354 1.14748C10.5496 2.07672 10.2769 3.53489 10.1863 5.1213C10.095 6.71893 10.1931 8.37925 10.7023 9.73705C10.8477 10.1249 10.6512 10.5572 10.2634 10.7026C9.87551 10.8481 9.4432 10.6516 9.29776 10.2637C8.68194 8.62153 8.59252 6.71935 8.68873 5.03573C8.72553 4.39179 8.79018 3.76993 8.86659 3.19447L1.53034 10.5307C1.23745 10.8236 0.762572 10.8236 0.469679 10.5307C0.176786 10.2378 0.176786 9.76295 0.469679 9.47006L7.82528 2.11446C7.18273 2.19925 6.48717 2.27186 5.77637 2.31171C4.07615 2.40705 2.18197 2.32292 0.70457 1.68975C0.323847 1.52658 0.147484 1.08567 0.31065 0.704951C0.473817 0.324229 0.914726 0.147865 1.29545 0.311032C2.44305 0.802862 4.04886 0.906228 5.69239 0.814067C7.31348 0.723165 8.86779 0.449612 9.86179 0.263237L10.9532 0.0585938Z">
          ...
          <div className="col-lg-12">
            <div className="blog-card1">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/innerpage/blog-st-img4.jpg" alt="blog-img-03" />
              </Link>
              <div className="blog-content">
                <ul className="mete">
                  <li><Link href="/blog-grid">Corporate</Link></li>
                  <li><Link href="/blog-grid">15 March, 2023</Link></li>
                </ul>
                <h4><Link href="/blog-details">The Art and Science of Digital Marketing.</Link></h4>
                <p>Give the reader ample white space to avoid overloading them. White space draws
                  attention to key ideas and improves reading.</p>
                <a className="explore-btn" href="/blog-details">
                  Read More
                  <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M10.9532 0.0585938L10.7354 1.14748C10.5496 2.07672 10.2769 3.53489 10.1863 5.1213C10.095 6.71893 10.1931 8.37925 10.7023 9.73705C10.8477 10.1249 10.6512 10.5572 10.2634 10.7026C9.87551 10.8481 9.4432 10.6516 9.29776 10.2637C8.68194 8.62153 8.59252 6.71935 8.68873 5.03573C8.72553 4.39179 8.79018 3.76993 8.86659 3.19447L1.53034 10.5307C1.23745 10.8236 0.762572 10.8236 0.469679 10.5307C0.176786 10.2378 0.176786 9.76295 0.469679 9.47006L7.82528 2.11446C7.18273 2.19925 6.48717 2.27186 5.77637 2.31171C4.07615 2.40705 2.18197 2.32292 0.70457 1.68975C0.323847 1.52658 0.147484 1.08567 0.31065 0.704951C0.473817 0.324229 0.914726 0.147865 1.29545 0.311032C2.44305 0.802862 4.04886 0.906228 5.69239 0.814067C7.31348 0.723165 8.86779 0.449612 9.86179 0.263237L10.9532 0.0585938Z">
          ...
          <div className="col-lg-12">
            <div className="blog-card1">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/innerpage/blog-st-img5.jpg" alt="blog-img-03" />
              </Link>
              <div className="blog-content">
                <ul className="mete">
                  <li><Link href="/blog-grid">Technology</Link></li>
                  <li><Link href="/blog-grid">12 January, 2024</Link></li>
                </ul>
                <h4><Link href="/blog-details">The Power of Visual Storytelling in Marketing</Link>
                </h4>
                <p>Allow adequate white space to avoid overwhelming the reader. Readability is
                  improved and key ideas are emphasized by the use of white space.</p>
                <a className="explore-btn" href="/blog-details">
                  Read More
                  <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M10.9532 0.0585938L10.7354 1.14748C10.5496 2.07672 10.2769 3.53489 10.1863 5.1213C10.095 6.71893 10.1931 8.37925 10.7023 9.73705C10.8477 10.1249 10.6512 10.5572 10.2634 10.7026C9.87551 10.8481 9.4432 10.6516 9.29776 10.2637C8.68194 8.62153 8.59252 6.71935 8.68873 5.03573C8.72553 4.39179 8.79018 3.76993 8.86659 3.19447L1.53034 10.5307C1.23745 10.8236 0.762572 10.8236 0.469679 10.5307C0.176786 10.2378 0.176786 9.76295 0.469679 9.47006L7.82528 2.11446C7.18273 2.19925 6.48717 2.27186 5.77637 2.31171C4.07615 2.40705 2.18197 2.32292 0.70457 1.68975C0.323847 1.52658 0.147484 1.08567 0.31065 0.704951C0.473817 0.324229 0.914726 0.147865 1.29545 0.311032C2.44305 0.802862 4.04886 0.906228 5.69239 0.814067C7.31348 0.723165 8.86779 0.449612 9.86179 0.263237L10.9532 0.0585938Z">
        ...
        <div className="blog-sidebar">
          ...
          <div className="single-widgets widget_egns_categoris mb-40">
            ...
            <ul className="wp-block-categoris-cloud">
              <li><Link href="/blog-standard"><span>Technology</span> <span>(02)</span></Link></li>
              <li><Link href="/blog-standard"><span>Marketing</span> <span>(04)</span> </Link></li>
              <li><Link href="/blog-standard"><span>Fintech</span> <span>(06)</span></Link></li>
              <li><Link href="/blog-standard"><span>Health &amp; Care</span> <span>(02)</span></Link></li>
              <li><Link href="/blog-standard"><span>Human Resource</span> <span>(03)</span></Link></li>
              <li><Link href="/blog-standard"><span>Corporate</span> <span>(04)</span></Link></li>
              <li><Link href="/blog-standard"><span>Mobile Banking</span> <span>(03)</span></Link></li>
            </ul>
          </div>
          <div className="single-widgets widget_egns_recent_post mb-40">
            ...
            <div className="recent-post-wraper">
              <div className="widget-cnt">
                <div className="wi">
                  <Link href="/blog-details"><img src="assets/img/innerpage/blog-sidebar-1.jpg" alt="image" /></Link>
                </div>
                <div className="wc">
                  <Link href="/blog-standard">07 January, 2024 / Marko</Link>
                  <h5><Link href="/blog-details">The Power of Visual Storytelling in
                      Marketing</Link></h5>
                </div>
              </div>
              <div className="widget-cnt">
                <div className="wi">
                  <Link href="/blog-details"><img src="assets/img/innerpage/blog-sidebar-2.jpg" alt="image" /></Link>
                </div>
                <div className="wc">
                  <Link href="/blog-standard">13 January, 2024 / Noure</Link>
                  <h5><Link href="/blog-details"> A Journey through Creative Excellence</Link></h5>
                </div>
              </div>
              <div className="widget-cnt">
                <div className="wi">
                  <Link href="/blog-details"><img src="assets/img/innerpage/blog-sidebar-3.jpg" alt="image" /></Link>
                </div>
                <div className="wc">
                  <Link href="/blog-standard">0 February, 2024 / Barlow</Link>
                  <h5><Link href="/blog-details">Strategies for a Standout Identity</Link></h5>
                </div>
              </div>
            </div>
          </div>
