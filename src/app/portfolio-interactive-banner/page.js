...
const InteractiveBanner = () => {
  ...
  const handleMouseOver = (event) => {
    ...
    const showElement = document.querySelector(target.dataset.show);
    if (showElement) {
  ...
  return (
    ...
    <header className="header-area style-1 innerpage portfolio">
  <div className="header-logo">
    <Link href="/"><img alt="image" className="img-fluid" src="assets/img/white-logo.svg" /></Link>
  </div>
  <div className="menu-wrap">
    <div className="main-menu">
      ...
      <ul className="menu-list ">
        <li><Link href="/portfolio-showcase">Our Work</Link></li>
    ...
    <div className="nav-right d-flex jsutify-content-end align-items-center">
      <div className="sidebar-btn" onClick={toggleMenu}>
        ...
        <svg className="close" xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18">
     ...
     <div className="interactive-banner-section">
  <ul className="social-icon">
    <li><a href="https://99designs.com/">99 Design</a></li>
    <li><a href="https://dribbble.com/"><i className="bi bi-dribbble" />Dribbble</a></li>
  </ul>
  <ul className="social-icon two">
    <li><a href="https://www.behance.net/"><i className="bi bi-behance" /> Behance </a></li>
    <li><a href="https://www.pinterest.com/"><i className="bi bi-pinterest" /> Pinterest</a></li>
  </ul>
  <ul className="interactive-banner-img-group" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-01.jpg")'}}>
    <li className="single-banner-bg" id="background-panel-0" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-01.jpg")'}}>
    </li>
    <li className="single-banner-bg" id="background-panel-1" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-02.jpg")'}}>
    </li>
    <li className="single-banner-bg" id="background-panel-2" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-03.jpg")'}}>
    </li>
    <li className="single-banner-bg" id="background-panel-3" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-04.jpg")'}}>
    </li>
    <li className="single-banner-bg" id="background-panel-4" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-05.jpg")'}}>
    </li>
  </ul>
  <ul className="interactive-list">
    <li className="ineteractive-single-item" data-show="#background-panel-0" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
      <div className="responsive-bg-img" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-01.jpg")'}}>
      </div>
      <div className="card-content">
        <div className="catgory-and-title">
          <Link href="/portfolio-showcase">Design</Link>
          <h3><Link href="/portfolio-details">Digital Masterpieces</Link></h3>
        </div>
        <p>It's a mutually beneficial arrangement where.</p>
      </div>
    </li>
    <li className="ineteractive-single-item" data-show="#background-panel-1" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
      <div className="responsive-bg-img" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-02.jpg")'}}>
      </div>
      <div className="card-content">
        <div className="catgory-and-title">
          <Link href="/portfolio-showcase">Branding</Link>
          <h3><Link href="/portfolio-details">Branding Design</Link></h3>
        </div>
        <p>It's a mutually beneficial arrangement where.</p>
      </div>
    </li>
    <li className="ineteractive-single-item" data-show="#background-panel-2" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
      <div className="responsive-bg-img" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-03.jpg")'}}>
      </div>
      <div className="card-content">
        <div className="catgory-and-title">
          <Link href="/portfolio-showcase">Creative</Link>
          <h3><Link href="/portfolio-details">Digital Solutions.</Link></h3>
        </div>
        <p>It's a mutually beneficial arrangement where.</p>
      </div>
    </li>
    <li className="ineteractive-single-item" data-show="#background-panel-3">
      <div className="responsive-bg-img" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-04.jpg")'}}>
      </div>
      <div className="card-content">
        <div className="catgory-and-title">
          <Link href="/portfolio-showcase">Modern</Link>
          <h3><Link href="/portfolio-details">Modern Design
              Solutions</Link></h3>
        </div>
        <p>It's a mutually beneficial arrangement where.</p>
      </div>
    </li>
    <li className="ineteractive-single-item" data-show="#background-panel-4">
      <div className="responsive-bg-img" style={{background: 'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-05.jpg")'}}>
      </div>
      <div className="card-content">
        <div className="catgory-and-title">
          <Link href="/portfolio-showcase">Creative</Link>
          <h3><Link href="/portfolio-details">Sculpting the Future</Link></h3>
        </div>
        <p>It's a mutually beneficial arrangement where.</p>
      </div>
    </li>
