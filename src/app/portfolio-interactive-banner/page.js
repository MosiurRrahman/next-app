  ...
  return (
    <>
        ...
        <div className="menu-wrap">
          <div className="main-menu">
            ...
            <ul className="menu-list ">
              <li>
                <Link href="/portfolio-showcase">Our Work</Link>
              </li>
              <li>
      ...
      <div className="interactive-banner-section">
        ...
        <ul
          className="interactive-banner-img-group"
          style={{
            background:
              'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-01.jpg")',
          }}
        >
          <li
          ...
          <li
            className="single-banner-bg"
            id="background-panel-4"
            style={{
              background:
                'linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url("/assets/img/innerpage/interactive-05.jpg")',
            }}
          ></li>
        </ul>
        <ul className="interactive-list">
          <li
            className="ineteractive-single-item"
            data-show="#background-panel-0"
          >
            <div
            ...
            <div className="card-content">
              <div className="catgory-and-title">
                ...
                <h3>
                  <Link href="/portfolio-details">Digital Masterpieces</Link>
                </h3>
              </div>
          ...
          >
            ...
            <div className="card-content">
              <div className="catgory-and-title">
                ...
                <h3>
                  <Link href="/portfolio-details">Digital Solutions.</Link>
                </h3>
              </div>
              <p>It's a mutually beneficial arrangement where.</p>
            </div>
          ...
          >
            ...
            <div className="card-content">
              <div className="catgory-and-title">
                ...
                <h3>
                  <Link href="/portfolio-details">Modern Design Solutions</Link>
                </h3>
              </div>
              <p>It's a mutually beneficial arrangement where.</p>
            </div>
