...
const InteractiveBanner = () => {
  ...
  <ul className="interactive-list">
    <li className="ineteractive-single-item" data-show="#background-panel-0">
    ...
    <li className="ineteractive-single-item" data-show="#background-panel-1">
    ...
    <li className="ineteractive-single-item" data-show="#background-panel-2">
