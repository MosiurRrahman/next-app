              ...
              <div className="row">
                <div className="col-lg-5">
                  <div className="section-title white">
                    <h1>
                      Case Study <span>2 Column Grid</span>
                    </h1>
                  </div>
                </div>
              ...
              <div className="magnetic-wrap">
                <div className="case-study-card">
                  <div className="case-study-img">
                    <img
                      src="assets/img/innerpage/case-study-card-img1.jpg"
                      alt=""
                    />
                    <div className="batch">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="magnetic-wrap">
                <div className="case-study-card">
                  <div className="case-study-img">
                    <img
                      src="assets/img/innerpage/case-study-card-img2.jpg"
                      alt=""
                    />
                    <div className="batch">
                      <a href="#">Mobile App</a>
            ...
            <div className="col-lg-5 col-md-6">
              <div className="magnetic-wrap">
                <div className="case-study-card">
                  <div className="case-study-img">
                    <img
                      src="assets/img/innerpage/case-study-card-img3.jpg"
                      alt=""
                    />
                    <div className="batch">
                      <a href="#">Branding</a>
            ...
            <div className="col-lg-6 col-md-6">
              <div className="magnetic-wrap">
                <div className="case-study-card">
                  <div className="case-study-img">
                    <img
                      src="assets/img/innerpage/case-study-card-img4.jpg"
                      alt=""
                    />
                    <div className="batch">
                      <a href="#">Marketing</a>
            ...
            <div className="col-lg-5 col-md-6">
              <div className="magnetic-wrap">
                <div className="case-study-card">
                  <div className="case-study-img">
                    <img
                      src="assets/img/innerpage/case-study-card-img5.jpg"
                      alt=""
                    />
                    <div className="batch">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="magnetic-wrap">
                <div className="case-study-card">
                  <div className="case-study-img">
                    <img
                      src="assets/img/innerpage/case-study-card-img6.jpg"
                      alt=""
                    />
                    <div className="batch">
