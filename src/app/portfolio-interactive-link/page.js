      ...
      <div className="col-lg-12">
        <div className="interactive-link-wrapper">
          <div className="single-interactive-link">
            <Link href="/portfolio-showcase">Branding <sup>45</sup></Link>
          ...
          <div className="single-interactive-link">
            <Link href="/portfolio-showcase">UI/UX Design <sup>20</sup></Link>
            <div className="pf-img">
        ...
        <div className="interactive-link-wrapper">
          <div className="single-interactive-link">
            <Link href="/portfolio-showcase">Web Development <sup>26</sup></Link>
            <div className="pf-img">
          ...
          <div className="single-interactive-link">
            <Link href="/portfolio-showcase">Email Marketing <sup>13</sup></Link>
            <div className="pf-img">
        ...
        <div className="interactive-link-wrapper">
          <div className="single-interactive-link">
            <Link href="/portfolio-showcase">Cloud Servcie <sup>13</sup></Link>
            <div className="pf-img">
          ...
          <div className="single-interactive-link">
            <Link href="/portfolio-showcase">Graphics Design<sup>18</sup></Link>
            <div className="pf-img">
        ...
        <div className="interactive-link-wrapper">
          <div className="single-interactive-link">
            <Link href="/portfolio-showcase">App Development <sup>22</sup></Link>
            <div className="pf-img">
          ...
          <div className="single-interactive-link">
            <Link href="/portfolio-showcase">Cyber Security <sup>33</sup></Link>
            <div className="pf-img">
