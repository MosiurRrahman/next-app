    ...
    <>
      <Header/>
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-8">
                <div className="post-tag-and-title">
                  <h1 className="post-title">Celebrates Major Milestone in Digital Services.</h1>
                  <ul className="post-category">
                    <li><Link href="/portfolio-showcase">UI/UX Design</Link></li>
                    <li><Link href="/portfolio-showcase">Typography</Link></li>
                    <li><Link href="/portfolio-showcase">Usability</Link></li>
                    <li><Link href="/portfolio-showcase">Hierarchy</Link></li>
                  </ul>
                </div>
              </div>
                ...
                <div className="portfolio-details-info-wrap">
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>Website:</td>
                        <td><a href="#">ui.visual.com</a></td>
                      </tr>
                      <tr>
                        <td>Date:</td>
                        <td><span>01/15/2024</span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <Swiper {...settings} className="swiper service-post-thumb-slider">
                    <div className="swiper-wrapper">
                      <SwiperSlide className="swiper-slide">
                        <img src="/assets/img/innerpage/portfolio-details-thumb-img.jpg" alt="" />
                      </SwiperSlide>
                      <SwiperSlide className="swiper-slide">
                        <img src="/assets/img/innerpage/portfolio-details-thumb-img2.jpg" alt="" />
                      </SwiperSlide>
                      <SwiperSlide className="swiper-slide">
                        <img src="/assets/img/innerpage/portfolio-details-thumb-img3.jpg" alt="" />
                      </SwiperSlide>
                      <SwiperSlide className="swiper-slide">
                        <img src="/assets/img/innerpage/portfolio-details-thumb-img4.jpg" alt="" />
                      </SwiperSlide>
                    </div>
            ...
            <div className="details-page-content mb-130">
              ...
              <div className="row g-lg-4 gy-3">
                <div className="col-lg-6">
                  <p className="first-para">A s we reflect on this achievement, we look forward to continuing
                    our journey of digital innovation, creating transformative solutions, and shaping
                    the future of the digital landscape. Celebrating a major milestone in digital
                    services is a significant occasion .</p>
                </div>
                <div className="col-lg-6">
                  <p>This milestone is a testament to the hard work, creativity, and dedication of our
                    incredible team and the unwavering support from our clients and partners. We are
                    grateful for the trust placed in us and the collaborative efforts that have fueled
                    our success.</p>
                </div>
              </div>
              <span className="line-break" />
              ...
              <div className="row g-lg-4 gy-5">
                <div className="col-lg-6">
                  ...
                  <p>When creating a detailed case study, it's important to provide comprehensive
                    information that communicates the story of the project, including the challenges
                    faced, the solutions implemented, and the achieved results.</p>
                  <br />
                  <ul>
                    <li>
                      ...
                      The digital agency landscape is highly competitive, requiring agencies to
                    ...
                    <li>
                      ...
                      With a focus on technology, digital agencies have teams skilled in web
                      development.
                    </li>
                  </ul>
                </div>
                <div className="col-lg-6">
                  <img src="/assets/img/innerpage/portfolio-details-page-img1.jpg" alt="" />
                </div>
              </div>
              <span className="line-break" />
              <span className="line-break" />
              ...
              <div className="row g-4 align-items-center">
                <div className="col-md-6">
                  ...
                  <p>When creating a detailed case study, it's important to provide comprehensive
                    information that communicates.</p>
                  <br />
                  <p>It's important to provide comprehensive information that communicates the story of
                    the project, including the challenges faced, the solutions implemented, and the
                    achieved results.</p>
                </div>
                <div className="col-md-6">
                  <img src="/assets/img/innerpage/portfolio-details-counter-img.png" alt="" className="counter-light" />
                  <img src="/assets/img/innerpage/portfolio-details-counter-dark-img.png" alt="" className="counter-dark" />
                </div>
              </div>
              <span className="line-break" />
              <span className="line-break" />
            ...
            <div className="details-navigation two">
              <div className="single-navigation">
                ...
                <div className="content">
                  <h6><a href="blog-details">The Art and Science of
                      Digital Marketing.</a></h6>
                </div>
              </div>
              <div className="single-navigation two text-end">
                <div className="content">
                  <h6><a href="blog-details">Innovative Solutions for a Digital Tomorrow.</a></h6>
                </div>
                <a className="arrow" href="blog-details">
                  Next
                  <svg width={7} height={14} viewBox="0 0 8 13" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="home4-team-section style-2">
          <svg className="vector" xmlns="http://www.w3.org/2000/svg" width={300} height={374} viewBox="0 0 300 374" fill="none">
            ...
            <div className="row mb-60">
              <div className="col-lg-12">
                <div className="section-title text-animation">
                  <h2>Our Core <br /><span>Contributers.</span></h2>
                  <div className="dash-and-paragraph three">
                    ...
                    <div className="btn-and-paragraph">
                      <Link href="/our-team1">Explore More
