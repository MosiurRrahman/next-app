  ...
  <div className="container">
    <div className="row gy-5 row-cols-xl-5 row-cols-md-4 row-cols-sm-3 row-cols-2">
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="700ms" data-wow-duration="1500ms">
        <div className="category-card4 two">
          <div className="icon">
            <img src="../assets/img/home4/icon/home4-category-icon9.svg" alt="" />
          </div>
          <div className="content">
            <h5><Link href="/art-auction/auction-sidebar">Illustrations</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
        <div className="category-card4 two">
          <div className="icon">
            <img src="../assets/img/home4/icon/home4-category-icon10.svg" alt="" />
          </div>
          <div className="content">
            <h5><Link href="/art-auction/auction-sidebar">Indigenous Art</Link></h5>
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="500ms" data-wow-duration="1500ms">
        <div className="category-card4 two">
          <div className="icon">
            <img src="../assets/img/home4/icon/home4-category-icon11.svg" alt="" />
          </div>
          <div className="content">
            <h5><Link href="/art-auction/auction-sidebar">Oceanic Art</Link></h5>
            <span>45,533 Item</span>
          </div>
          <div className="category-img">
      ...
      <div className="col wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
        <div className="category-card4 two">
          <div className="icon">
            <img src="../assets/img/home4/icon/home4-category-icon12.svg" alt="" />
          </div>
          <div className="content">
            <h5><Link href="/art-auction/auction-sidebar">Decorative Arts</Link></h5>
