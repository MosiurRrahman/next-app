          ...
          <div className="row g-lg-4 gy-5 mb-110">
            <div className="col-lg-8">
              <div className="post-thumb">
                <img
                  src="assets/img/innerpage/case-study-details-thumb-img.jpg"
                  alt=""
                />
              </div>
              <span className="line-break" />
              ...
              <div className="details-page-content">
                ...
                <div className="row g-4">
                  <div className="col-lg-6">
                    <img
                      src="assets/img/innerpage/case-study-details-page-img1.jpg"
                      alt=""
                    />
                  </div>
                  <div className="col-lg-6">
                    <img
                      src="assets/img/innerpage/case-study-details-page-img2.jpg"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div className="row g-4 align-items-center">
                  ...
                  <div className="col-md-4">
                    <img
                      src="assets/img/innerpage/case-study-details-counter-img.png"
                      alt=""
                      className="counter-light"
                    />
                    <img
                      src="assets/img/innerpage/case-study-details-counter-dark-img.png"
                      alt=""
                ...
                <h3>Conclusion</h3>
                <p>
                  By covering these details in your case study, you create a
                  comprehensive narrative that showcases your agency's expertise
                  and the successful outcomes achieved for your clients.{" "}
                </p>
              </div>
            </div>
                ...
                <ul className="download-btns">
                  <li>
                    <a href="assets/case-study.pdf" download="case-study.pdf">
                      <img
                        src="assets/img/innerpage/vector/pdf-icon.svg"
                        alt=""
                      />
                      Download Pdf
                    </a>
                  ...
                  <li>
                    <a href="assets/case-study.pdf" download="case-study.pdf">
                      <img
                        src="assets/img/innerpage/vector/docs-icon.svg"
                        alt=""
                      />
                      Download Docs
                    </a>
