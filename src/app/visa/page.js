    ...
    <div className="row g-lg-4 gy-5">
          ...
          <div className="row gy-4">
            <div className="col-md-12 item">
              <div className="package-card4 four"> 
                <Link href="/visa/visa-details" className="package-card-img">
                  <img src="/assets/img/home4/package-card4-img1.jpg" alt="" />
                </Link>
                <div className="package-card-content">
                  ...
                  <div className="card-content-bottom">
                    <div className="price-area">
                      ...
                      <h6><strong>$</strong>3860 <span>Per Person</span></h6>
                    </div>
                    <Link href="/visa/visa-details" className="apply-btn">
                      Apply Now
                      <div className="arrow">
            ...
            <div className="col-md-12 item">
              <div className="package-card4 four"> 
                <Link href="/visa/visa-details" className="package-card-img">
                  <img src="/assets/img/home4/package-card4-img2.jpg" alt="" />
                </Link>
                <div className="package-card-content">
                  <div className="card-content-top">
                    <h5>Grown-up E-visa with Cooling and Assurance.</h5>
                    <ul>
                      <li><span>Country :</span> Egypt</li>
                      <li><span>Visa Type :</span> Tourist</li>
                      <li><span>Visa Mode :</span> Electronic</li>
                      <li><span>Validity :</span> 50 Days</li>
                      <li><span>Processing Time :</span> 7-10 Working Day</li>
                    </ul>
                  </div>
                  <div className="card-content-bottom">
                    <div className="price-area">
                      <span>Starting Form:</span>
                      <h6><strong>$</strong>3500 <span>Per Person</span></h6>
                    </div>
                    <Link href="/visa/visa-details" className="apply-btn">
                      Apply Now
                      <div className="arrow">
            ...
            <div className="col-md-12 item">
              <div className="package-card4 four"> 
                <Link href="/visa/visa-details" className="package-card-img">
                  <img src="/assets/img/innerpage/visa-package-img1.jpg" alt="" />
                </Link>
                <div className="package-card-content">
                  <div className="card-content-top">
                    <h5>Digital Visa for Adults with Admirer and Insurance</h5>
                    <ul>
                  ...
                  <div className="card-content-bottom">
                    <div className="price-area">
                      <span>Starting Form:</span>
                      <h6><strong>$</strong>4500 <span>Per Person</span></h6>
                    </div>
                    <Link href="/visa/visa-details" className="apply-btn">
                      Apply Now
                      <div className="arrow">
            ...
            <div className="col-md-12 item">
              <div className="package-card4 four"> 
                <Link href="/visa/visa-details" className="package-card-img">
                  <img src="/assets/img/innerpage/visa-package-img2.jpg" alt="" />
                </Link>
                <div className="package-card-content">
                  <div className="card-content-top">
                    ...
                    <ul>
                      ...
                      <li><span>Visa Type :</span> Tourist</li>
                      <li><span>Visa Mode :</span> Electronic</li>
                      <li><span>Validity :</span> 40 Days</li>
                      <li><span>Processing Time :</span> 7-10 Working Day</li>
                    </ul>
                  </div>
                  <div className="card-content-bottom">
                    <div className="price-area">
                      <span>Starting Form:</span>
                      <h6><strong>$</strong>2500 <span>Per Person</span></h6>
                    </div>
                    <Link href="/visa/visa-details" className="apply-btn">
                      Apply Now
                      <div className="arrow">
            ...
            <div className="col-md-12 item">
              <div className="package-card4 four"> 
                <Link href="/visa/visa-details" className="package-card-img">
                  <img src="/assets/img/innerpage/visa-package-img3.jpg" alt="" />
                </Link>
                <div className="package-card-content">
                  <div className="card-content-top">
                    <h5>E-Visa for Grown-Ups with Devotee and Assurance</h5>
                    <ul>
                  ...
                  <div className="card-content-bottom">
                    <div className="price-area">
                      <span>Starting Form:</span>
                      <h6><strong>$</strong>4200 <span>Per Person</span></h6>
                    </div>
                    <Link href="/visa/visa-details" className="apply-btn">
                      Apply Now
                      <div className="arrow">
            ...
            <div className="col-md-12 item">
              <div className="package-card4 four"> 
                <Link href="/visa/visa-details" className="package-card-img">
                  <img src="/assets/img/innerpage/visa-package-img4.jpg" alt="" />
                </Link>
                <div className="package-card-content">
                  <div className="card-content-top">
                    <h5>Virtual Visa for Adults with Supporter and Protection</h5>
                    <ul>
      ...
      <div className="col-lg-4">
        <div className="sidebar-area">
          <h5 className="widget-title mb-30">FAQ - General Visa Information:</h5>
