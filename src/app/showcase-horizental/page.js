    ...
    <div className="row grid mb-130">
      <div className="col-lg-12 grid-item UiUx Web Graphics">
        <div className="single-work">
          <div className="work-name">
            ...
            <h3><Link href="/portfolio-details">Corporate Brand Revitalization.</Link></h3>
          </div>
          <div className="work-discription">
            <p>Strategy that involves creating and sharing content on social a website's media
              platforms.</p>
            <ul>
              <li><Link href="/portfolio-showcase">UI/UX</Link></li>
              <li><Link href="/portfolio-showcase">Color Palette</Link></li>
          ...
          <div className="details-btn-wrap">
            <div className="details-btn">
              <Link className="primary-btn4 btn-hover" href="/portfolio-details">View Details
      ...
      <div className="col-lg-12 grid-item Web UiUx">
        <div className="single-work">
          <div className="work-name">
            ...
            <h3><Link href="/portfolio-details">NexGen Pioneering Digital Solutions.</Link></h3>
          </div>
          <div className="work-discription">
            <p>Strategy that involves creating and sharing content on social a website's media
              platforms.</p>
      ...
      <div className="col-lg-12 grid-item Branding Graphics">
        <div className="single-work">
          ...
          <div className="work-discription">
            <p>It's a mutually beneficial arrangement where affiliates earn a commission .</p>
            <ul>
              <li><Link href="/portfolio-showcase">Logo</Link></li>
              <li><Link href="/portfolio-showcase">Usability</Link></li>
              <li><Link href="/portfolio-showcase">Color Palette</Link></li>
            </ul>
          </div>
      ...
      <div className="col-lg-12 grid-item UiUx Branding">
        <div className="single-work">
          <div className="work-name">
            ...
            <h3><Link href="/portfolio-details">Where Vision Meets Technology.</Link></h3>
          </div>
          <div className="work-discription">
            <p>Strategy that involves creating and sharing content on social a website's media
              platforms.</p>
      ...
      <div className="col-lg-12 grid-item Web Branding">
        <div className="single-work">
          <div className="work-name">
            ...
            <h3><Link href="/portfolio-details"> Studio Navigating the Digital Wave.</Link></h3>
          </div>
          <div className="work-discription">
            <p>It's a mutually beneficial arrangement where affiliates earn a commission .</p>
            <ul>
      ...
      <div className="col-lg-12 grid-item UiUx Branding Graphics">
        <div className="single-work">
          <div className="work-name">
            ...
            <h3><Link href="/portfolio-details">We Compose Digital Masterpieces.</Link></h3>
          </div>
          <div className="work-discription">
            <p>Strategy that involves creating and sharing content on social a website's media
              platforms.</p>
      ...
      <div className="col-lg-12 d-flex justify-content-center">
        <div className="load-more-btn btn_wrapper">
          <button className="circle-btn btn-hover">
            ...
            </svg> Load More <strong>Portfolio</strong>
            <span style={{top: '50.5px', left: '83.75px'}} />
          </button>
        </div>
      </div>
