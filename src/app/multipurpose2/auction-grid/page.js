...
const AuctionGridPage = () => {
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Nomism Nexus Connecting  Collectors to Coins.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$4,648</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Vintage Valor Embracing the Elegance of Eras Past.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$4,648</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Titan Motors Built to Conquer Every Mile.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$5,237</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Canvas &amp; Culture Brush with Elegance Auction.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$5,588</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Canvas Code Redefining Art in the Digital Realm.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$8,974</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Electro Edge Redefining Time Possibilities Gadget.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$4,648</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Nostalgia Hookup Memories Reside in Every Piece.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$4,648</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Gizmo Galaxy Your Universe of Cutting Edge Tech.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$5,237</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
    <div className="auction-card style-7">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/multipurpose2/auction-details">Pixel Prodigy Inspiring Pixels Time Creators One.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$8,475</strong>
