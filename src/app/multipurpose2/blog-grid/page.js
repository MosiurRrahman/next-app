      ...
      <div className="row g-4 mb-60">
        {
          blogGridData.map((data)=>{
            const {blog_id, blog_title,  blog_image,blog_url,blog_date,blog_author,blog_comment,blog_category} = data
            return(
              <>
              <div key={blog_id} className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                  ...
                  <div className="card-content">
                    <div className="blog-meta">
                      <ul className="category">
                        <li><Link href={blog_url}>{blog_category}</Link></li>
                      </ul>
                      <div className="blog-comment">
                        <span>Comment ({blog_comment})</span>
                      </div>
                    </div>
                    <h4><Link href={blog_url}>{blog_title}</Link></h4>
