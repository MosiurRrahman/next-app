        ...
        <div className="container-lg container-fluid">
          <div className="row mb-50">
            ...
            <div className="col-lg-8">
              <div className="section-title five text-animation">
                <h2>
                  Leverage a variety of technologies
          ...
          <div className="row g-4 ">
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="single-work-process magnetic-item">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="single-work-process two magnetic-item">
                <div className="icon-and-title">
                  <div className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="single-work-process three magnetic-item">
                <div className="icon-and-title">
                  <div className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="single-work-process four magnetic-item">
                <div className="icon-and-title">
                  <div className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-lg-12">
              <div className="sevices-wrap">
                ...
                <div className="single-services">
                  ...
                  <div className="content">
                    <p>
                      Optimization involves various on-page and off-page
                      techniques to improve a website's visibility, relevance.
                    </p>
                    <ul className="tag-list">
                      <li>Optimization</li>
                      <li>Research</li>
                ...
                <div className="single-services">
                  ...
                  <div className="content">
                    <p>
                      A powerful digital marketing strategy that involves
                ...
                <div className="single-services">
                  ...
                  <h3>
                    <Link href="/service-details">Affiliate Marketing</Link>
                  </h3>
                  <div className="services-img">
                  ...
                  <div className="content">
                    <p>
                      It's a mutually beneficial arrangement where affiliates
                      earn a commission .
                    </p>
                    <ul className="tag-list">
                      <li>Affiliate</li>
                ...
                <div className="single-services">
                  ...
                  <h3>
                    <Link href="/service-details">Online Public Relations</Link>
                  </h3>
                  <div className="services-img">
                  ...
                  <div className="content">
                    <p>
                      It encompasses digital communication strategies to build
                      and maintain.
                    </p>
                    <ul className="tag-list">
                      <li>Management</li>
                ...
                <div className="single-services">
                  ...
                  <h3>
                    <Link href="/service-details">E-commerce Marketing</Link>
                  </h3>
                  <div className="services-img">
                  ...
                  <div className="content">
                    <p>
                      The goal is to attract potential customers, drive sales,
