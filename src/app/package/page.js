        ...
        <div className="sidebar-area">
          ...
          <div className="single-widget mb-30">
            ...
            <ul className="category-list two">
              <li>
                <Link href="/blog">Indonesia
                  <span>20</span>
                </Link>  
              </li>
              <li>
                <Link href="/blog">Switzerland
                  <span>35</span>
                </Link>
              </li>
              <li>
                <Link href="/blog">Egypt
                  <span>25</span>
                </Link>
              </li>
              <li>
                <Link href="/blog">Saudi Arab
                  <span>18</span>
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/blog">Bangladesh
                  <span>08</span>
                </Link>
              </li>
              <li>
                <Link href="/blog">Luxury Retreat
                  <span>15</span>
                </Link>
              </li>
              <li>
                <Link href="/blog">Photography Expedition
                  <span>25</span>
                </Link>
              </li>
            </ul>
