...
const page = () => {
  return (
    <>
    <Breadcrumb pagename="Package Top Search" pagetitle="Package Top Search"/>
            ...
            <div className="col-xl-3 col-sm-6 d-flex justify-content-center">
              <div className="single-search-box">
                ...
                <div className="searchbox-input">
                  ...
                  <div className="custom-select-dropdown">
                    <div className="select-input">
                      <input type="text" readOnly defaultValue="Family Tour" />
                      <i className="bi bi-chevron-down" />
                    </div>
            ...
            <div className="col-xl-3 col-sm-6 d-flex justify-content-center">
              <div className="single-search-box">
                ...
                <div className="searchbox-input">
                  ...
                  <div className="custom-select-dropdown">
                    <div className="select-input">
                      <input type="text" readOnly defaultValue="Economy" />
                      <i className="bi bi-chevron-down" />
                    </div>
                    <div className="custom-select-wrap two no-scroll">
                      <ul className="option-list">
    ...
    <div className="row gy-5 mb-70">
            ...
            <div className="batch">
              ...
              <div className="location">
                ...
                <ul className="location-list">
                  <li><Link href="/package/package">Nepal</Link></li>
                  <li><Link href="/package/package">Indonesia Tour</Link></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="card-content-top">
              ...
              <div className="location-area">
                <ul className="location-list scrollTextAni">
                  <li><Link href="/package/package">Alexandria</Link></li>
                  <li><Link href="/package/package">Sharm El Sheikh</Link></li>
                  <li><Link href="/package/package">Mansoura</Link></li>
                  <li><Link href="/package/package">Karachi</Link></li>
                  <li><Link href="/package/package">Lahore</Link></li>
                  <li><Link href="/package/package">Islamabad</Link></li>
                </ul>
              </div>
            </div>
        ...
        <div className="package-card">
          <div className="package-card-img-wrap">
            ...
            <div className="batch">
              ...
              <div className="location">
                ...
                <ul className="location-list">
                  <li><Link href="/package/package">Egypt</Link></li>
                  <li><Link href="/package/package">Turkey Tour</Link></li>
                </ul>
              </div>
            </div>
          </div>
          <div className="package-card-content">
            <div className="card-content-top">
              ...
              <div className="location-area">
                <ul className="location-list scrollTextAni">
                  <li><Link href="/package/package">Mecca</Link></li>
                  <li><Link href="/package/package">Medina</Link></li>
                  <li><Link href="/package/package">Riyadh</Link></li>
                  <li><Link href="/package/package">Doha</Link></li>
                  <li><Link href="/package/package">Al Wakrah</Link></li>
                  <li><Link href="/package/package">Al Rayyan</Link></li>
                </ul>
              </div>
            </div>
            <div className="card-content-bottom">
          ...
          <div className="package-card-img-wrap">
            ...
            <div className="batch">
              ...
              <div className="location">
                ...
                <ul className="location-list">
                  <li><Link href="/package/package">France</Link></li>
                  <li><Link href="/package/package">Spain Tour</Link></li>
                </ul>
              </div>
            </div> 
          </div>
        ...
        <div className="package-card">
          <div className="package-card-img-wrap">
            ...
            <div className="batch">
              ...
              <div className="location">
                ...
                <ul className="location-list">
                  <li><Link href="/package/package">India</Link></li>
                  <li><Link href="/package/package">Japan Tour</Link></li>
                </ul>
              </div>
            </div> 
          </div>
          <div className="package-card-content">
            <div className="card-content-top">
              ...
              <div className="location-area">
                <ul className="location-list">
                  <li><Link href="/package/package">Bangalore</Link></li>
                  <li><Link href="/package/package">Chennai</Link></li>
                  <li><Link href="/package/package">New Delhi</Link></li>
                  <li><Link href="/package/package">Dhaka</Link></li>
                  <li><Link href="/package/package">Rangpur</Link></li>
                  <li><Link href="/package/package">Sylhet</Link></li>
                </ul>
              </div>
            </div>
            <div className="card-content-bottom">
        ...
        <div className="package-card">
          <div className="package-card-img-wrap">
            ...
            <div className="batch">
              ...
              <div className="location">
                ...
                <ul className="location-list">
                  <li><Link href="/package/package">Brazil</Link></li>
                  <li><Link href="/package/package">Hungary Tour</Link></li>
                </ul>
              </div>
            </div> 
          </div>
          <div className="package-card-content">
            <div className="card-content-top">
              ...
              <div className="location-area">
                <ul className="location-list scrollTextAni">
                  <li><Link href="/package/package">Paris</Link></li>
                  <li><Link href="/package/package">Marseille</Link></li>
                  <li><Link href="/package/package">Bordeaux</Link></li>
                  <li><Link href="/package/package">Madrid</Link></li>
                  <li><Link href="/package/package">Barcelona</Link></li>
                  <li><Link href="/package/package">Valencia</Link></li>
                </ul>
              </div>
            </div>
            <div className="card-content-bottom">
        ...
        <div className="package-card">
          ...
          <div className="package-card-content">
            <div className="card-content-top">
              ...
              <div className="location-area">
                <ul className="location-list scrollTextAni">
                  <li><Link href="/package/package">Kathmandu</Link></li>
                  <li><Link href="/package/package">Pokhara</Link></li>
                  <li><Link href="/package/package">Lalitpur</Link></li>
                  <li><Link href="/package/package">Jakarta</Link></li>
                  <li><Link href="/package/package">Surabaya</Link></li>
                  <li><Link href="/package/package">Bandung</Link></li>
                </ul>
              </div>
            </div>
            <div className="card-content-bottom">
      ...
      <div className="col-lg-4 col-md-6">
        <div className="package-card">
          ...
          <div className="package-card-content">
            <div className="card-content-top">
              <h5><Link href="/package/package-details">Exploring ancient ruins, histor landmarks, and cultural.</Link></h5>
              <div className="location-area">
                <ul className="location-list scrollTextAni">
                  <li><Link href="/package/package">Kathmandu</Link></li>
                  <li><Link href="/package/package">Pokhara</Link></li>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="package-card">
          ...
          <div className="package-card-content">
            <div className="card-content-top">
              <h5><Link href="/package/package-details">Immersive cultural Expirees, local cuisine.</Link></h5>
              <div className="location-area">
                <ul className="location-list scrollTextAni">
                  <li><Link href="/package/package">Kathmandu</Link></li>
                  <li><Link href="/package/package">Pokhara</Link></li>
