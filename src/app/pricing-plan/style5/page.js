                    ...
                    <div className="pricing-plan-tab-area">
                        ...
                        <div className="tab-content" id="nav-tab2Content">
                            <div className="tab-pane fade show active" id="nav-monthly" role="tabpanel" aria-labelledby="nav-monthly-tab" tabIndex={0}>
                                <div className="row g-xl-3 gy-5 align-items-center justify-content-center">
                                    <div className="col-xl-4 col-md-6">
                                        <div className="magnetic-item">
                                            <div className="pricing-card style-4" style={{ backgroundImage: 'url(assets/img/home5/home5-pricing-card-bg.png), linear-gradient(180deg, rgba(29, 32, 38, 1) 0%, rgba(29, 32, 38, 1) 100%)' }}>
                                                <div className="pricing-top">
                                                    <span>Basic Plan</span>
                                                    <p>Highlight experience &amp; qualifications of pouter member certificate relevant degrees.</p>
                                                    <h2><span>$</span>85<sub>/ Monthly</sub></h2>
                                                    <div className="pay-btn-area">
                                                        <Link href="/contact" className="primary-btn2 two" data-text="Purchase Plan">
                                    ...
                                    <div className="col-xl-4 col-md-6">
                                        <div className="magnetic-item">
                                            <div className="pricing-card style-4 st-plan2" style={{ backgroundImage: 'url(assets/img/home5/home5-pricing-card-st-bg.png), linear-gradient(180deg, rgba(117, 114, 253, 0.15) 0%, rgba(117, 114, 253, 0.15) 100%)' }}>
                                                <div className="pricing-top">
                                                    <span>Standard Plan</span>
                                                    <p>Highlight experience &amp; qualifications of pouter member certificate relevant degrees.</p>
                                                    <h2><span>$</span>126 <sub><del>$180</del>/ Monthly</sub></h2>
                                                    <div className="pay-btn-area">
                                                        <Link href="/contact" className="primary-btn2 two" data-text="Purchase Plan">
                                                            <span>Purchase Plan</span>
                                                        </Link>
                                        ...
                                        <div className="magnetic-item">
                                            <div className="pricing-card style-4" style={{ backgroundImage: 'url(assets/img/home5/home5-pricing-card-bg.png), linear-gradient(180deg, rgba(29, 32, 38, 1) 0%, rgba(29, 32, 38, 1) 100%)' }}>
                                                <div className="pricing-top">
                                                    ...
                                                    <p>Highlight experience &amp; qualifications of pouter member certificate relevant degrees.</p>
                                                    <h2><span>$</span>180<sub>/ Monthly</sub></h2>
                                                    <div className="pay-btn-area">
                                                        <Link href="/contact" className="primary-btn2 two" data-text="Purchase Plan">
                                                            <span>Purchase Plan</span>
                                                        </Link>
