      ...
      <div className="col-lg-5">
        ...
        <div className="single-contact mb-40">
          ...
          <div className="content">
            ...
            <h6><a href="mailto:example@example.com">example@example.com</a></h6>
          </div>
        </div>
        <div className="single-contact mb-40">
          <div className="title">
        ...
        <div className="single-contact">
          ...
          <div className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22.9 23" style={{enableBackground: 'new 0 0 22.9 23'}} xmlSpace="preserve">
