          ...
          <div className="row g-4 grid mb-130">
            <div className="col-lg-4 col-sm-6 grid-item activites office">
              <div className="single-gallery-img">
                <a
                  href="assets/img/innerpage/gallery-img-01.jpg"
            ...
            <div className="col-lg-4 col-sm-6 grid-item activites">
              <div className="single-gallery-img">
                <a
                  href="assets/img/innerpage/gallery-img-02.jpg"
                  data-fancybox="gallery"
                  data-caption="Caption Images 2"
                  className="view-btn"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-lg-4 col-sm-6 grid-item office festival">
              <div className="single-gallery-img">
                <a
                  href="assets/img/innerpage/gallery-img-03.jpg"
                  data-fancybox="gallery"
                  data-caption="Caption Images 3"
                  className="view-btn"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-lg-6 col-sm-6 grid-item office">
              <div className="single-gallery-img">
                <a
                  href="assets/img/innerpage/gallery-img-04.jpg"
                  data-fancybox="gallery"
            ...
            <div className="col-lg-6 col-sm-6 grid-item festival">
              <div className="single-gallery-img">
                <a
                  href="assets/img/innerpage/gallery-img-05.jpg"
                  data-fancybox="gallery"
            ...
            <div className="col-lg-4 col-sm-6 grid-item office anuTour">
              <div className="single-gallery-img">
                <a
                  href="assets/img/innerpage/gallery-img-06.jpg"
                  data-fancybox="gallery"
            ...
            <div className="col-lg-4 col-sm-6 grid-item office festival">
              <div className="single-gallery-img">
                <a
                  href="assets/img/innerpage/gallery-img-07.jpg"
                  data-fancybox="gallery"
            ...
            <div className="col-lg-4 col-sm-6 grid-item activites anuTour">
              <div className="single-gallery-img">
                <a
                  href="assets/img/innerpage/gallery-img-08.jpg"
                  data-fancybox="gallery"
