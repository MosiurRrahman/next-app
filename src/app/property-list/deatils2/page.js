          ...
          <div className="col-lg-8">
            <div className="poperty-details-content">
              ...
              <div className="single-item mb-50">
                ...
                <div className="poperty-video-area">
                  <img src="/assets/img/inner-page/poperty-video-img.png" alt="" />
                  <div className="play-btn">
                    <a href="assets/video/popup-video.mp4" data-fancybox="gallery">Play</a>
                  </div>
                </div>
              </div>
              <div className="single-item mb-50">
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-sm-12">
                      <div className="form-inner">
                        ...
                        <input placeholder="From Date & Time" id="datepicker" type="text" />
                      </div>
                    </div>
                    <div className="col-sm-12">
                      <div className="form-inner">
