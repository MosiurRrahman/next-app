...
const Page = () => {
  ...
  return (
    <>
      ...
      <Breadcrumb
        pageName="Property Listing System"
                  ...
                  <div className="show-item-and-filte">
                    ...
                    <div className="filter-view">
                      <div className="filter-atra">
                        ...
                        <form>
                          <div className="form-inner">
                              <SelectComponent placeholder={"price"} options={["Highest Price","Lowest Price"]}/>
                      ...
                      <div className="product-card">
                        <div className="product-img">
                          ...
                          <div className="swiper product-img-slider">
                            <div className="swiper-wrapper">
                              <div className="swiper-slide">
                                <img src="assets/img/inner-page/product-sb-img-12.png" alt="image" />
                              </div>
                              <div className="swiper-slide">
                                <img src="assets/img/inner-page/product-sb-img-02.png" alt="image" />
                              </div>
