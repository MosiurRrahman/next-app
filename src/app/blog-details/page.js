      ...
      <div className="blog-details-page pt-110 mb-110">
        <div className="container">
              ...
              <div className="blog-details-author-meta">
                <div className="author-area">
                  ...
                  <div className="author-content">
                    <h6>By, <Link href="/blog-grid">Cooper Jogan</Link></h6>
                  </div>
                </div>
                <ul>
                  <li>
          ...
          <div className="row gy-5 mb-70">
            <div className="col-lg-8">
              <div className="blog-details-content">
                <h1>Winning whispers tips and tricks borns from successful bidding.</h1>
                <span className="line-break" />
                <span className="line-break" />
                <p className="first-para">NSuspendisse bibendum efficitur orci, a pretium erat mattis nec. Vestibulum antena ypsumi primis inaetahsjanl faucibus orci luctus etenjot ultrices posuere cubilia curae curabitur.</p>
                <span className="line-break" />
                ...
                <blockquote>
                  <p className="blockquote-text">"I work with Alguneb Johnl on many projects, he always toldagona exci my expectations with his quality work and fastestopa tope service, very smooth and simple communication."</p>
                  <h3 className="blockquote-author">Leslie Alexander</h3>
                  <svg className="quotes" xmlns="http://www.w3.org/2000/svg" width={93} height={90} viewBox="0 0 93 90">
                ...
                <div className="row g-4">
                  ...
                  <div className="col-lg-6">
                    <img src="assets/img/inner-pages/blog-details-img3.jpg" alt="" />
                  </div>
                </div>
                <span className="line-break" />
                <span className="line-break" />
          ...
          <div className="blog-tag">
            <h6>Tag:</h6>
            <ul>
              <li><Link href="/blog-grid">Industry,</Link></li>
              <li><Link href="/blog-grid">Marketing,</Link></li>
              <li><Link href="/blog-grid">Technology,</Link></li>
              <li><Link href="/blog-grid">Health Care</Link></li>
            </ul>
          </div>
              ...
              <div className="details-navigation">
                  ...
                  <Link href="/blog-details" className="nav-btn">
                    <div className="arrow">
                      <svg width={16} height={13} viewBox="0 0 16 13" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M2.58563 6.98704L15.7913 6.98738L15.7913 6.01295L2.58563 6.0133L7.15096 1.44797L6.46232 0.75933L0.72148 6.50017L6.46232 12.241L7.15096 11.5524L2.58563 6.98704Z" strokeWidth="0.3" />
                      </svg>
                    </div>
                    Previous Post
                  </Link>
                  <div className="content">
                    <h6><Link href="/blog-details">Challenges creating structure multiple brand system.</Link></h6>
                  </div>
                </div>
                <div className="single-navigation two text-end">
                  ...
                  <Link href="/blog-details" className="nav-btn">
                    ...
                    <div className="arrow">
                      <svg width={16} height={13} viewBox="0 0 16 13" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M13.4144 6.01333L0.208692 6.01299L0.208692 6.98741L13.4144 6.98707L8.84904 11.5524L9.53768 12.241L15.2785 6.5002L9.53768 0.759362L8.84904 1.448L13.4144 6.01333Z" strokeWidth="0.3" />
                      </svg>
                    </div>
                  </Link>
                </div>
