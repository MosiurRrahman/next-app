...
const AuctionGrid = () => {
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      <div className="auction-card-img-wrap">
        <Link href="/antiques-auciton/auction-details" className="card-img">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">Velocity visions performance meets precision. </Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$2,898</strong>
          </div>
          <Link href="/antiques-auciton/auction-details" className="bid-btn">
            Bid Now
          </Link>
        </div>
      </div>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">19th century chines antique porcelain vase.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$4,648</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/antiques-auciton/auction-details">Art decorat bronze sculpture antique pot. </Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$8,974</strong>
          </div>
          <Link href="/antiques-auction/auction-details2" className="bid-btn">Notify Me</Link>
        </div>
      </div>
    </div>
  </div>
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">Neo-classical marble busting rustic farmhouse.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$5,237</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">Zenith auto elevating driving your experience.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$2,898</strong>
          </div>
          <a href="#" className="bid-btn">Bid Now</a>
        </div>
      </div>
    </div>
  </div>
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content"> 
        <h6><Link href="/antiques-auciton/auction-details">Titan motors built to conquer every milen.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$6,367</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">Victorian silver color wall old clock set.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$2,898</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">18th century chines antique porcelain vase.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$8,974</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">Eclipse cars redefining thus road ahead auction.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$5,237</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">Colonial revival dining chairs with old book.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$4,648</strong>
  ...
  <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
    <div className="auction-card style-3">
      ...
      <div className="auction-card-content">
        <h6><Link href="/antiques-auciton/auction-details">Regency perioded chandelier jug with pot.</Link></h6>
        <div className="price-and-code-area">
          <div className="price">
            <span>Current Bid at:</span>
            <strong>$3,984</strong>
