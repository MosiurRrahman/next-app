                ...
                >
                  <div className="blog-card">
                    <div className="blog-card-img-wrap">
                      ...
                      <div className="batch">
                        <Link href="/antiques-auction/blog-grid" className="date">
                          03 January, 2024
                        </Link>
                      </div>
                    </div>
                    <div className="card-content">
                      <div className="blog-meta">
                        <ul className="category">
                          <li>
                            <Link href="/antiques-auction/blog-grid">ANTIQUE</Link>
                          </li>
                        </ul>
                      ...
                      <Link className="view-button" href="/antiques-auction/blog-details">
                        Read More
                  ...
                  <div className="blog-card">
                    ...
                    <div className="card-content">
                      <div className="blog-meta">
                        <ul className="category">
                          <li>
                            <Link href="/antiques-auction/blog-grid">RENAISSANCE</Link>
                          </li>
                        </ul>
                        <div className="blog-comment">
                          <span>Comment (20)</span>
                  ...
                  <div className="blog-card">
                    ...
                    <div className="card-content">
                      <div className="blog-meta">
                        <ul className="category">
                          <li>
                            <Link href="/antiques-auction/blog-grid">ROMANTICISM</Link>
                          </li>
                        </ul>
                        <div className="blog-comment">
              ...
              <div className="sidebar-area">
                ...
                <div className="single-widget mb-30">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/antiques-auction/blog-grid">20 February, 2024</Link>
                      <h6>
                        <Link href="/antiques-auction/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/antiques-auction/blog-grid">12 January, 2024</Link>
                      <h6>
                        <Link href="/antiques-auction/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/antiques-auction/blog-grid">04 January, 2024</Link>
                      <h6>
                        <Link href="/antiques-auction/blog-details">
                ...
                <div className="single-widget mb-30">
                  ...
                  <ul className="tag-list">
                    ...
                    <li>
                      <Link href="/antiques-auction/blog-grid ">Manuscripts</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/antiques-auction/blog-grid ">Baroque Art</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/antiques-auction/blog-grid ">Photography</Link>
                    </li>
                    <li>
                      <Link href="/antiques-auction/blog-grid ">Smartwatches</Link>
                    </li>
                  </ul>
                </div>
