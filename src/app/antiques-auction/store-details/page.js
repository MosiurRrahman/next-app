      ...
      <div className="single-widget">
        ...
        <div className="highest-bidding-widget mb-20">
          <div className="highest-bidding-img">
            <Link href="/antiques-auction/auction-details"><img src="/assets/img/inner-pages/highest-bidding-img1.jpg" alt="" /></Link>
          </div>
          <div className="highest-bidding-content">
            <h6><Link href="/antiques-auction/auction-details">Poutsicle Hydratingani Stain offering.</Link></h6>
        ...
        <div className="highest-bidding-widget mb-20">
          <div className="highest-bidding-img">
            <Link href="/antiques-auction/auction-details"><img src="/assets/img/inner-pages/highest-bidding-img2.jpg" alt="" /></Link>
          </div>
          <div className="highest-bidding-content">
            <h6><Link href="/antiques-auction/auction-details">Heritage Had Curating Watch.</Link></h6>
            <div className="price-area">
              <span>Current Bid at:</span>
              <strong>$2,458</strong>
            </div>
        ...
        <div className="highest-bidding-widget">
          <div className="highest-bidding-img">
            <Link href="/antiques-auction/auction-details"><img src="/assets/img/inner-pages/highest-bidding-img3.jpg" alt="" /></Link>
          </div>
          <div className="highest-bidding-content">
            <h6><Link href="/antiques-auction/auction-details">Art decorat bronze sculpture.</Link></h6>
            <div className="price-area">
              <span>Current Bid at:</span>
              <strong>$2,878</strong>
            </div>
    ...
    <div className="container">
      <div className="store-details-profile-area mb-70">
        <div className="store-details-profile-cover-photo">
          <img src="/assets/img/inner-pages/store-details-profile-cover-img1.jpg" alt="" />
        </div>
          ...
          <div className="row g-3 align-items-center">
            <div className="col-lg-4 order-lg-1 order-2">
              <div className="single-contact">
                ...
                <div className="content">
                  <h6><a href="https://maps.app.goo.gl/kqJUoD2Fa4GJ2aPWA"> <strong>Address :</strong>  House 168/170, Road 02, Avenue 01, Mirpur DOHS, Dhaka, Bangladesh</a></h6>
                </div>
              </div>
            </div>
            <div className="col-lg-4 d-flex justify-content-lg-center order-lg-2 order-1">
              <div className="profile-area">
                <div className="profile-img">
                  <img src="/assets/img/inner-pages/store-details-profile-img1.png" alt="" />
                </div>
            ...
            <div className="col-lg-4 d-flex justify-content-lg-end order-lg-3 order-3">
              <div className="single-contact">
                ...
                <div className="content">
                  <h6><a href="mailto:info@gmail.com"><strong>Email :</strong> info@gmail.com</a></h6>
                  <h6><a href="tel:01796713831"><strong>Phone :</strong> +88 0179 6713 831</a></h6>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row g-4 mb-60">
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="auction-card">
              <div className="auction-card-img-wrap">
                <Link href="/antiques-auction/auction-details" className="card-img">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Zenith auto elevating driving your experience</Link></h6>
                ...
                <div className="author-and-btn-area">
                  <Link href="/antiques-auction/store-details" className="author-area">
                    <div className="author-img">
                      <img src="/assets/img/home1/auction-card-author-img1.png" alt="" />
                    </div>
                    <div className="author-content">
                      <h6>Maverick Dylan</h6>
                    </div>
                  </Link>
                  <Link href="/antiques-auction/auction-details" className="bid-btn">
                    Bid Now
                  </Link>
                </div>
              </div>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Heritage had curating watch time
                    treasures.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                ...
                <div className="author-and-btn-area">
                  <Link href="/antiques-auction/store-details" className="author-area">
                    <div className="author-img">
                      <img src="/assets/img/home1/auction-card-author-img2.png" alt="" />
                    </div>
                    <div className="author-content">
                      <h6>Wyatt Matthew</h6>
                    </div>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Canvas code redefining art in the digital
                    realm.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                ...
                <div className="author-and-btn-area">
                  <Link href="/antiques-auction/store-details" className="author-area">
                    <div className="author-img">
                      <img src="/assets/img/home1/auction-card-author-img3.png" alt="" />
                    </div>
                    <div className="author-content">
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Nomism on nexus connecting collectors to coins.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$5,635</strong>
                ...
                <div className="author-and-btn-area">
                  <Link href="/antiques-auction/store-details" className="author-area">
                    <div className="author-img">
                      <img src="/assets/img/home1/auction-card-author-img4.png" alt="" />
                    </div>
                    <div className="author-content">
                      <h6>Jacob Logan</h6>
                    </div>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Vintage valor embracing then elegance of eras past.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$2,898</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Canvas &amp; culture brush withn elegance auction.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$9,458</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Nostalgian hookup memories reside in every piece.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$8,687</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Coin crest cresting the peak of numismatic.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$5,578</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Pixela prodigy inspiring pixels time creators one.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                ...
                <div className="author-and-btn-area">
                  ...
                  <Link href="/antiques-auction/auction-details2" className="bid-btn">
                    Notify Me
                  </Link>
                </div>
              </div>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Gizmo galaxy your universent of cutting edge tech.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Titan motors built to conquer every milen.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$6,367</strong>
          ...
          <div className="col-xl-3 col-md-4 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/antiques-auction/auction-details">Electro edge redefining times possibilities gadget.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
