                  ...
                  <div className="inner-pagination-area">
                    <ul className="paginations">
                      <li
                        ...
                        className={`page-item paginations-button ${currentPage === 1 ? "disabled" : ""
                          }`}
                      >
                        <a href="#">
                          <svg
                      ...
                      <li
                        ...
                        className={`page-item paginations-button ${currentPage === Math.ceil(totalProducts / productsPerPage)
                          ? "disabled"
                          : ""
                          }`}
                      >
