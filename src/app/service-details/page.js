              ...
              <div className="col-lg-12">
                ...
                >
                  <div className="swiper-wrapper">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/innerpage/service-details-thumb-img1.jpg"
                        alt=""
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/innerpage/service-details-thumb-img2.jpg"
                        alt=""
                      />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img
                        src="/assets/img/innerpage/service-details-thumb-img3.jpg"
                        alt=""
                      />
                    </SwiperSlide>
                  </div>
