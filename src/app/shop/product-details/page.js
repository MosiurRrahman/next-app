    ...
    <div className="row gy-5">
      ...
      <div className="col-lg-6">
        <div className="product-details-content">
          ...
          <p>Experience the perfect blend of fashion and function – choose our Leather Bags and redefine the way you carry your essentials. Elevate your everyday style with a touch of timeless elegance and the enduring quality of genuine leather.</p>
          ...
          <div className="product-details-btn">
            <Link href="/shop/cart" className="primary-btn1">*Add to Cart*</Link>
            <Link href="/shop/checkout" className="secondary-btn4 two">*Buy Now*</Link>
          </div>
          <div className="product-info">
            <ul className="product-info-list">
              <li> <span>SKU:</span> 9852410</li>
              <li> <span>Category:</span> <Link href="/shop">Equipment</Link></li>
              <li> <span>Tags:</span> <Link href="/shop">Glass</Link>, <Link href="/shop">Backpack</Link>, <Link href="/shop">Cap</Link></li>
            </ul>
          </div>
          <div className="payment-method">
            <h6>Guaranted Safe Checkout</h6>
            <ul className="payment-card-list">
              <li><img src="/assets/img/innerpage/payment-img1.svg" alt="" /></li>
              <li><img src="/assets/img/innerpage/payment-img2.svg" alt="" /></li>
              <li><img src="/assets/img/innerpage/payment-img3.svg" alt="" /></li>
              <li><img src="/assets/img/innerpage/payment-img4.svg" alt="" /></li>
              <li><img src="/assets/img/innerpage/payment-img5.svg" alt="" /></li>
              <li><img src="/assets/img/innerpage/payment-img6.svg" alt="" /></li>
              <li><img src="/assets/img/innerpage/payment-img7.svg" alt="" /></li>
            </ul>
          </div>
          ...
          <div className="tab-content" id="nav-tabContent">
            <div className="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
              <div className="description-content">
                <p>Introducing our innovative Voyager Sunglasses, the perfect fusion of style and functionality for the modern traveler. Crafted with cutting-edge polarized lenses, these sunglasses provide superior UV protection while reducing glare, ensuring crystal-clear vision during your sun-soaked adventures. The sleek, lightweight design guarantees comfort, and with a foldable frame and compact carrying case, these sunglasses are the ultimate travel companion, effortlessly fitting into any bag or pocket.</p>
              </div>
            </div>
...
<div className="related-product-section mb-120">
  <div className="container">
    ...
    <div className="row">
      <div className="col-12">
        <div className="swiper package-card2-slider">
