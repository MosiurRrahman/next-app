                ...
                <div className="cart-menu">
                  ...
                  <div className="cart-footer">
                    ...
                    <div className="choose-payment-method">
                      ...
                      <div className="payment-option">
                        <ul>
                          <li className="paypal active">
                            <img src="/assets/img/innerpage/icon/payPal.svg" alt="" />
                            <div className="checked">
                              <i className="bi bi-check" />
                            </div>
                          </li>
                          <li className="stripe">
                            <img src="/assets/img/innerpage/icon/stripe.svg" alt="" />
                            <div className="checked">
                              <i className="bi bi-check" />
                            </div>
                          </li>
                          <li className="offline">
                            <img src="/assets/img/innerpage/icon/offline.svg" alt="" />
                            <div className="checked">
                              <i className="bi bi-check" />
                            </div>
                          </li>
                      ...
                      <div className="pt-25" id="StripePayment" style={{display: 'none'}}>
                    ...
                    <div className="form-inner">
                      <button className="primary-btn1" type="submit">Place Order</button>
                    </div>
                  </div>
                </div>
              </form>
