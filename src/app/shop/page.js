    ...
    <div className="row g-md-4 gy-5">
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Leather Bag</Link></h6>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Beach Hat</Link></h6>
            <span>$110.00 <del>$150.00</del></span>
            <div className="rating">
              <ul>
                <li><i className="bi bi-star-fill" /></li>
                <li><i className="bi bi-star-fill" /></li>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Winter Cap</Link></h6>
            <span>$90.00 <del>$120.00</del></span>
            <div className="rating">
              <ul>
                <li><i className="bi bi-star-fill" /></li>
                <li><i className="bi bi-star-fill" /></li>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Beach Slippers</Link></h6>
            <span>$100.00 <del>$130.00</del></span>
            <div className="rating">
              <ul>
                <li><i className="bi bi-star-fill" /></li>
                <li><i className="bi bi-star-fill" /></li>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Tiny Torchlight</Link></h6>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Sleeping Bag</Link></h6>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Trendy Sunglass</Link></h6>
            <span>$130.00</span>
            <div className="rating">
              <ul>
                <li><i className="bi bi-star-fill" /></li>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Adventure Binoculars</Link></h6>
            <span>$150.00 <del>$200.00</del></span>
            <div className="rating">
              <ul>
                <li><i className="bi bi-star-fill" /></li>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="product-card">
          ...
          <div className="product-card-content">
            <h6><Link href="/shop/product-details">Cosy Neck Pillow</Link></h6>
            <span>$110.00 <del>$150.00</del></span>
            <div className="rating">
              <ul>
                <li><i className="bi bi-star-fill" /></li>
