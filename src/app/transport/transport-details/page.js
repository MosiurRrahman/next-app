        ...
        <div className="container">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
                      ...
                      <div className="swiper product-img-slider">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/car-img.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/car-img1.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/car-img2.jpg" alt="image" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="tab-pane fade" id="interior" role="tabpanel" aria-labelledby="interior-tab">
                    <div className="transport-img">
                      ...
                      <div className="swiper product-img-slider">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-01.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-011.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-012.jpg" alt="image" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="tab-pane fade" id="video-clip" role="tabpanel" aria-labelledby="video-clip-tab">
                    <div className="transport-img">
                      ...
                      <div className="swiper product-img-slider">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-03.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-031.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-032.jpg" alt="image" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="tab-pane fade" id="color-clip" role="tabpanel" aria-labelledby="color-clip-tab">
                    <div className="transport-img">
                      ...
                      <div className="swiper product-img-slider">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-04.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-041.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-042.jpg" alt="image" />
                          </div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="tab-pane fade" id="color-clip2" role="tabpanel" aria-labelledby="color-clip2-tab">
                    <div className="transport-img">
                      <div className="slider-btn-group">
                        <div className="product-stand-next swiper-arrow">
                          <svg width={8} height={13} viewBox="0 0 8 13" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="swiper product-img-slider">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-05.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-051.jpg" alt="image" />
                          </div>
                          <div className="swiper-slide">
                            <img src="/assets/img/innerpage/tab-big-052.jpg" alt="image" />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <ul className="nav nav-tabs" id="myTab5" role="tablist">
                  <li className="nav-item" role="presentation">
                    <button className="nav-link active" id="exterior-tab" data-bs-toggle="tab" data-bs-target="#exterior" type="button" role="tab" aria-controls="exterior" aria-selected="true">
                      <img src="/assets/img/innerpage/tab-sm-img02.jpg" alt="" />
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    <button className="nav-link" id="interior-tab" data-bs-toggle="tab" data-bs-target="#interior" type="button" role="tab" aria-controls="interior" aria-selected="false">
                      <img src="/assets/img/innerpage/tab-sm-img01.jpg" alt="" />
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    <button className="nav-link" id="video-clip-tab" data-bs-toggle="tab" data-bs-target="#video-clip" type="button" role="tab" aria-controls="video-clip" aria-selected="false">
                      <img src="/assets/img/innerpage/tab-sm-img03.jpg" alt="" />
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    <button className="nav-link" id="color-clip-tab" data-bs-toggle="tab" data-bs-target="#color-clip" type="button" role="tab" aria-controls="color-clip" aria-selected="false">
                      <img src="/assets/img/innerpage/tab-sm-img04.jpg" alt="" />
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    <button className="nav-link" id="color-clip2-tab" data-bs-toggle="tab" data-bs-target="#color-clip2" type="button" role="tab" aria-controls="color-clip2" aria-selected="false">
                      <img src="/assets/img/innerpage/tab-sm-img05.jpg" alt="" />
                    </button>
                  </li>
                </ul>
              </div>
              ...
              <p>Traveling from Dhaka to Sajek Valley is an adventure that takes you from the bustling capital
                city of Bangladesh to the serene and picturesque landscapes of the Chittagong Hill Tracts.</p>
              <p>The journey begins in Dhaka, a vibrant metropolis teeming with life, where you'll find yourself
                amidst the hustle and bustle of the city streets. Travelers have several options for reaching
                Sajek Valley from Dhaka, typically starting with a journey by road.</p>
              <p>The road trip from Dhaka to Sajek Valley offers an opportunity to witness the diverse landscapes
                of Bangladesh. As you leave Dhaka behind, the scenery gradually transforms from urban
                developments to rural expanses, passing through towns and villages along the way. The road winds
                through lush greenery, hills, and valleys, providing glimpses of the country's natural beauty.
              </p>
              <h4>Included and Excluded</h4>
              <div className="includ-and-exclud-area mb-20">
                <ul>
                  <li><i className="bi bi-check-lg" /> Specify the modes of transportation included (flights,
                    trains, buses, etc.).</li>
                  <li><i className="bi bi-check-lg" /> Clarify if it covers transfers between destinations or if
                    it's limited to specific legs of the journey.</li>
                  <li><i className="bi bi-check-lg" /> Mention the type of accommodation provided (hotels,
                    hostels, etc.).</li>
                  <li><i className="bi bi-check-lg" /> Specify the number of nights included and the room type
                    (single, double, etc.).</li>
                  <li><i className="bi bi-check-lg" /> Any additional services like travel insurance, Wi-Fi
                    access, or specific amenities.</li>
                </ul>
                <ul className="exclud">
                  <li><i className="bi bi-x-lg" /> Specify activities or tours not included but available as
                    optional extras.</li>
                  <li><i className="bi bi-x-lg" /> Clarify that personal expenses such as souvenirs, extra
                    meals, or additional transportation outside the tour schedule are not included.</li>
                  <li><i className="bi bi-x-lg" /> Highlight that travel insurance is not included (if
                    applicable) and recommend purchasing it separately.</li>
                  <li><i className="bi bi-x-lg" /> Specify that costs related to visas or permits are not part
                    of the package.</li>
                  <li><i className="bi bi-x-lg" /> Indicate that tips for guides, drivers, or any other service
                    providers are not included</li>
                </ul>
              </div>
                    ...
                    <div className="accordion-item">
                      ...
                      <div id="travelcollapseOne" className="accordion-collapse collapse show" aria-labelledby="travelheadingOne" data-bs-parent="#accordionTravel">
                        <div className="accordion-body">
                          Aptent taciti sociosqu ad litora torquent per conubia nostra, per inci only
                          Integer purus onthis felis non aliquam.Mauris nec just vitae ann auctor tol
                          euismod sit amet non ipsul growing this.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      ...
                      <div id="travelcollapseTwo" className="accordion-collapse collapse" aria-labelledby="travelheadingTwo" data-bs-parent="#accordionTravel">
                        <div className="accordion-body">
                          ...
                          only Integer purus onthis
                          placerat felis non aliquam.Mauris nec justo vitae ante auctor tol euismod
            ...
            <div className="col-lg-4">
              <div className="transport-sidebar">
                <div className="booking-form-wrap">
                  ...
                  <p>Reserve your beautiful travel: Dhaka-Sajek Valley transportation for a peaceful
                    adventure.</p>
                  <div className="nav nav-pills mb-40" role="tablist">
                    ...
                    <button className="nav-link" id="v-pills-contact-tab" data-bs-toggle="pill" data-bs-target="#v-pills-contact" type="button" role="tab" aria-controls="v-pills-contact" aria-selected="false" tabIndex={-1}>Inquiry
                      Form</button>
                  </div>
                    ...
                    <div className="tab-pane fade active show" id="v-pills-booking" role="tabpanel" aria-labelledby="v-pills-booking-tab">
                      <div className="sidebar-booking-form">
                        <form>
                            ...
                            <ul>
                              <li className="privet">
                                <div className="form-check">
                                  <input className="form-check-input" type="radio" name="transportType" id="car" defaultValue="option1" defaultChecked />
                                  <label className="form-check-label" htmlFor="car">
                                    ...
                                    <span>4 Person <span className="price">$200</span></span>
                                  </label>
                                </div>
                              </li>
                              <li className="public">
                                <div className="form-check">
                                  <input className="form-check-input" type="radio" name="transportType" id="bus" defaultValue="option4" />
                                  <label className="form-check-label" htmlFor="bus">
                                    ...
                                    <span>Per Person <span className="price">$40</span></span>
                                  </label>
                                </div>
                              </li>
                              <li className="public">
                                <div className="form-check">
                                  <input className="form-check-input" type="radio" name="transportType" id="train" defaultValue="option2" />
                                  <label className="form-check-label" htmlFor="train">
                                    ...
                                    <span>Per Person <span className="price">$30</span></span>
                                  </label>
                                </div>
                              </li>
                              <li className="public">
                                <div className="form-check">
                                  <input className="form-check-input" type="radio" name="transportType" id="boat" defaultValue="option3" />
                                  <label className="form-check-label" htmlFor="boat">
                                    ...
                                    <span>Per Person <span className="price">$70</span></span>
                                  </label>
                                </div>
                              </li>
                            </ul>
                          ...
                          <div className="booking-form-item-type" id="forPrivet">
                            <div className="number-input-item adults">
                              <label htmlFor="transportss" className="number-input-lable"><span>Car - Toyota:
                                </span><span> $200</span></label>
                                <QuantityCounter/>
                            </div>
                          </div>
                          <div className="booking-form-item-type" id="forPublic" style={{display: 'none'}}>
                            <div className="number-input-item adults">
                              <label htmlFor="adultsPerson" className="number-input-lable"><span>Adult:
                                </span><span> $60 <del>$80</del></span></label>
                                <QuantityCounter/>
                            </div>
                            <div className="number-input-item children">
                              <label htmlFor="childrenPerson" className="number-input-lable"><span>
                                  Children:
