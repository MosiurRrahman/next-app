(function ($) {
	...
	var swiper = new Swiper(".home3-case-study-slider", {
		slidesPerView: 1,
		speed: 1500,
		spaceBetween: 25,
		// autoplay: {
	...
	// Home5 Testimonial Slider
	var swiper = new Swiper(".home5-portfolio-slider", {
		slidesPerView: 1,
		speed: 1500,
		spaceBetween: 25,
		effect: 'fade',             // Use the fade effect
	...
	// Home5 Testimonial Slider
	var swiper = new Swiper(".home5-founder-slider", {
		slidesPerView: 1,
		speed: 1500,
		spaceBetween: 25,
		effect: 'fade',             // Use the fade effect
	...
	window.addEventListener('scroll', function() {
		const featureSection = document.querySelector('.home5-benifit-section');
		const img = document.getElementById('rotating-image');
		
		 // Check if the featureSection and img exist before proceeding
		 if (featureSection && img) {
			// Get the bounding rectangle of the feature section
			...
			if (sectionRect.top <= 0 && sectionRect.bottom >= 0) {
				// Calculate rotation based on the distance scrolled
				const rotation = Math.abs(sectionRect.top) / 5; // Adjust rotation speed here
				img.style.transform = `rotate(${rotation}deg)`;
			} else {
				// Reset the rotation when the section is not at the top of the viewport
	...
	if (window.innerWidth <= 991) {
		document.querySelectorAll('.home3-service-section .accordion-flush .accordion-item').forEach(function(element) {
			element.addEventListener('click', function(e) {
				document.querySelector('#main-item').scrollIntoView({
					behavior: 'smooth'
				});
			});
		});
	...
	$('.home2-logo-area').each(function () {
		var dealName = $(this).children('.logo-list');
