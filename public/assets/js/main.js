...
--------------------------------------------- */
  ...
  $("body").on("click", ".add-education-row", function () {
    ...
    newRow +=
      '<input type="text" id="datepicker10" name="stp" placeholder="DD/MM/YY">';
    newRow += "</div>";
    newRow += "</div>";
    newRow += "</div>";
    newRow += '<div class="col-md-6">';
    ...
    newRow +=
      '<button type="button" class="remove-education-row remove">Remove Education Area</button>';
    newRow += "</div>";
    newRow += "</div>";
  ...
  $("body").on("click", ".add-experiences-row", function () {
    ...
    newRow +=
      '<div class="form-agreement form-inner d-flex justify-content-between flex-wrap p-0">';
    ...
    newRow += '<div class="add-row">';
    newRow +=
      '<button type="button" class="remove-experiences-row remove">Remove Experiences Area</button>';
    newRow += "</div>";
    newRow += "</div>";
  ...
  $("body").on("click", ".addwork-area-row", function () {
    ...
    newRow += '<div class="add-row">';
    newRow +=
      '<button type="button" class="remove-work-area-row remove">Remove Work Area</button>';
    newRow += "</div>";
    newRow += "</div>";
